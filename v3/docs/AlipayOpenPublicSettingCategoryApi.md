# AlipaySDKNet.OpenAPI.Api.AlipayOpenPublicSettingCategoryApi
...
namespace Example
{
    public class QueryExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AlipayOpenPublicSettingCategoryApi(config);
            ...
            {
                Debug.Print("Exception when calling AlipayOpenPublicSettingCategoryApi.Query: " + e.Message );
