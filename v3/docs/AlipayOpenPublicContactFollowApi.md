# AlipaySDKNet.OpenAPI.Api.AlipayOpenPublicContactFollowApi
...
<a name="batchquery"></a>
# **Batchquery**
> AlipayOpenPublicContactFollowBatchqueryResponseModel Batchquery (string authToken = null)
...
namespace Example
{
    public class BatchqueryExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AlipayOpenPublicContactFollowApi(config);
            ...
            {
                Debug.Print("Exception when calling AlipayOpenPublicContactFollowApi.Batchquery: " + e.Message );
