# AlipaySDKNet.OpenAPI.Api.AlipayOpenPublicLifeDebarkApi
...
namespace Example
{
    public class ApplyExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AlipayOpenPublicLifeDebarkApi(config);
            ...
            {
                Debug.Print("Exception when calling AlipayOpenPublicLifeDebarkApi.Apply: " + e.Message );
