...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchBoxImageModule")]
    public partial class SearchBoxImageModule : IEquatable<SearchBoxImageModule>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchBoxImageModule" /> class.
        /// </summary>
        ...
        public SearchBoxImageModule(string applyNo = default(string), string failReason = default(string), string gmtModified = default(string), string moduleId = default(string), string moduleType = default(string), string status = default(string))
        {
        ...
        {
            return this.Equals(input as SearchBoxImageModule);
        }

        /// <summary>
        /// Returns true if SearchBoxImageModule instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchBoxImageModule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchBoxImageModule input)
        {
            if (input == null)
            {
                return false;
