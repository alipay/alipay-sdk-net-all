...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class TemplateActionInfoDTO : IEquatable<TemplateActionInfoDTO>, IValidatableObject
    {
        ...
        /// <param name="url">行动点跳转链接，当url_type取\&quot;url\&quot;或不填时必填.</param>
        /// <param name="urlType">跳转链接类型，当前支持url和miniAppUrl，不填则默认为url类型：  url：对应填写url参数，支持http(s)和支付宝schema地址等；  miniAppUrl: 对应填写mini_app_url参数，跳转至指定的支付宝小程序页面.</param>
        ...
        /// </summary>
        /// <value>行动点跳转链接，当url_type取\&quot;url\&quot;或不填时必填</value>
        ...
        /// </summary>
        /// <value>跳转链接类型，当前支持url和miniAppUrl，不填则默认为url类型：  url：对应填写url参数，支持http(s)和支付宝schema地址等；  miniAppUrl: 对应填写mini_app_url参数，跳转至指定的支付宝小程序页面</value>
