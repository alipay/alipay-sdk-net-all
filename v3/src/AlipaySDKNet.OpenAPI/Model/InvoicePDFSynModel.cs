...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class InvoicePDFSynModel : IEquatable<InvoicePDFSynModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="applyId">支付宝开票申请id。 当userId为空时，必填； 如果在开票过程中，是通过支付宝提交的申请到开票服务方，支付宝会带上开票申请在支付宝生成的申请id，开票服务方在回传发票的时候只需要回传这个申请id，不用获取用户的userId，支付宝可以根据申请id将发票归集到对应的用户名下.</param>
        /// <param name="extendFields">预留的扩展字段，格式如：key1&#x3D;value1\\nkey2&#x3D;value2\\nkey3&#x3D;value3，字段之间以\\n(换行符)分隔。.</param>
        /// <param name="fileBase">base64化的字符串.</param>
        /// <param name="fileDownloadType">PDF类型文件填写PDF， OFD类型文件填写ofd， JPG类型文件填写JPG(JPG文件请先询问对接人当前是否支持).</param>
        /// <param name="fileDownloadUrl">发票文件下载地址。.</param>
        /// <param name="openId">支付宝用户id，当apply_id为空时，open_id必填.</param>
        /// <param name="outInvoiceId">外部ISV的唯一发票标识.</param>
        /// <param name="userId">支付宝用户userId； 当apply_id为空时，userId必填.</param>
        /// <param name="zip">压缩方式.</param>
        public InvoicePDFSynModel(string applyId = default(string), string extendFields = default(string), string fileBase = default(string), string fileDownloadType = default(string), string fileDownloadUrl = default(string), string openId = default(string), string outInvoiceId = default(string), string userId = default(string), string zip = default(string))
        {
        ...
        /// </summary>
        /// <value>支付宝开票申请id。 当userId为空时，必填； 如果在开票过程中，是通过支付宝提交的申请到开票服务方，支付宝会带上开票申请在支付宝生成的申请id，开票服务方在回传发票的时候只需要回传这个申请id，不用获取用户的userId，支付宝可以根据申请id将发票归集到对应的用户名下</value>
        ...
        /// </summary>
        /// <value>PDF类型文件填写PDF， OFD类型文件填写ofd， JPG类型文件填写JPG(JPG文件请先询问对接人当前是否支持)</value>
        ...
        /// </summary>
        /// <value>支付宝用户userId； 当apply_id为空时，userId必填</value>
