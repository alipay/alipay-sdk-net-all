...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class EmployeeTitleDTO : IEquatable<EmployeeTitleDTO>, IValidatableObject
    {
        ...
        public EmployeeTitleDTO(string accountId = default(string), string createBy = default(string), string employeeId = default(string), string enterpriseId = default(string), string modifyBy = default(string), string openId = default(string), string taxRegisterNo = default(string), string titleId = default(string), string titleTag = default(string), string userId = default(string))
        {
