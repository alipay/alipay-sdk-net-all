...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class DatadigitalFincloudGeneralsaasOcrServerDetectModel : IEquatable<DatadigitalFincloudGeneralsaasOcrServerDetectModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="ocrType">可识别OCR类型。如，ID_CARD_FRONT 大陆身份证正面；ID_CARD_BACK 大陆身份证反面等。具体支持的类型以接入文档为准。.</param>
        ...
        /// </summary>
        /// <value>可识别OCR类型。如，ID_CARD_FRONT 大陆身份证正面；ID_CARD_BACK 大陆身份证反面等。具体支持的类型以接入文档为准。</value>
