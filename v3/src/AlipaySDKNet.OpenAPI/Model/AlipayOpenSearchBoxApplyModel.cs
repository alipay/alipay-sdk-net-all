...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayOpenSearchBoxApplyModel")]
    public partial class AlipayOpenSearchBoxApplyModel : IEquatable<AlipayOpenSearchBoxApplyModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayOpenSearchBoxApplyModel" /> class.
        /// </summary>
        ...
        /// <param name="customKeywords">自定义触发词，最多可配置10个，限1-8个中文字符。 小程序直达不支持设置此项.</param>
        ...
        /// </summary>
        /// <value>自定义触发词，最多可配置10个，限1-8个中文字符。 小程序直达不支持设置此项</value>
        ...
        /// </summary>
        /// <value>关联账号信息，1-3个。 内部字段均需设置。当为品牌直达时，数组中的第1个账号会被设置为\&quot;账号1\&quot;，也就是将作为搜索直达专区头部的跳转地址</value>
        ...
        /// </summary>
        /// <value>\&quot;服务信息，服务必须审核通过才能申请搜索直达。品牌直达最多可配置同一品牌认证下的小程序4个，小程序直达最多可配置2个。 内部字段均需设置。\&quot;</value>
        ...
        {
            return this.Equals(input as AlipayOpenSearchBoxApplyModel);
        }

        /// <summary>
        /// Returns true if AlipayOpenSearchBoxApplyModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayOpenSearchBoxApplyModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayOpenSearchBoxApplyModel input)
        {
            if (input == null)
            {
                return false;
