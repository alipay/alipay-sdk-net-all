...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ArInvoiceOpenApiResponse")]
    public partial class ArInvoiceOpenApiResponse : IEquatable<ArInvoiceOpenApiResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArInvoiceOpenApiResponse" /> class.
        /// </summary>
        /// <param name="arInvoiceLines">发票行信息集合.</param>
        ...
        /// <param name="online">是否为点在发票  true：是， false：不是.</param>
        /// <param name="outBusinessNoList">外部单据号.</param>
        /// <param name="payee">收款人.</param>
        /// <param name="pdfFileName">PDF附件名称.</param>
        /// <param name="pdfFileUrl">可外网访问的PDF附件的下载链接.</param>
        ...
        /// <param name="relBlueInvoices">发票如果有关联的蓝票则显示发票关联的蓝票信息.</param>
        /// <param name="relRedInvoices">如果发票有关联的红票则为关联的红票的信息.</param>
        /// <param name="reviewer">复核人.</param>
        /// <param name="salesProductNameList">销售产品码字符串数组.</param>
        ...
        /// </summary>
        /// <value>是否为点在发票  true：是， false：不是</value>
        ...
        /// </summary>
        /// <value>外部单据号</value>
        [DataMember(Name = "out_business_no_list", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>PDF附件名称</value>
        [DataMember(Name = "pdf_file_name", EmitDefaultValue = false)]
        public string PdfFileName { get; set; }

        /// <summary>
        /// 可外网访问的PDF附件的下载链接
        /// </summary>
        /// <value>可外网访问的PDF附件的下载链接</value>
        [DataMember(Name = "pdf_file_url", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>发票如果有关联的蓝票则显示发票关联的蓝票信息</value>
        [DataMember(Name = "rel_blue_invoices", EmitDefaultValue = false)]
        public List<ArRelInvoiceOpenApiResponse> RelBlueInvoices { get; set; }

        /// <summary>
        /// 如果发票有关联的红票则为关联的红票的信息
        /// </summary>
        /// <value>如果发票有关联的红票则为关联的红票的信息</value>
        [DataMember(Name = "rel_red_invoices", EmitDefaultValue = false)]
        ...
        /// 销售产品码字符串数组
        /// </summary>
        /// <value>销售产品码字符串数组</value>
        [DataMember(Name = "sales_product_name_list", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OutBusinessNoList: ").Append(OutBusinessNoList).Append("\n");
            ...
            sb.Append("  RelBlueInvoices: ").Append(RelBlueInvoices).Append("\n");
            sb.Append("  RelRedInvoices: ").Append(RelRedInvoices).Append("\n");
            sb.Append("  Reviewer: ").Append(Reviewer).Append("\n");
            sb.Append("  SalesProductNameList: ").Append(SalesProductNameList).Append("\n");
        ...
        {
            return this.Equals(input as ArInvoiceOpenApiResponse);
        }

        /// <summary>
        /// Returns true if ArInvoiceOpenApiResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ArInvoiceOpenApiResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArInvoiceOpenApiResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    input.ArInvoiceLines != null &&
                    this.ArInvoiceLines.SequenceEqual(input.ArInvoiceLines)
                ) && 
                (
                ...
                (
                    this.OutBusinessNoList == input.OutBusinessNoList ||
                    this.OutBusinessNoList != null &&
                    input.OutBusinessNoList != null &&
                    this.OutBusinessNoList.SequenceEqual(input.OutBusinessNoList)
                ) && 
                (
                ...
                (
                    this.PdfFileName == input.PdfFileName ||
                    (this.PdfFileName != null &&
                    this.PdfFileName.Equals(input.PdfFileName))
                ) && 
                (
                    this.PdfFileUrl == input.PdfFileUrl ||
                    (this.PdfFileUrl != null &&
                    this.PdfFileUrl.Equals(input.PdfFileUrl))
                ) && 
                (
                ...
                (
                    this.RelBlueInvoices == input.RelBlueInvoices ||
                    this.RelBlueInvoices != null &&
                    input.RelBlueInvoices != null &&
                    this.RelBlueInvoices.SequenceEqual(input.RelBlueInvoices)
                ) && 
                (
                    this.RelRedInvoices == input.RelRedInvoices ||
                    this.RelRedInvoices != null &&
                    input.RelRedInvoices != null &&
                    this.RelRedInvoices.SequenceEqual(input.RelRedInvoices)
                ) && 
                (
                ...
                (
                    this.SalesProductNameList == input.SalesProductNameList ||
                    this.SalesProductNameList != null &&
                    input.SalesProductNameList != null &&
                    this.SalesProductNameList.SequenceEqual(input.SalesProductNameList)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.OutBusinessNoList.GetHashCode();
                }
                if (this.Payee != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.PdfFileName.GetHashCode();
                }
                if (this.PdfFileUrl != null)
                {
                    hashCode = (hashCode * 59) + this.PdfFileUrl.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.RelBlueInvoices.GetHashCode();
                }
                if (this.RelRedInvoices != null)
                {
                    hashCode = (hashCode * 59) + this.RelRedInvoices.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.SalesProductNameList.GetHashCode();
                }
