...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayFundTransUniTransferModel : IEquatable<AlipayFundTransUniTransferModel>, IValidatableObject
    {
        ...
        /// <param name="businessParams">转账业务请求的扩展参数，支持传入的扩展参数如下： sub_biz_scene 子业务场景，红包业务必传，取值REDPACKET，C2C现金红包、B2C现金红包均需传入.</param>
        /// <param name="mutipleCurrencyDetail">mutipleCurrencyDetail.</param>
        /// <param name="orderTitle">转账业务的标题，用于在支付宝用户的账单里显示.</param>
        /// <param name="originalOrderId">原支付宝业务单号。C2C现金红包-红包领取时，传红包支付时返回的支付宝单号；B2C现金红包、单笔无密转账到支付宝不需要该参数。.</param>
        ...
        /// </summary>
        /// <value>转账业务请求的扩展参数，支持传入的扩展参数如下： sub_biz_scene 子业务场景，红包业务必传，取值REDPACKET，C2C现金红包、B2C现金红包均需传入</value>
        ...
        /// </summary>
        /// <value>原支付宝业务单号。C2C现金红包-红包领取时，传红包支付时返回的支付宝单号；B2C现金红包、单笔无密转账到支付宝不需要该参数。</value>
