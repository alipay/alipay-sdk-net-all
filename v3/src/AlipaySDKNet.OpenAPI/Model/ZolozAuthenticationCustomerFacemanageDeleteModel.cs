...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ZolozAuthenticationCustomerFacemanageDeleteModel")]
    public partial class ZolozAuthenticationCustomerFacemanageDeleteModel : IEquatable<ZolozAuthenticationCustomerFacemanageDeleteModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZolozAuthenticationCustomerFacemanageDeleteModel" /> class.
        /// </summary>
        /// <param name="areacode">地域编码.</param>
        /// <param name="bizType">人脸产品能力.</param>
        /// <param name="bizscale">业务量.</param>
        /// <param name="brandcode">商户品牌.</param>
        /// <param name="devicenum">商户机具唯一编码，关键参数.</param>
        /// <param name="extinfo">拓展参数.</param>
        /// <param name="facetype">入库类型 IDCARD:身份证 ALIPAY_USER:支付宝用户id, ALIPAY_TEL:手机号入库 CUSTOMER:自定义.</param>
        /// <param name="faceval">入库用户信息.</param>
        /// <param name="group">分组.</param>
        /// <param name="storecode">门店编码.</param>
        /// <param name="validtimes">有效期天数，如7天、30天、365天.</param>
        public ZolozAuthenticationCustomerFacemanageDeleteModel(string areacode = default(string), string bizType = default(string), string bizscale = default(string), string brandcode = default(string), string devicenum = default(string), string extinfo = default(string), string facetype = default(string), string faceval = default(string), string group = default(string), string storecode = default(string), string validtimes = default(string))
        {
        ...
        /// </summary>
        /// <value>入库类型 IDCARD:身份证 ALIPAY_USER:支付宝用户id, ALIPAY_TEL:手机号入库 CUSTOMER:自定义</value>
        ...
        {
            return this.Equals(input as ZolozAuthenticationCustomerFacemanageDeleteModel);
        }

        /// <summary>
        /// Returns true if ZolozAuthenticationCustomerFacemanageDeleteModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ZolozAuthenticationCustomerFacemanageDeleteModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZolozAuthenticationCustomerFacemanageDeleteModel input)
        {
            if (input == null)
            {
                return false;
