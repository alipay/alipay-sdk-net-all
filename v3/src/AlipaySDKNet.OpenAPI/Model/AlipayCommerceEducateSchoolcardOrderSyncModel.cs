...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayCommerceEducateSchoolcardOrderSyncModel : IEquatable<AlipayCommerceEducateSchoolcardOrderSyncModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="actualAmount">实际金额（总支付金额）.</param>
        /// <param name="appletAppId">小程序appid.</param>
        /// <param name="cardBalance">校园卡余额.</param>
        /// <param name="cardNo">卡号.</param>
        /// <param name="cardType">卡类型.</param>
        /// <param name="createTime">该笔订单真实的创建时间，需精确到毫秒。时间格式为 yyyy-MM-dd HH:mm:ss.SSS。同一笔订单保持不变.</param>
        ...
        /// <param name="modifiedTime">订单修改时间，时间格式为 yyyy-MM-dd HH:mm:ss.SSS。用于订单状态或数据变化较快的顺序控制，防止乱序。order_modified_time较晚的同步会被最终存储，order_modified_time相同的两次同步会被幂等处理。.</param>
        /// <param name="openId">蚂蚁统一会员ID.</param>
        /// <param name="orderAmount">订单金额.</param>
        /// <param name="orderDetailUrl">订单详情链接.</param>
        /// <param name="orderStatus">订单状态 消费成功 CONSUME_S ；已退款：REFUNDED； 开卡成功 CARD_ACTIVED；消费失败：UN_CHARGE 充值成功 RECHARGE_S.</param>
        /// <param name="outBizNo">外部业务号.</param>
        /// <param name="payAddress">支付地点.</param>
        /// <param name="payMode">付款方式，不传默认展示学校名称+校园卡+（卡号后四位）.</param>
        /// <param name="rakeBackPid">返佣pid.</param>
        /// <param name="schoolId">学校内标.</param>
        /// <param name="schoolPid">学校pid.</param>
        ...
        /// </summary>
        /// <value>该笔订单真实的创建时间，需精确到毫秒。时间格式为 yyyy-MM-dd HH:mm:ss.SSS。同一笔订单保持不变</value>
        ...
        /// </summary>
        /// <value>订单修改时间，时间格式为 yyyy-MM-dd HH:mm:ss.SSS。用于订单状态或数据变化较快的顺序控制，防止乱序。order_modified_time较晚的同步会被最终存储，order_modified_time相同的两次同步会被幂等处理。</value>
        ...
        /// </summary>
        /// <value>订单状态 消费成功 CONSUME_S ；已退款：REFUNDED； 开卡成功 CARD_ACTIVED；消费失败：UN_CHARGE 充值成功 RECHARGE_S</value>
