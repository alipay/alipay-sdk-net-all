...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel : IEquatable<AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel>, IValidatableObject
    {
        ...
        public AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel(string code = default(string), string msg = default(string), string titleCode = default(string), EnterpriseTitleInfo titleInfo = default(EnterpriseTitleInfo))
        {
            this.Code = code;
            this.Msg = msg;
