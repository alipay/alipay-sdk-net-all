...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ExtendParams : IEquatable<ExtendParams>, IValidatableObject
    {
        ...
        public ExtendParams(string cardType = default(string), string hbFqNum = default(string), string hbFqSellerPercent = default(string), string industryRefluxInfo = default(string), string royaltyFreeze = default(string), string specifiedSellerName = default(string), string sysServiceProviderId = default(string), string tradeComponentOrderId = default(string))
        {
