...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class VoucherSendModeInfo : IEquatable<VoucherSendModeInfo>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="deliveryChannelList">推广渠道列表.</param>
        ...
        public VoucherSendModeInfo(List<string> deliveryChannelList = default(List<string>), VoucherPackageModeInfo voucherPackageModeInfo = default(VoucherPackageModeInfo), VoucherSaleModeInfo voucherSaleModeInfo = default(VoucherSaleModeInfo), string voucherSendMode = default(string), VoucherSendRuleInfo voucherSendRuleInfo = default(VoucherSendRuleInfo))
        {
        ...
        /// </summary>
        /// <value>推广渠道列表</value>
        [DataMember(Name = "delivery_channel_list", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeliveryChannelList: ").Append(DeliveryChannelList).Append("\n");
        ...
        public bool Equals(VoucherSendModeInfo input)
        {
            ...
            return 
                (
                    this.DeliveryChannelList == input.DeliveryChannelList ||
                    this.DeliveryChannelList != null &&
                    input.DeliveryChannelList != null &&
                    this.DeliveryChannelList.SequenceEqual(input.DeliveryChannelList)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DeliveryChannelList.GetHashCode();
                }
