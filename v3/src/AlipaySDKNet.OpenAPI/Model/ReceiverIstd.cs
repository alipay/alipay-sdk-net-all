...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// ReceiverIstd
    /// </summary>
    [DataContract(Name = "ReceiverIstd")]
    public partial class ReceiverIstd : IEquatable<ReceiverIstd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceiverIstd" /> class.
        /// </summary>
        /// <param name="address">地址(街道、小区、大厦等，用于定位).</param>
        /// <param name="addressDetail">地址详情(楼号、单元号、层号).</param>
        /// <param name="city">城市名称，如杭州市.</param>
        /// <param name="coordinateType">坐标类型，0：火星坐标（高德，腾讯地图均采用火星坐标） 1：百度坐标。目前只支持0:火星坐标.</param>
        /// <param name="lat">纬度.</param>
        /// <param name="lng">经度.</param>
        /// <param name="mobileNo">手机号.</param>
        /// <param name="name">姓名.</param>
        public ReceiverIstd(string address = default(string), string addressDetail = default(string), string city = default(string), int coordinateType = default(int), string lat = default(string), string lng = default(string), string mobileNo = default(string), string name = default(string))
        {
        ...
        /// </summary>
        /// <value>坐标类型，0：火星坐标（高德，腾讯地图均采用火星坐标） 1：百度坐标。目前只支持0:火星坐标</value>
        ...
        {
            return this.Equals(input as ReceiverIstd);
        }

        /// <summary>
        /// Returns true if ReceiverIstd instances are equal
        /// </summary>
        /// <param name="input">Instance of ReceiverIstd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReceiverIstd input)
        {
            if (input == null)
            {
                return false;
