...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// ItemInfo
    /// </summary>
    [DataContract(Name = "ItemInfo")]
    public partial class ItemInfo : IEquatable<ItemInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public ItemInfo(List<string> itemIds = default(List<string>), List<string> itemImgs = default(List<string>), string itemLink = default(string), string itemName = default(string), string itemText = default(string), string maxDiscountNum = default(string), string minConsumeNum = default(string), string originalPrice = default(string), string skuMinConsume = default(string), string totalMaxDiscountNum = default(string))
        {
        ...
        /// <summary>
        /// Returns true if ItemInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemInfo to be compared</param>
        /// <returns>Boolean</returns>
