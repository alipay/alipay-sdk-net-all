...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ConversionData : IEquatable<ConversionData>, IValidatableObject
    {
        ...
        public ConversionData(string bizNo = default(string), string callbackExtInfo = default(string), string conversionAmount = default(string), string conversionId = default(string), int conversionTime = default(int), string conversionType = default(string), string creativeId = default(string), string dataId = default(string), string dataSrcType = default(string), string groupId = default(string), string planId = default(string), string principalId = default(string), string principalTag = default(string), List<ConversionProperty> propertyList = default(List<ConversionProperty>), string source = default(string), string targetId = default(string), string targetType = default(string), string uuid = default(string), string uuidType = default(string))
        {
            this.BizNo = bizNo;
