...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayMarketingActivityVoucherPublishModel")]
    public partial class AlipayMarketingActivityVoucherPublishModel : IEquatable<AlipayMarketingActivityVoucherPublishModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayMarketingActivityVoucherPublishModel" /> class.
        /// </summary>
        ...
        public AlipayMarketingActivityVoucherPublishModel(string activityId = default(string), string merchantAccessMode = default(string), string outBizNo = default(string))
        {
        ...
        {
            return this.Equals(input as AlipayMarketingActivityVoucherPublishModel);
        }

        /// <summary>
        /// Returns true if AlipayMarketingActivityVoucherPublishModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayMarketingActivityVoucherPublishModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayMarketingActivityVoucherPublishModel input)
        {
            if (input == null)
            {
                return false;
