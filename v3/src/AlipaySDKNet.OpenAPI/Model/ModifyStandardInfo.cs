...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ModifyStandardInfo : IEquatable<ModifyStandardInfo>, IValidatableObject
    {
        ...
        public ModifyStandardInfo(List<StandardConditionInfo> addConditionList = default(List<StandardConditionInfo>), AssetShareSourceInfo assetShareSourceInfo = default(AssetShareSourceInfo), string consumeMode = default(string), List<string> deleteConditionIdList = default(List<string>), List<StandardConditionInfo> modifyConditionList = default(List<StandardConditionInfo>), string openRuleId = default(string), string paymentPolicy = default(string), int personalQrcodeMode = default(int), string standardDesc = default(string), string standardId = default(string), string standardName = default(string))
        {
