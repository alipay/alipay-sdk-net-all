...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AntMerchantExpandShopCreateModel : IEquatable<AntMerchantExpandShopCreateModel>, IValidatableObject
    {
        ...
        /// <param name="certImage">营业执照图片，需传入&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload\&quot;&gt;ant.merchant.expand.indirect.image.upload&lt;/a&gt; 接口上传图片后得到的 image_id。.</param>
        /// <param name="certName">营业执照名称，填写值为营业执照或统一社会信用代码证上的名称。 注意：若传入 cert_no，则本参数必填。.</param>
        /// <param name="certNo">证件号码，请填写店铺营业执照号。.</param>
        /// <param name="certType">证件类型，取值范围：201：营业执照；2011:多证合一(统一社会信用代码)。 注意：若传入 cert_no，则本参数必填。.</param>
        ...
        /// <param name="legalCertNo">法人身份证号。通过蚂蚁门店管理能力创建门店时可选。.</param>
        /// <param name="legalName">法人名称。通过蚂蚁门店管理能力创建门店时可选。.</param>
        /// <param name="licenseAuthLetterImage">营业执照授权函。需传入&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload\&quot;&gt;ant.merchant.expand.indirect.image.upload&lt;/a&gt; 接口上传图片后得到的 image_id。 通过蚂蚁门店管理能力创建门店时可选。.</param>
        /// <param name="memo">备注.</param>
        /// <param name="outDoorImages">门头照 id，需传入&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload\&quot;&gt;ant.merchant.expand.indirect.image.upload&lt;/a&gt; 接口上传图片后得到的 image_id。 通过蚂蚁门店管理能力创建门店时可选。.</param>
        ...
        /// </summary>
        /// <value>营业执照图片，需传入&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload\&quot;&gt;ant.merchant.expand.indirect.image.upload&lt;/a&gt; 接口上传图片后得到的 image_id。</value>
        ...
        /// </summary>
        /// <value>营业执照名称，填写值为营业执照或统一社会信用代码证上的名称。 注意：若传入 cert_no，则本参数必填。</value>
        ...
        /// </summary>
        /// <value>证件类型，取值范围：201：营业执照；2011:多证合一(统一社会信用代码)。 注意：若传入 cert_no，则本参数必填。</value>
        ...
        /// </summary>
        /// <value>法人身份证号。通过蚂蚁门店管理能力创建门店时可选。</value>
        ...
        /// </summary>
        /// <value>法人名称。通过蚂蚁门店管理能力创建门店时可选。</value>
        ...
        /// </summary>
        /// <value>营业执照授权函。需传入&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload\&quot;&gt;ant.merchant.expand.indirect.image.upload&lt;/a&gt; 接口上传图片后得到的 image_id。 通过蚂蚁门店管理能力创建门店时可选。</value>
        ...
        /// </summary>
        /// <value>门头照 id，需传入&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload\&quot;&gt;ant.merchant.expand.indirect.image.upload&lt;/a&gt; 接口上传图片后得到的 image_id。 通过蚂蚁门店管理能力创建门店时可选。</value>
