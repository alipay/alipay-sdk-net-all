...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayCommerceEcEmployeeAddModel : IEquatable<AlipayCommerceEcEmployeeAddModel>, IValidatableObject
    {
        ...
        /// <param name="employeeCertType">证件类型，用于企业人脸库员工刷脸开通时的核验， 枚举支持：IDENTITY_CARD身份证，PASS_PORT护照，STU_NUM学生学号，COMPANY_NUM工号，TAIWAN_CARD台胞证，HK_MC_CARD港澳证件.</param>
        /// <param name="employeeEmail">员工邮箱.</param>
        /// <param name="employeeMobile">员工手机号 1.和identity二选一.</param>
        /// <param name="employeeName">员工姓名.</param>
        /// <param name="employeeNo">员工编号.</param>
        /// <param name="enterpriseId">企业id.</param>
        /// <param name="identity">身份 1.和employee_mobile二选一 2.对应身份类型进行传参，企业支付宝登录账号(支持手机号或者邮箱)或企业支付宝会员id(对应2088开头的支付宝会员id).</param>
        /// <param name="identityOpenId">当identity_type为ALIPAY_USER_ID时，此字段传入open_id.</param>
        /// <param name="identityType">身份类型 ALIPAY_LOGON_ID(企业支付宝登录账号) ALIPAY_USER_ID(企业支付宝会员id).</param>
        /// <param name="iotCheckType">员工刷脸加入企业人脸库时的核验方式，如果设置为business_facepay_checkall，则employee_name、employee_cert_type、employee_cert_no必传，如果不传则默认不核验。.</param>
        /// <param name="iotVid">员工在企业人脸库的人脸唯一标识，支持自定义传入，如果未传入则会默认生成.</param>
        /// <param name="roleList">角色列表，目前只支持填一种角色，默认为USER USER：普通员工 ADMIN：管理员.</param>
        public AlipayCommerceEcEmployeeAddModel(List<string> departmentIds = default(List<string>), string employeeCertNo = default(string), string employeeCertType = default(string), string employeeEmail = default(string), string employeeMobile = default(string), string employeeName = default(string), string employeeNo = default(string), string enterpriseId = default(string), string identity = default(string), string identityOpenId = default(string), string identityType = default(string), string iotCheckType = default(string), string iotVid = default(string), List<string> roleList = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>证件类型，用于企业人脸库员工刷脸开通时的核验， 枚举支持：IDENTITY_CARD身份证，PASS_PORT护照，STU_NUM学生学号，COMPANY_NUM工号，TAIWAN_CARD台胞证，HK_MC_CARD港澳证件</value>
        ...
        /// </summary>
        /// <value>员工手机号 1.和identity二选一</value>
        ...
        /// </summary>
        /// <value>身份 1.和employee_mobile二选一 2.对应身份类型进行传参，企业支付宝登录账号(支持手机号或者邮箱)或企业支付宝会员id(对应2088开头的支付宝会员id)</value>
        ...
        /// </summary>
        /// <value>身份类型 ALIPAY_LOGON_ID(企业支付宝登录账号) ALIPAY_USER_ID(企业支付宝会员id)</value>
        ...
        /// </summary>
        /// <value>员工刷脸加入企业人脸库时的核验方式，如果设置为business_facepay_checkall，则employee_name、employee_cert_type、employee_cert_no必传，如果不传则默认不核验。</value>
        ...
        /// </summary>
        /// <value>员工在企业人脸库的人脸唯一标识，支持自定义传入，如果未传入则会默认生成</value>
        ...
        /// </summary>
        /// <value>角色列表，目前只支持填一种角色，默认为USER USER：普通员工 ADMIN：管理员</value>
