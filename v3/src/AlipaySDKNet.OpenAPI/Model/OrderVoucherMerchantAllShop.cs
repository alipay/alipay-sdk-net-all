...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderVoucherMerchantAllShop")]
    public partial class OrderVoucherMerchantAllShop : IEquatable<OrderVoucherMerchantAllShop>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderVoucherMerchantAllShop" /> class.
        /// </summary>
        ...
        public OrderVoucherMerchantAllShop(List<string> excludeShopIds = default(List<string>))
        {
        ...
        {
            return this.Equals(input as OrderVoucherMerchantAllShop);
        }

        /// <summary>
        /// Returns true if OrderVoucherMerchantAllShop instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderVoucherMerchantAllShop to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderVoucherMerchantAllShop input)
        {
            if (input == null)
            {
                return false;
