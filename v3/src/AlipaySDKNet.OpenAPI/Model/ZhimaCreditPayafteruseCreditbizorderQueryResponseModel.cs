...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ZhimaCreditPayafteruseCreditbizorderQueryResponseModel : IEquatable<ZhimaCreditPayafteruseCreditbizorderQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="totalCreditPayAmount">信用服务订单中信用支付金额，不包含支付宝营销金额.</param>
        /// <param name="tradeNo">支付宝交易号。 先用后付产品下必传；芝麻风险评估与召回产品下不传。.</param>
        /// <param name="zmServiceId">芝麻信用服务ID.</param>
        public ZhimaCreditPayafteruseCreditbizorderQueryResponseModel(string createTime = default(string), string creditAgreementId = default(string), string creditBizOrderId = default(string), string orderStatus = default(string), string productCode = default(string), string totalAmount = default(string), string totalCreditPayAmount = default(string), string tradeNo = default(string), string zmServiceId = default(string))
        {
        ...
        /// </summary>
        /// <value>信用服务订单中信用支付金额，不包含支付宝营销金额</value>
        [DataMember(Name = "total_credit_pay_amount", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TotalCreditPayAmount: ").Append(TotalCreditPayAmount).Append("\n");
        ...
        public bool Equals(ZhimaCreditPayafteruseCreditbizorderQueryResponseModel input)
        {
            ...
            return 
                ...
                (
                    this.TotalCreditPayAmount == input.TotalCreditPayAmount ||
                    (this.TotalCreditPayAmount != null &&
                    this.TotalCreditPayAmount.Equals(input.TotalCreditPayAmount))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TotalCreditPayAmount != null)
                {
                    hashCode = (hashCode * 59) + this.TotalCreditPayAmount.GetHashCode();
                }
