...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayCommerceLogisticsOrderIstdretryCreateModel")]
    public partial class AlipayCommerceLogisticsOrderIstdretryCreateModel : IEquatable<AlipayCommerceLogisticsOrderIstdretryCreateModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayCommerceLogisticsOrderIstdretryCreateModel" /> class.
        /// </summary>
        ...
        /// <param name="logisticsToken">下即时配送订单token, 配送公司可以返回此字段，当商家下单时候带上这个字段，保证在一段时间内运费不变.</param>
        /// <param name="openId">消费者id， 如果consumer_source是alipay，则consumer_id必须是支付宝用户openId；如果consumer_source是wx，则consumer_id可以为空.</param>
        /// <param name="orderExtIstd">orderExtIstd.</param>
        /// <param name="outOrderNo">商家订单号.</param>
        /// <param name="receiver">receiver.</param>
        /// <param name="sender">sender.</param>
        /// <param name="shopNo">商家门店编号.</param>
        public AlipayCommerceLogisticsOrderIstdretryCreateModel(string consumerId = default(string), ConsumerNotifyIstd consumerNotify = default(ConsumerNotifyIstd), string consumerSource = default(string), List<GoodsDetailIstd> goodsDetails = default(List<GoodsDetailIstd>), GoodsInfoIstd goodsInfo = default(GoodsInfoIstd), string logisticsCode = default(string), string logisticsToken = default(string), string openId = default(string), OrderExtIstd orderExtIstd = default(OrderExtIstd), string outOrderNo = default(string), ReceiverIstd receiver = default(ReceiverIstd), SenderIstd sender = default(SenderIstd), string shopNo = default(string))
        {
        ...
        /// </summary>
        /// <value>下即时配送订单token, 配送公司可以返回此字段，当商家下单时候带上这个字段，保证在一段时间内运费不变</value>
        ...
        /// </summary>
        /// <value>消费者id， 如果consumer_source是alipay，则consumer_id必须是支付宝用户openId；如果consumer_source是wx，则consumer_id可以为空</value>
        ...
        {
            return this.Equals(input as AlipayCommerceLogisticsOrderIstdretryCreateModel);
        }

        /// <summary>
        /// Returns true if AlipayCommerceLogisticsOrderIstdretryCreateModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayCommerceLogisticsOrderIstdretryCreateModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayCommerceLogisticsOrderIstdretryCreateModel input)
        {
            if (input == null)
            {
                return false;
