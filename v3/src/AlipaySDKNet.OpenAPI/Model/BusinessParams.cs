...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class BusinessParams : IEquatable<BusinessParams>, IValidatableObject
    {
        ...
        /// <param name="buyerMemo">买家备注信息.</param>
        ...
        /// <param name="forcePwd">收银台强制密码核身参数，实际收银侧会根据这个参数为true并结合业务场景来判断是否密码核身.</param>
        ...
        public BusinessParams(string actualOrderTime = default(string), string buyerMemo = default(string), string campusCard = default(string), string cardType = default(string), string enterprisePayAmount = default(string), string enterprisePayInfo = default(string), string forcePwd = default(string), string goodTaxes = default(string), string mcCreateTradeIp = default(string), string priorityUnfreezeAsset = default(string), string tinyAppMerchantBizType = default(string))
        {
        ...
        /// </summary>
        /// <value>买家备注信息</value>
        [DataMember(Name = "buyer_memo", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>收银台强制密码核身参数，实际收银侧会根据这个参数为true并结合业务场景来判断是否密码核身</value>
        [DataMember(Name = "force_pwd", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BuyerMemo: ").Append(BuyerMemo).Append("\n");
            ...
            sb.Append("  ForcePwd: ").Append(ForcePwd).Append("\n");
        ...
        public bool Equals(BusinessParams input)
        {
            ...
            return 
                ...
                (
                    this.BuyerMemo == input.BuyerMemo ||
                    (this.BuyerMemo != null &&
                    this.BuyerMemo.Equals(input.BuyerMemo))
                ) && 
                (
                ...
                (
                    this.ForcePwd == input.ForcePwd ||
                    (this.ForcePwd != null &&
                    this.ForcePwd.Equals(input.ForcePwd))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.BuyerMemo.GetHashCode();
                }
                ...
                if (this.ForcePwd != null)
                {
                    hashCode = (hashCode * 59) + this.ForcePwd.GetHashCode();
                }
