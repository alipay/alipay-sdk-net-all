...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayTradeRefundResponseModel : IEquatable<AlipayTradeRefundResponseModel>, IValidatableObject
    {
        ...
        /// <param name="presentRefundBuyerAmount">本次退款金额中买家退款金额; 该字段默认不返回；.</param>
        /// <param name="presentRefundDiscountAmount">本次退款金额中平台优惠退款金额； 该字段默认不返回；.</param>
        /// <param name="presentRefundMdiscountAmount">本次退款金额中商家优惠退款金额； 该字段默认不返回；.</param>
        /// <param name="refundChargeAmount">本次退款针对收款方的退收费金额； 只在机构间联模式下返回，其它场景下不返回该字段；.</param>
        ...
        /// <param name="refundFee">退款总金额。 指该笔交易累计已经退款成功的金额。.</param>
        /// <param name="refundHybAmount">本次请求退惠营宝金额.</param>
        ...
        /// <param name="sendBackFee">本次商户实际退回金额。 说明：如需获取该值，需在入参query_options中传入 refund_detail_item_list。.</param>
        /// <param name="storeName">交易在支付时候的门店名称.</param>
        /// <param name="tradeNo">2013112011001004330000121536.</param>
        ...
        /// </summary>
        /// <value>本次退款金额中买家退款金额; 该字段默认不返回；</value>
        ...
        /// </summary>
        /// <value>本次退款金额中平台优惠退款金额； 该字段默认不返回；</value>
        ...
        /// </summary>
        /// <value>本次退款金额中商家优惠退款金额； 该字段默认不返回；</value>
        ...
        /// </summary>
        /// <value>本次退款针对收款方的退收费金额； 只在机构间联模式下返回，其它场景下不返回该字段；</value>
        ...
        /// </summary>
        /// <value>退款总金额。 指该笔交易累计已经退款成功的金额。</value>
        ...
        /// </summary>
        /// <value>本次商户实际退回金额。 说明：如需获取该值，需在入参query_options中传入 refund_detail_item_list。</value>
        ...
        /// </summary>
        /// <value>2013112011001004330000121536</value>
