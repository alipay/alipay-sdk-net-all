...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayCommerceEcEnterpriseInfoModifyModel : IEquatable<AlipayCommerceEcEnterpriseInfoModifyModel>, IValidatableObject
    {
        ...
        /// <param name="reliableProfiles">reliableProfiles.</param>
        public AlipayCommerceEcEnterpriseInfoModifyModel(string enterpriseAlias = default(string), string enterpriseId = default(string), string enterpriseName = default(string), ReliableEnterpriseProfilesDTO reliableProfiles = default(ReliableEnterpriseProfilesDTO))
        {
        ...
        /// <summary>
        /// Gets or Sets ReliableProfiles
        /// </summary>
        [DataMember(Name = "reliable_profiles", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReliableProfiles: ").Append(ReliableProfiles).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(AlipayCommerceEcEnterpriseInfoModifyModel input)
        {
            ...
            return 
                ...
                (
                    this.ReliableProfiles == input.ReliableProfiles ||
                    (this.ReliableProfiles != null &&
                    this.ReliableProfiles.Equals(input.ReliableProfiles))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReliableProfiles != null)
                {
                    hashCode = (hashCode * 59) + this.ReliableProfiles.GetHashCode();
                }
                return hashCode;
            }
        }
