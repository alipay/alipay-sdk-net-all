...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceEnterpriseconsumeEnterpriseopenruleModifyModel : IEquatable<AlipayEbppInvoiceEnterpriseconsumeEnterpriseopenruleModifyModel>, IValidatableObject
    {
        ...
        /// <param name="invoiceRuleName">开票名称.</param>
        /// <param name="invoiceTitleId">汇总开需要抬头，笔笔开不需要传抬头.</param>
        /// <param name="sellerType">销方类型：TP开票、商户开票 枚举定义：MERCHANT（商户）、TP（TP）.</param>
        public AlipayEbppInvoiceEnterpriseconsumeEnterpriseopenruleModifyModel(string accountId = default(string), string agreementNo = default(string), string enterpriseId = default(string), string invoiceRuleId = default(string), string invoiceRuleName = default(string), string invoiceTitleId = default(string), string sellerType = default(string))
        {
        ...
        /// </summary>
        /// <value>销方类型：TP开票、商户开票 枚举定义：MERCHANT（商户）、TP（TP）</value>
