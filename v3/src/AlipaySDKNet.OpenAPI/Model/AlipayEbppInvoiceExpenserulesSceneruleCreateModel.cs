...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceExpenserulesSceneruleCreateModel : IEquatable<AlipayEbppInvoiceExpenserulesSceneruleCreateModel>, IValidatableObject
    {
        ...
        /// <param name="expenseType">费用类型 枚举值：MEAL（餐饮），METRO（地铁）.</param>
        ...
        /// <param name="sceneType">因公场景 枚举值：OVERTIME（加班），SUBSIDY（补贴福利），TRAVEL（差旅）.</param>
        ...
        /// </summary>
        /// <value>费用类型 枚举值：MEAL（餐饮），METRO（地铁）</value>
        ...
        /// </summary>
        /// <value>因公场景 枚举值：OVERTIME（加班），SUBSIDY（补贴福利），TRAVEL（差旅）</value>
