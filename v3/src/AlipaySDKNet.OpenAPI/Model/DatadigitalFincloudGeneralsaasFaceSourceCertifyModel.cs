...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class DatadigitalFincloudGeneralsaasFaceSourceCertifyModel : IEquatable<DatadigitalFincloudGeneralsaasFaceSourceCertifyModel>, IValidatableObject
    {
        ...
        public DatadigitalFincloudGeneralsaasFaceSourceCertifyModel(string certName = default(string), string certNo = default(string), string certType = default(string), string livenessStrategy = default(string), string outerBizNo = default(string), string phone = default(string), bool reserved = default(bool), string securityStrategy = default(string))
        {
