...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayOpenAgentOfflinepaymentSignErrorResponseModel")]
    public partial class AlipayOpenAgentOfflinepaymentSignErrorResponseModel : IEquatable<AlipayOpenAgentOfflinepaymentSignErrorResponseModel>, IValidatableObject
    {
        /// <summary>
        /// 错误码
        /// </summary>
        ...
        public enum CodeEnum
        {
            ...
            /// <summary>
            /// Enum ISVNOPERMISSION for value: ISV_NO_PERMISSION
            /// </summary>
            [EnumMember(Value = "ISV_NO_PERMISSION")]
            ISVNOPERMISSION = 27,

            /// <summary>
            /// Enum AGENTSIGNINAUDITBYSAMEISV for value: AGENT_SIGN_IN_AUDIT_BY_SAME_ISV
            /// </summary>
            [EnumMember(Value = "AGENT_SIGN_IN_AUDIT_BY_SAME_ISV")]
            AGENTSIGNINAUDITBYSAMEISV = 28,

            /// <summary>
            /// Enum AGENTSIGNINAUDITBYDIFFISV for value: AGENT_SIGN_IN_AUDIT_BY_DIFF_ISV
            /// </summary>
            [EnumMember(Value = "AGENT_SIGN_IN_AUDIT_BY_DIFF_ISV")]
            AGENTSIGNINAUDITBYDIFFISV = 29,

            /// <summary>
            /// Enum AGENTSIGNCONFIRMBYSAMEISV for value: AGENT_SIGN_CONFIRM_BY_SAME_ISV
            /// </summary>
            [EnumMember(Value = "AGENT_SIGN_CONFIRM_BY_SAME_ISV")]
            AGENTSIGNCONFIRMBYSAMEISV = 30,

            /// <summary>
            /// Enum AGENTSIGNCONFIRMBYDIFFISV for value: AGENT_SIGN_CONFIRM_BY_DIFF_ISV
            /// </summary>
            [EnumMember(Value = "AGENT_SIGN_CONFIRM_BY_DIFF_ISV")]
            AGENTSIGNCONFIRMBYDIFFISV = 31,

            /// <summary>
            /// Enum AGENTSIGNVALIDBYSAMEISV for value: AGENT_SIGN_VALID_BY_SAME_ISV
            /// </summary>
            [EnumMember(Value = "AGENT_SIGN_VALID_BY_SAME_ISV")]
            AGENTSIGNVALIDBYSAMEISV = 32,

            /// <summary>
            /// Enum SHOPSIGNBOARDPICRISK for value: SHOP_SIGN_BOARD_PIC_RISK
            /// </summary>
            [EnumMember(Value = "SHOP_SIGN_BOARD_PIC_RISK")]
            SHOPSIGNBOARDPICRISK = 33,

            /// <summary>
            /// Enum BUSINESSLICENSEPICRISK for value: BUSINESS_LICENSE_PIC_RISK
            /// </summary>
            [EnumMember(Value = "BUSINESS_LICENSE_PIC_RISK")]
            BUSINESSLICENSEPICRISK = 34,

            /// <summary>
            /// Enum AGENTSIGNPRODUCTINFORBIDDEN for value: AGENT_SIGN_PRODUCT_IN_FORBIDDEN
            /// </summary>
            [EnumMember(Value = "AGENT_SIGN_PRODUCT_IN_FORBIDDEN")]
            AGENTSIGNPRODUCTINFORBIDDEN = 35,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayOpenAgentOfflinepaymentSignErrorResponseModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AlipayOpenAgentOfflinepaymentSignErrorResponseModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayOpenAgentOfflinepaymentSignErrorResponseModel" /> class.
        /// </summary>
        ...
        public AlipayOpenAgentOfflinepaymentSignErrorResponseModel(CodeEnum code = default(CodeEnum), string links = default(string), string message = default(string))
        {
            this.Code = code;
            // to ensure "message" is required (not null)
            // if (message == null)
            // {
            //     throw new ArgumentNullException("message is a required property for AlipayOpenAgentOfflinepaymentSignErrorResponseModel and cannot be null");
            // }
        ...
        {
            return this.Equals(input as AlipayOpenAgentOfflinepaymentSignErrorResponseModel);
        }

        /// <summary>
        /// Returns true if AlipayOpenAgentOfflinepaymentSignErrorResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayOpenAgentOfflinepaymentSignErrorResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayOpenAgentOfflinepaymentSignErrorResponseModel input)
        {
            if (input == null)
            {
                return false;
