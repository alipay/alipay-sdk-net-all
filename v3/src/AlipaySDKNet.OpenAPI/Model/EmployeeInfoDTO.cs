...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class EmployeeInfoDTO : IEquatable<EmployeeInfoDTO>, IValidatableObject
    {
        ...
        /// <param name="employeeCertNo">证件号，手机号，邮箱三个必填其一.</param>
        /// <param name="employeeCertType">证件类型，当证件号不为空时必填.</param>
        /// <param name="employeeId">员工id.</param>
        /// <param name="employeeName">员工姓名.</param>
        /// <param name="employeeNo">员工工号.</param>
        /// <param name="encryptCertNo">加密身份证号，当加密类型不为空时必填.</param>
        /// <param name="encryptMobile">加密手机号，当加密类型不为空时必填.</param>
        ...
        public EmployeeInfoDTO(string activate = default(string), List<EmployeeDepartmentDTO> departmentList = default(List<EmployeeDepartmentDTO>), string email = default(string), string employeeCertNo = default(string), string employeeCertType = default(string), string employeeId = default(string), string employeeName = default(string), string employeeNo = default(string), string encryptCertNo = default(string), string encryptMobile = default(string), string gmtCreate = default(string), string gmtModified = default(string), string iotFaceStatus = default(string), string iotVid = default(string), string mobile = default(string), string openId = default(string), List<string> roleList = default(List<string>), string userId = default(string))
        {
        ...
        /// 加密身份证号，当加密类型不为空时必填
        /// </summary>
        /// <value>加密身份证号，当加密类型不为空时必填</value>
