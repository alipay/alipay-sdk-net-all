...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayFundTransUniTransferResponseModel : IEquatable<AlipayFundTransUniTransferResponseModel>, IValidatableObject
    {
        ...
        public AlipayFundTransUniTransferResponseModel(string amount = default(string), string orderId = default(string), string outBizNo = default(string), string payFundOrderId = default(string), string settleSerialNo = default(string), string status = default(string), string transDate = default(string))
        {
            this.Amount = amount;
