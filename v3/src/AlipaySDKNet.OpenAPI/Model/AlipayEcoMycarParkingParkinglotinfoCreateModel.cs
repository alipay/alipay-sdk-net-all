...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayEcoMycarParkingParkinglotinfoCreateModel")]
    public partial class AlipayEcoMycarParkingParkinglotinfoCreateModel : IEquatable<AlipayEcoMycarParkingParkinglotinfoCreateModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayEcoMycarParkingParkinglotinfoCreateModel" /> class.
        /// </summary>
        /// <param name="agentId">服务商的支付宝账号ID（2088开头的16位纯数字，&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/common/02ncut\&quot;&gt;获取方式&lt;/a&gt;），由服务商提供给ISV.</param>
        ...
        /// <param name="contactEmali">该参数废弃.</param>
        ...
        /// <param name="mchntId">收款方的支付宝账号ID（2088开头的16位纯数字，&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/common/02ncut\&quot;&gt;获取方式&lt;/a&gt;），由停车场收款的业主方提供给ISV，该字段暂用于机具和物料申领.</param>
        ...
        /// <param name="outParkingId">ISV停车场ID，由ISV 自定义，同一个isv或商户范围内唯一.</param>
        ...
        /// <param name="payType">支付方式。枚举支持： 1：表示支付宝在线缴费。 2：表示支付宝代扣缴费。 3：表示当面付。 4:  现金 说明：如支持多种方式以 &#39;,&#39; 进行分隔。.</param>
        ...
        public AlipayEcoMycarParkingParkinglotinfoCreateModel(string agentId = default(string), List<BusinessItem> businessIsv = default(List<BusinessItem>), string chargeSumSpace = default(string), List<ParkingLotChargingRuleInfo> chargingRule = default(List<ParkingLotChargingRuleInfo>), string cityId = default(string), string contactAlipay = default(string), string contactEmali = default(string), string contactMobile = default(string), string contactName = default(string), string contactTel = default(string), string contactWeixin = default(string), string equipmentName = default(string), string isSupportInvoice = default(string), string isvMobile = default(string), string latitude = default(string), string longitude = default(string), string mchntId = default(string), string originalIsvAppid = default(string), string originalIsvMobile = default(string), string originalIsvName = default(string), string originalIsvPid = default(string), string outParkingId = default(string), string parkingAddress = default(string), string parkingEndTime = default(string), string parkingFeeDescription = default(string), string parkingFeeDescriptionImg = default(string), string parkingLotType = default(string), string parkingMobile = default(string), string parkingName = default(string), string parkingNumber = default(string), string parkingPoiid = default(string), string parkingStartTime = default(string), string parkingType = default(string), string payType = default(string), string paymentMode = default(string), string serivceUrl = default(string), List<ParkingLotServiceInfo> serviceList = default(List<ParkingLotServiceInfo>), string shopingmallId = default(string), string sumSpace = default(string), string supportAfterPay = default(string), string timeOut = default(string))
        {
        ...
        /// </summary>
        /// <value>服务商的支付宝账号ID（2088开头的16位纯数字，&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/common/02ncut\&quot;&gt;获取方式&lt;/a&gt;），由服务商提供给ISV</value>
        ...
        /// </summary>
        /// <value>该参数废弃</value>
        [DataMember(Name = "contact_emali", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>收款方的支付宝账号ID（2088开头的16位纯数字，&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/common/02ncut\&quot;&gt;获取方式&lt;/a&gt;），由停车场收款的业主方提供给ISV，该字段暂用于机具和物料申领</value>
        ...
        /// </summary>
        /// <value>ISV停车场ID，由ISV 自定义，同一个isv或商户范围内唯一</value>
        ...
        /// </summary>
        /// <value>支付方式。枚举支持： 1：表示支付宝在线缴费。 2：表示支付宝代扣缴费。 3：表示当面付。 4:  现金 说明：如支持多种方式以 &#39;,&#39; 进行分隔。</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ContactEmali: ").Append(ContactEmali).Append("\n");
        ...
        {
            return this.Equals(input as AlipayEcoMycarParkingParkinglotinfoCreateModel);
        }

        /// <summary>
        /// Returns true if AlipayEcoMycarParkingParkinglotinfoCreateModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayEcoMycarParkingParkinglotinfoCreateModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayEcoMycarParkingParkinglotinfoCreateModel input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ContactEmali == input.ContactEmali ||
                    (this.ContactEmali != null &&
                    this.ContactEmali.Equals(input.ContactEmali))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ContactEmali != null)
                {
                    hashCode = (hashCode * 59) + this.ContactEmali.GetHashCode();
                }
