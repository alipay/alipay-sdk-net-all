...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayOpenSearchBoxQueryResponseModel : IEquatable<AlipayOpenSearchBoxQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="areaKeywordModule">areaKeywordModule.</param>
        ...
        /// <summary>
        /// Gets or Sets AreaKeywordModule
        /// </summary>
        [DataMember(Name = "area_keyword_module", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AreaKeywordModule: ").Append(AreaKeywordModule).Append("\n");
        ...
        public bool Equals(AlipayOpenSearchBoxQueryResponseModel input)
        {
            ...
            return 
                ...
                (
                    this.AreaKeywordModule == input.AreaKeywordModule ||
                    (this.AreaKeywordModule != null &&
                    this.AreaKeywordModule.Equals(input.AreaKeywordModule))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AreaKeywordModule != null)
                {
                    hashCode = (hashCode * 59) + this.AreaKeywordModule.GetHashCode();
                }
