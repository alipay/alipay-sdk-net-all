...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class InstitutionBasicInfo : IEquatable<InstitutionBasicInfo>, IValidatableObject
    {
        ...
        /// <param name="effective">制度是否启用,1启用0不启用.</param>
        ...
        public InstitutionBasicInfo(string consultMode = default(string), string effective = default(string), string effectiveEndDate = default(string), string effectiveStartDate = default(string), string institutionDesc = default(string), string institutionId = default(string), string institutionName = default(string))
        {
