...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class McardNotifyMessage : IEquatable<McardNotifyMessage>, IValidatableObject
    {
        ...
        /// <param name="messageType">消息类型，每种消息都定义了固定消息模板，  POINT_UPDATE：积分变更消息  BALANCE_UPDATE：余额变更消息  LEVEL_UPDATE：等级变更消息.</param>
        ...
        /// </summary>
        /// <value>消息类型，每种消息都定义了固定消息模板，  POINT_UPDATE：积分变更消息  BALANCE_UPDATE：余额变更消息  LEVEL_UPDATE：等级变更消息</value>
