...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayFundTransCommonQueryResponseModel : IEquatable<AlipayFundTransCommonQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="failInstErrorCode">查询到的订单状态为FAIL失败时，返回具体报错银行的错误码。.</param>
        /// <param name="failInstName">查询到的订单状态为FAIL失败时，返回具体的报错银行名称.</param>
        /// <param name="failInstReason">查询到的订单状态为FAIL失败时，返回具体的原因。.</param>
        ...
        /// </summary>
        /// <value>查询到的订单状态为FAIL失败时，返回具体报错银行的错误码。</value>
        [DataMember(Name = "fail_inst_error_code", EmitDefaultValue = false)]
        public string FailInstErrorCode { get; set; }

        /// <summary>
        /// 查询到的订单状态为FAIL失败时，返回具体的报错银行名称
        /// </summary>
        /// <value>查询到的订单状态为FAIL失败时，返回具体的报错银行名称</value>
        [DataMember(Name = "fail_inst_name", EmitDefaultValue = false)]
        public string FailInstName { get; set; }

        /// <summary>
        /// 查询到的订单状态为FAIL失败时，返回具体的原因。
        /// </summary>
        /// <value>查询到的订单状态为FAIL失败时，返回具体的原因。</value>
        [DataMember(Name = "fail_inst_reason", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FailInstErrorCode: ").Append(FailInstErrorCode).Append("\n");
            sb.Append("  FailInstName: ").Append(FailInstName).Append("\n");
            sb.Append("  FailInstReason: ").Append(FailInstReason).Append("\n");
        ...
        public bool Equals(AlipayFundTransCommonQueryResponseModel input)
        {
            ...
            return 
                ...
                (
                    this.FailInstErrorCode == input.FailInstErrorCode ||
                    (this.FailInstErrorCode != null &&
                    this.FailInstErrorCode.Equals(input.FailInstErrorCode))
                ) && 
                (
                    this.FailInstName == input.FailInstName ||
                    (this.FailInstName != null &&
                    this.FailInstName.Equals(input.FailInstName))
                ) && 
                (
                    this.FailInstReason == input.FailInstReason ||
                    (this.FailInstReason != null &&
                    this.FailInstReason.Equals(input.FailInstReason))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FailInstErrorCode != null)
                {
                    hashCode = (hashCode * 59) + this.FailInstErrorCode.GetHashCode();
                }
                if (this.FailInstName != null)
                {
                    hashCode = (hashCode * 59) + this.FailInstName.GetHashCode();
                }
                if (this.FailInstReason != null)
                {
                    hashCode = (hashCode * 59) + this.FailInstReason.GetHashCode();
                }
