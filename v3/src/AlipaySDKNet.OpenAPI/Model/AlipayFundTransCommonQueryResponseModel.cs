...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayFundTransCommonQueryResponseModel : IEquatable<AlipayFundTransCommonQueryResponseModel>, IValidatableObject
    {
        ...
        public AlipayFundTransCommonQueryResponseModel(string arrivalTimeEnd = default(string), string deductBillInfo = default(string), string errorCode = default(string), string failReason = default(string), string orderFee = default(string), string orderId = default(string), string outBizNo = default(string), string passbackParams = default(string), string payDate = default(string), string payFundOrderId = default(string), string status = default(string), string subOrderErrorCode = default(string), string subOrderFailReason = default(string), string subOrderStatus = default(string), string transAmount = default(string), string transferBillInfo = default(string))
        {
