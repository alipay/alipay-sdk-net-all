...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayOpenAppQrcodeCreateModel : IEquatable<AlipayOpenAppQrcodeCreateModel>, IValidatableObject
    {
        ...
        /// <param name="queryParam">小程序的启动参数，打开小程序的query ，在小程序 onLaunch的方法中获取。可查看 &lt;a href&#x3D; \&quot;https://opendocs.alipay.com/support/01rb2a\&quot;&gt;如何获取各种场景的启动参数&lt;/a&gt;。.</param>
        /// <param name="size">合成后图片的大小 (s - - 8cm, m - - 12cm, l - - 30cm).</param>
        ...
        /// </summary>
        /// <value>小程序的启动参数，打开小程序的query ，在小程序 onLaunch的方法中获取。可查看 &lt;a href&#x3D; \&quot;https://opendocs.alipay.com/support/01rb2a\&quot;&gt;如何获取各种场景的启动参数&lt;/a&gt;。</value>
        ...
        /// </summary>
        /// <value>合成后图片的大小 (s - - 8cm, m - - 12cm, l - - 30cm)</value>
