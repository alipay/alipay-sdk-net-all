...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayMarketingActivityOrdervoucherCreateModel : IEquatable<AlipayMarketingActivityOrdervoucherCreateModel>, IValidatableObject
    {
        ...
        /// <param name="voucherType">券类型。商家券支持三类券类型： FIX_VOUCHER：满减券； DISCOUNT_VOUCHER：折扣券； SPECIAL_VOUCHER：特价券； 兑换券仅支持一类券类型：EXCHANGE_VOUCHER: 兑换券；.</param>
        ...
        /// </summary>
        /// <value>券类型。商家券支持三类券类型： FIX_VOUCHER：满减券； DISCOUNT_VOUCHER：折扣券； SPECIAL_VOUCHER：特价券； 兑换券仅支持一类券类型：EXCHANGE_VOUCHER: 兑换券；</value>
