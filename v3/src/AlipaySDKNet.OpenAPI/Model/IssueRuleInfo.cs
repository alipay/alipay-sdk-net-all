...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class IssueRuleInfo : IEquatable<IssueRuleInfo>, IValidatableObject
    {
        ...
        /// <param name="invalidMode">累计类型，默认为0 枚举：0（不可累计）、1（可累计）、2（累计天数）、3（累计到指定日期）.</param>
        /// <param name="invalidModeValue">累计类型值.</param>
        /// <param name="issueAmountValue">发放金额.</param>
        ...
        /// </summary>
        /// <value>累计类型，默认为0 枚举：0（不可累计）、1（可累计）、2（累计天数）、3（累计到指定日期）</value>
