...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel : IEquatable<AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel>, IValidatableObject
    {
        ...
        /// <param name="titleCode">抬头编码.</param>
        /// <param name="titleId">抬头ID.</param>
        /// <param name="titleName">企业抬头名称.</param>
        public AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel(string accountId = default(string), string address = default(string), string agreementNo = default(string), string bankAccount = default(string), string bankName = default(string), string enterpriseId = default(string), string taxRegisterNo = default(string), string telephone = default(string), string titleCode = default(string), string titleId = default(string), string titleName = default(string))
        {
        ...
        /// </summary>
        /// <value>抬头编码</value>
        [DataMember(Name = "title_code", EmitDefaultValue = false)]
        ...
        public bool Equals(AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel input)
        {
            ...
            return 
                ...
                (
                    this.TitleCode == input.TitleCode ||
                    (this.TitleCode != null &&
                    this.TitleCode.Equals(input.TitleCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.TitleCode.GetHashCode();
                }
