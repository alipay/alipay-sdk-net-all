...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceInstitutionModifyModel : IEquatable<AlipayEbppInvoiceInstitutionModifyModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="accountId">企业共同账户id（条件必填）.</param>
        /// <param name="agreementNo">授权签约协议号（条件必填）.</param>
        /// <param name="consultMode">费控咨询模式： 0-支付宝内部计算 1-咨询外部服务商.</param>
        /// <param name="effective">制度是否启用（可空），\&quot;0\&quot;为停用，\&quot;1\&quot;为启用.</param>
        /// <param name="effectiveEndDate">制度生效结束时间（可空），最小粒度为天，最早是当日.</param>
        /// <param name="effectiveStartDate">制度生效起始时间（可空），最小粒度为天，最早是当日.</param>
        /// <param name="enterpriseId">企业id（条件必填）.</param>
        /// <param name="institutionDesc">制度描述（可空）.</param>
        /// <param name="institutionId">制度id.</param>
        /// <param name="institutionName">制度名称（可空）.</param>
        ...
        /// </summary>
        /// <value>制度是否启用（可空），\&quot;0\&quot;为停用，\&quot;1\&quot;为启用</value>
        ...
        /// </summary>
        /// <value>制度生效起始时间（可空），最小粒度为天，最早是当日</value>
