...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// VoucherDisplayInfo
    /// </summary>
    [DataContract(Name = "VoucherDisplayInfo")]
    public partial class VoucherDisplayInfo : IEquatable<VoucherDisplayInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoucherDisplayInfo" /> class.
        /// </summary>
        ...
        public VoucherDisplayInfo(string brandLogo = default(string), string brandName = default(string), string customerServiceMobile = default(string), string customerServiceUrl = default(string), string voucherComment = default(string), string voucherDescription = default(string), List<string> voucherDetailImages = default(List<string>), string voucherImage = default(string))
        {
        ...
        {
            return this.Equals(input as VoucherDisplayInfo);
        }

        /// <summary>
        /// Returns true if VoucherDisplayInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of VoucherDisplayInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoucherDisplayInfo input)
        {
            if (input == null)
            {
                return false;
