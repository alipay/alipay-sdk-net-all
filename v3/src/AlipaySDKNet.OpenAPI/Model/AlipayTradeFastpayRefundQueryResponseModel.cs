...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayTradeFastpayRefundQueryResponseModel : IEquatable<AlipayTradeFastpayRefundQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="refundHybAmount">本次退款金额中退惠营宝的金额.</param>
        ...
        /// <param name="sendBackFee">本次商户实际退回金额； 默认不返回该信息，需要在入参的query_options中指定\&quot;refund_detail_item_list\&quot;值时才返回该字段信息。.</param>
        /// <param name="totalAmount">该笔退款所对应的交易的订单金额.</param>
        ...
        /// </summary>
        /// <value>本次商户实际退回金额； 默认不返回该信息，需要在入参的query_options中指定\&quot;refund_detail_item_list\&quot;值时才返回该字段信息。</value>
