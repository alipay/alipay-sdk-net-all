...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayIserviceCcmSwArticleGetResponseModel")]
    public partial class AlipayIserviceCcmSwArticleGetResponseModel : IEquatable<AlipayIserviceCcmSwArticleGetResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayIserviceCcmSwArticleGetResponseModel" /> class.
        /// </summary>
        ...
        /// <param name="relatedArticles">关联的知识点基础信息.</param>
        ...
        public AlipayIserviceCcmSwArticleGetResponseModel(List<ArticleAttachmentInfo> attachments = default(List<ArticleAttachmentInfo>), int categoryId = default(int), string categoryNamePath = default(string), List<ArticleCategoryInfo> categoryPath = default(List<ArticleCategoryInfo>), string content = default(string), string createTime = default(string), string creatorId = default(string), List<string> extendTitles = default(List<string>), int id = default(int), List<string> keywords = default(List<string>), int libraryId = default(int), int orderNo = default(int), List<ArticleAttachmentInfo> pictures = default(List<ArticleAttachmentInfo>), string publishEnd = default(string), string publishStart = default(string), List<BaseArticleInfo> relatedArticles = default(List<BaseArticleInfo>), List<string> sceneCodes = default(List<string>), string source = default(string), string status = default(string), string statusCode = default(string), string title = default(string), string updateTime = default(string), string updaterId = default(string), string updaterName = default(string))
        {
        ...
        {
            return this.Equals(input as AlipayIserviceCcmSwArticleGetResponseModel);
        }

        /// <summary>
        /// Returns true if AlipayIserviceCcmSwArticleGetResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayIserviceCcmSwArticleGetResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayIserviceCcmSwArticleGetResponseModel input)
        {
            if (input == null)
            {
                return false;
