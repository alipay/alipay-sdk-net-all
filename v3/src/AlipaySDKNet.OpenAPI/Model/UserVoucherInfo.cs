...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// UserVoucherInfo
    /// </summary>
    [DataContract(Name = "UserVoucherInfo")]
    public partial class UserVoucherInfo : IEquatable<UserVoucherInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserVoucherInfo" /> class.
        /// </summary>
        ...
        /// <param name="belongMerchantId">券归属商户 pid。.</param>
        /// <param name="createTime">用户领券时间。.</param>
        ...
        /// <param name="voucherName">券名称。展示在支付宝卡包中的券名称。.</param>
        ...
        public UserVoucherInfo(ActivityBaseInfo activityBaseInfo = default(ActivityBaseInfo), string activityId = default(string), string availableBeginTime = default(string), string availableEndTime = default(string), string belongMerchantId = default(string), string createTime = default(string), UserVoucherBaseInfo userVoucherBaseInfo = default(UserVoucherBaseInfo), VoucherAvailableScopeInfo voucherAvailableScopeInfo = default(VoucherAvailableScopeInfo), VoucherCustomerGuideInfo voucherCustomerGuideInfo = default(VoucherCustomerGuideInfo), VoucherDeductInfo voucherDeductInfo = default(VoucherDeductInfo), CommonVoucherDisplayLiteInfo voucherDisplayLiteInfo = default(CommonVoucherDisplayLiteInfo), VoucherDisplayPatternInfo voucherDisplayPatternInfo = default(VoucherDisplayPatternInfo), string voucherId = default(string), string voucherName = default(string), VoucherSendModeInfo voucherSendModeInfo = default(VoucherSendModeInfo), string voucherStatus = default(string), string voucherType = default(string), VoucherUseRuleInfo voucherUseRuleInfo = default(VoucherUseRuleInfo), CommonVoucherUseRuleLiteInfo voucherUseRuleLiteInfo = default(CommonVoucherUseRuleLiteInfo))
        {
        ...
        {
            return this.Equals(input as UserVoucherInfo);
        }

        /// <summary>
        /// Returns true if UserVoucherInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of UserVoucherInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserVoucherInfo input)
        {
            if (input == null)
            {
                return false;
