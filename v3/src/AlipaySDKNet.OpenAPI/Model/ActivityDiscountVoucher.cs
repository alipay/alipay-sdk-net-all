...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActivityDiscountVoucher")]
    public partial class ActivityDiscountVoucher : IEquatable<ActivityDiscountVoucher>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityDiscountVoucher" /> class.
        /// </summary>
        ...
        public ActivityDiscountVoucher(string ceilingAmount = default(string), string discount = default(string), string floorAmount = default(string), string goodsName = default(string), string originAmount = default(string))
        {
        ...
        {
            return this.Equals(input as ActivityDiscountVoucher);
        }

        /// <summary>
        /// Returns true if ActivityDiscountVoucher instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivityDiscountVoucher to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivityDiscountVoucher input)
        {
            if (input == null)
            {
                return false;
