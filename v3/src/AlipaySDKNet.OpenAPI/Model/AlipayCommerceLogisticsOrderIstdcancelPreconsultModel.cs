...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayCommerceLogisticsOrderIstdcancelPreconsultModel")]
    public partial class AlipayCommerceLogisticsOrderIstdcancelPreconsultModel : IEquatable<AlipayCommerceLogisticsOrderIstdcancelPreconsultModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayCommerceLogisticsOrderIstdcancelPreconsultModel" /> class.
        /// </summary>
        ...
        public AlipayCommerceLogisticsOrderIstdcancelPreconsultModel(string cancelReason = default(string), string cancelReasonId = default(string), string logisticsCode = default(string), string orderNo = default(string), string outOrderNo = default(string), string waybillNo = default(string))
        {
        ...
        {
            return this.Equals(input as AlipayCommerceLogisticsOrderIstdcancelPreconsultModel);
        }

        /// <summary>
        /// Returns true if AlipayCommerceLogisticsOrderIstdcancelPreconsultModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayCommerceLogisticsOrderIstdcancelPreconsultModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayCommerceLogisticsOrderIstdcancelPreconsultModel input)
        {
            if (input == null)
            {
                return false;
