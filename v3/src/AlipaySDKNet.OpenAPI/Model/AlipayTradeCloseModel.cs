...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayTradeCloseModel : IEquatable<AlipayTradeCloseModel>, IValidatableObject
    {
        ...
        public AlipayTradeCloseModel(CloseExtendParams extendParams = default(CloseExtendParams), string notifyUrl = default(string), string operatorId = default(string), string outTradeNo = default(string), string tradeNo = default(string))
        {
