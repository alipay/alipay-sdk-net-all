...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayOpenMiniVersionDetailQueryResponseModel : IEquatable<AlipayOpenMiniVersionDetailQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="baseAudit">准入审核结果： PASS：通过 REJECT：驳回 （提审时 audit_rule 传 BASE_PROMOTE 时有该字段）.</param>
        /// <param name="baseAuditRecord">baseAuditRecord.</param>
        /// <param name="canRelease">是否可上架-true/false （提审时 audit_rule 传 BASE_PROMOTE 时有该字段）.</param>
        /// <param name="gmtApplyAudit">小程序版本提交审核的时间.</param>
        /// <param name="gmtAuditEnd">小程序版本审核结束时间.</param>
        ...
        /// <param name="serviceRegionType">小程序服务区域类型，GLOBLE-全球，CHINA-中国，LOCATION-指定区域.</param>
        ...
        /// </summary>
        /// <value>准入审核结果： PASS：通过 REJECT：驳回 （提审时 audit_rule 传 BASE_PROMOTE 时有该字段）</value>
        ...
        /// </summary>
        /// <value>是否可上架-true/false （提审时 audit_rule 传 BASE_PROMOTE 时有该字段）</value>
        ...
        /// </summary>
        /// <value>小程序服务区域类型，GLOBLE-全球，CHINA-中国，LOCATION-指定区域</value>
