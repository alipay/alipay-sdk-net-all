...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class RefundGoodsDetail : IEquatable<RefundGoodsDetail>, IValidatableObject
    {
        ...
        /// <param name="outItemId">商家侧小程序商品ID，具体使用方式请参考：https://opendocs.alipay.com/pre-open/06uila?pathHash&#x3D;87297d0a.</param>
        /// <param name="outSkuId">商家侧小程序商品sku ID，具体使用方式请参考：https://opendocs.alipay.com/pre-open/06uila?pathHash&#x3D;87297d0a.</param>
        /// <param name="refundAmount">该商品的退款总金额，单位为元.</param>
        public RefundGoodsDetail(string goodsId = default(string), string outItemId = default(string), string outSkuId = default(string), string refundAmount = default(string))
        {
        ...
        /// </summary>
        /// <value>商家侧小程序商品ID，具体使用方式请参考：https://opendocs.alipay.com/pre-open/06uila?pathHash&#x3D;87297d0a</value>
        ...
        /// </summary>
        /// <value>商家侧小程序商品sku ID，具体使用方式请参考：https://opendocs.alipay.com/pre-open/06uila?pathHash&#x3D;87297d0a</value>
