...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayUserDeliverAddress")]
    public partial class AlipayUserDeliverAddress : IEquatable<AlipayUserDeliverAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayUserDeliverAddress" /> class.
        /// </summary>
        /// <param name="address">地址.</param>
        /// <param name="addressCode">区域编码.</param>
        /// <param name="defaultDeliverAddress">是否默认收货地址.</param>
        /// <param name="deliverArea">区/县.</param>
        /// <param name="deliverCity">市.</param>
        ...
        /// <param name="deliverProvince">省.</param>
        /// <param name="zip">邮编.</param>
        public AlipayUserDeliverAddress(string address = default(string), string addressCode = default(string), string defaultDeliverAddress = default(string), string deliverArea = default(string), string deliverCity = default(string), string deliverFullname = default(string), string deliverMobile = default(string), string deliverPhone = default(string), string deliverProvince = default(string), string zip = default(string))
        {
        ...
        {
            return this.Equals(input as AlipayUserDeliverAddress);
        }

        /// <summary>
        /// Returns true if AlipayUserDeliverAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayUserDeliverAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayUserDeliverAddress input)
        {
            if (input == null)
            {
                return false;
