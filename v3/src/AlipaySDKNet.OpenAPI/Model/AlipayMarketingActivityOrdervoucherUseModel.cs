...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayMarketingActivityOrdervoucherUseModel : IEquatable<AlipayMarketingActivityOrdervoucherUseModel>, IValidatableObject
    {
        ...
        /// <param name="goodsDetail">商品明细信息。    限制：  当前交易中存在商品信息，则建议传入商品明细信息。.</param>
        ...
        /// <param name="storeId">用户核销优惠券的支付门店id,调用接口ant.merchant.expand.shop.create创建门店返回的门店id。 限制: 传入的门店id必须是创建商家券voucher_use_rule. voucher_available_scope. order_voucher_available_shop对象中shop_ids中的门店id.</param>
        /// <param name="totalFee">订单优惠前的总金额    限制：  该笔订单的资金总额，取值范围[0.01,100000000]，精确到小数点后2位。.</param>
        /// <param name="tradeChannel">交易渠道。    枚举值：  ZHIFUBAO_TRADE_CHANNEL：  支付宝交易渠道    WX_TRADE_CHANNEL：  微信交易渠道    OTHER_TRADE_CHANNEL：  其他交易渠道.</param>
        ...
        /// </summary>
        /// <value>商品明细信息。    限制：  当前交易中存在商品信息，则建议传入商品明细信息。</value>
        ...
        /// </summary>
        /// <value>用户核销优惠券的支付门店id,调用接口ant.merchant.expand.shop.create创建门店返回的门店id。 限制: 传入的门店id必须是创建商家券voucher_use_rule. voucher_available_scope. order_voucher_available_shop对象中shop_ids中的门店id</value>
        ...
        /// </summary>
        /// <value>订单优惠前的总金额    限制：  该笔订单的资金总额，取值范围[0.01,100000000]，精确到小数点后2位。</value>
        ...
        /// </summary>
        /// <value>交易渠道。    枚举值：  ZHIFUBAO_TRADE_CHANNEL：  支付宝交易渠道    WX_TRADE_CHANNEL：  微信交易渠道    OTHER_TRADE_CHANNEL：  其他交易渠道</value>
