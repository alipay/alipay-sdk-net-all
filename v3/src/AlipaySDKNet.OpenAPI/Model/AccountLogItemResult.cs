...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AccountLogItemResult : IEquatable<AccountLogItemResult>, IValidatableObject
    {
        ...
        /// <param name="balance">余额，单位元，仅供参考。由于架构原因，余额变动并不保证连续。也就是余额不一定等于上一笔余额减去当笔金额。但是会保证最终一致。.</param>
        ...
        /// <param name="transAmount">金额，单位元.</param>
        ...
        /// </summary>
        /// <value>余额，单位元，仅供参考。由于架构原因，余额变动并不保证连续。也就是余额不一定等于上一笔余额减去当笔金额。但是会保证最终一致。</value>
