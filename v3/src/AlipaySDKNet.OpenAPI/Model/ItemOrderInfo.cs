...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ItemOrderInfo : IEquatable<ItemOrderInfo>, IValidatableObject
    {
        ...
        /// <param name="quantity">商品数量（单位：自拟）。 小程序订单助手业务中，为必传；其他业务场景参见对应的产品文档。.</param>
        /// <param name="skuId">商品 sku id.</param>
        /// <param name="status">商品状态枚举，默认无需传入，如需使用请联系业务负责人.</param>
        /// <param name="statusDesc">商品状态描述，默认无需传入，如需使用请联系业务负责人.</param>
        /// <param name="unit">商品规格.</param>
        /// <param name="unitPrice">商品单价（单位：元）。 小程序订单助手业务中，为必传；其他业务场景参见对应的产品文档。.</param>
        ...
        /// </summary>
        /// <value>商品数量（单位：自拟）。 小程序订单助手业务中，为必传；其他业务场景参见对应的产品文档。</value>
        ...
        /// </summary>
        /// <value>商品状态枚举，默认无需传入，如需使用请联系业务负责人</value>
        ...
        /// </summary>
        /// <value>商品单价（单位：元）。 小程序订单助手业务中，为必传；其他业务场景参见对应的产品文档。</value>
