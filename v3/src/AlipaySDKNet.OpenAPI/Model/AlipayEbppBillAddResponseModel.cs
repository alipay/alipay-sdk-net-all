...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayEbppBillAddResponseModel")]
    public partial class AlipayEbppBillAddResponseModel : IEquatable<AlipayEbppBillAddResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayEbppBillAddResponseModel" /> class.
        /// </summary>
        /// <param name="alipayOrderNo">支付宝的业务订单号，具有唯一性。.</param>
        /// <param name="bankBillNo">外部订单号，由于对账时回传给外部商户.</param>
        ...
        /// <param name="extendField">扩展属性，该属性值现在用于确保只有一个人可以支付成功  用法：多个人对同一笔外部欠费单创建多个账单时，确保该值不变.</param>
        ...
        /// <param name="tradeNo">50新链路订单号.</param>
        public AlipayEbppBillAddResponseModel(string alipayOrderNo = default(string), string bankBillNo = default(string), string billDate = default(string), string billKey = default(string), string chargeInst = default(string), string chargeInstName = default(string), string extendField = default(string), string merchantOrderNo = default(string), string orderType = default(string), string ownerName = default(string), string payAmount = default(string), string serviceAmount = default(string), string subOrderType = default(string), string tradeNo = default(string))
        {
        ...
        /// 外部订单号，由于对账时回传给外部商户
        /// </summary>
        /// <value>外部订单号，由于对账时回传给外部商户</value>
        ...
        /// </summary>
        /// <value>扩展属性，该属性值现在用于确保只有一个人可以支付成功  用法：多个人对同一笔外部欠费单创建多个账单时，确保该值不变</value>
        ...
        {
            return this.Equals(input as AlipayEbppBillAddResponseModel);
        }

        /// <summary>
        /// Returns true if AlipayEbppBillAddResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayEbppBillAddResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayEbppBillAddResponseModel input)
        {
            if (input == null)
            {
                return false;
