...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayMerchantIndirectSmidbindQueryResponseModel : IEquatable<AlipayMerchantIndirectSmidbindQueryResponseModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="checkResult">确认状态，枚举：已完成确认（AUTHORIZED）/未完成确认（UNAUTHORIZED）/已销户（CLOSED）/sub_merchant_id不存在（SMID_NOT_EXIST）.</param>
        ...
        /// </summary>
        /// <value>确认状态，枚举：已完成确认（AUTHORIZED）/未完成确认（UNAUTHORIZED）/已销户（CLOSED）/sub_merchant_id不存在（SMID_NOT_EXIST）</value>
