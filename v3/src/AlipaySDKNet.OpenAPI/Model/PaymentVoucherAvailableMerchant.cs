...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentVoucherAvailableMerchant")]
    public partial class PaymentVoucherAvailableMerchant : IEquatable<PaymentVoucherAvailableMerchant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentVoucherAvailableMerchant" /> class.
        /// </summary>
        /// <param name="availablePids">优惠券可核销的直连商户PID  限制： 1、available_pids和available_smids至少二选一。.</param>
        /// <param name="availableSmids">优惠券可核销的间连商户SMID  限制：  1、available_pids和available_smids至少二选一。.</param>
        public PaymentVoucherAvailableMerchant(List<string> availablePids = default(List<string>), List<string> availableSmids = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>优惠券可核销的直连商户PID  限制： 1、available_pids和available_smids至少二选一。</value>
        ...
        /// </summary>
        /// <value>优惠券可核销的间连商户SMID  限制：  1、available_pids和available_smids至少二选一。</value>
        ...
        {
            return this.Equals(input as PaymentVoucherAvailableMerchant);
        }

        /// <summary>
        /// Returns true if PaymentVoucherAvailableMerchant instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentVoucherAvailableMerchant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentVoucherAvailableMerchant input)
        {
            if (input == null)
            {
                return false;
