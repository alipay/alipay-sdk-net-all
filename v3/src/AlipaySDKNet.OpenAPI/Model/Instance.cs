...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class Instance : IEquatable<Instance>, IValidatableObject
    {
        ...
        public Instance(string createTime = default(string), string creatorId = default(string), string description = default(string), string externalId = default(string), string id = default(string), string name = default(string), string status = default(string), string updateTime = default(string), string updaterId = default(string))
        {
