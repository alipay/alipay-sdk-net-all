...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayOpenFeeAdjustApplyModel : IEquatable<AlipayOpenFeeAdjustApplyModel>, IValidatableObject
    {
        ...
        public AlipayOpenFeeAdjustApplyModel(string account = default(string), string applicationFee = default(string), string certNo = default(string), string certType = default(string), string cityCode = default(string), string detailAddress = default(string), string districtCode = default(string), string productCode = default(string), string provinceCode = default(string))
        {
