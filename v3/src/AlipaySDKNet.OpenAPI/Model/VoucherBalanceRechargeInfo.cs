...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class VoucherBalanceRechargeInfo : IEquatable<VoucherBalanceRechargeInfo>, IValidatableObject
    {
        ...
        /// <param name="logonId">出资的商户支付宝登录账号  限制:  logon_id和partner_id必须且只能二选一.</param>
        /// <param name="partnerId">出资的商户支付宝ID  限制:  logon_id和partner_id必须且只能二选一.</param>
        ...
        /// </summary>
        /// <value>出资的商户支付宝登录账号  限制:  logon_id和partner_id必须且只能二选一</value>
        ...
        /// </summary>
        /// <value>出资的商户支付宝ID  限制:  logon_id和partner_id必须且只能二选一</value>
