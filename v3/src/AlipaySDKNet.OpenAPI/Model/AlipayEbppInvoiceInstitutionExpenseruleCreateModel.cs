...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceInstitutionExpenseruleCreateModel : IEquatable<AlipayEbppInvoiceInstitutionExpenseruleCreateModel>, IValidatableObject
    {
        ...
        /// <param name="consumeMode">消费模式，该使用规则支持消费的资产类型，不填为默认模式，默认模式为优先消费余额，没有余额则根据规则中设置的限额控制消费金额.</param>
        ...
        /// </summary>
        /// <value>消费模式，该使用规则支持消费的资产类型，不填为默认模式，默认模式为优先消费余额，没有余额则根据规则中设置的限额控制消费金额</value>
        ...
        /// </summary>
        /// <value>开票规则id，若使用途径是外卖的使用规则需要开票，需要在创建使用规则时关联开票规则，后续变更关联开票规则不生效</value>
        ...
        /// </summary>
        /// <value>当笔消费金额大于规则可用余额时，用于控制支付策略，该字段缺省时采取因公账户和个人账户组合支付策略</value>
        ...
        /// 费控规则名称 特殊说明： 1）敏感词校验
        /// </summary>
        /// <value>费控规则名称 特殊说明： 1）敏感词校验</value>
