...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayOpenMiniVersionUploadModel : IEquatable<AlipayOpenMiniVersionUploadModel>, IValidatableObject
    {
        ...
        /// <param name="bundleId">小程序投放的端参数，默认支付宝端 。支持：com.alipay.alipaywallet：支付宝端。 com.alipay.iot.xpaas：支付宝IoT端。 例如投放到支付宝钱包是支付宝端。.</param>
        ...
        /// </summary>
        /// <value>小程序投放的端参数，默认支付宝端 。支持：com.alipay.alipaywallet：支付宝端。 com.alipay.iot.xpaas：支付宝IoT端。 例如投放到支付宝钱包是支付宝端。</value>
