...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AppMemberInfo : IEquatable<AppMemberInfo>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="gmtInvite">邀请时间，格式为yyyy-MM-dd HH:mm:ss.</param>
        /// <param name="gmtJoin">加入时间，格式为yyyy-MM-dd.</param>
        /// <param name="logonId">支付宝登录账号.</param>
        /// <param name="nickName">昵称.</param>
        /// <param name="openId">支付宝用户openId.</param>
        /// <param name="portrait">头像地址fileId(完整地址需自行拼接).</param>
        /// <param name="role">角色类型.</param>
        /// <param name="status">成员的状态.</param>
        ...
        /// </summary>
        /// <value>邀请时间，格式为yyyy-MM-dd HH:mm:ss</value>
        ...
        /// 加入时间，格式为yyyy-MM-dd
        /// </summary>
        /// <value>加入时间，格式为yyyy-MM-dd</value>
        ...
        /// </summary>
        /// <value>头像地址fileId(完整地址需自行拼接)</value>
