...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class SubMerchantEnterOpenModel : IEquatable<SubMerchantEnterOpenModel>, IValidatableObject
    {
        ...
        /// <param name="pid">开票商户pid，入驻支付即开票场景的时候，该字段必传.</param>
        /// <param name="registerNo">商户门店税号。.</param>
        /// <param name="subMName">商户门店全称。.</param>
        /// <param name="subMShortName">商户门店简称，只能由大写字母、下划线、数字组成，且必须以大写字母开头。.</param>
        ...
        /// </summary>
        /// <value>开票商户pid，入驻支付即开票场景的时候，该字段必传</value>
        ...
        /// </summary>
        /// <value>商户门店简称，只能由大写字母、下划线、数字组成，且必须以大写字母开头。</value>
