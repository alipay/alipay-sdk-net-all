...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayMarketingActivityVoucherpackageBatchqueryModel : IEquatable<AlipayMarketingActivityVoucherpackageBatchqueryModel>, IValidatableObject
    {
        ...
        /// <param name="voucherPackageStatus">券包状态：不指定可查全部状态，指定时只支持查单个状态 枚举值： CREATED：已创建, ENABLE：已发布（包含过期）, PAUSED：已暂停, DISABLE：已停止;.</param>
        ...
        /// </summary>
        /// <value>券包状态：不指定可查全部状态，指定时只支持查单个状态 枚举值： CREATED：已创建, ENABLE：已发布（包含过期）, PAUSED：已暂停, DISABLE：已停止;</value>
