...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// InteligentUseTime
    /// </summary>
    [DataContract(Name = "InteligentUseTime")]
    public partial class InteligentUseTime : IEquatable<InteligentUseTime>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InteligentUseTime" /> class.
        /// </summary>
        ...
        public InteligentUseTime(string dimension = default(string), string times = default(string), string values = default(string))
        {
        ...
        {
            return this.Equals(input as InteligentUseTime);
        }

        /// <summary>
        /// Returns true if InteligentUseTime instances are equal
        /// </summary>
        /// <param name="input">Instance of InteligentUseTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InteligentUseTime input)
        {
            if (input == null)
            {
                return false;
