...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayCommerceEcEmployeeInviteQueryResponseModel : IEquatable<AlipayCommerceEcEmployeeInviteQueryResponseModel>, IValidatableObject
    {
        ...
        public AlipayCommerceEcEmployeeInviteQueryResponseModel(string enterpriseId = default(string), string miniAppSignUrl = default(string), string signUrl = default(string))
        {
