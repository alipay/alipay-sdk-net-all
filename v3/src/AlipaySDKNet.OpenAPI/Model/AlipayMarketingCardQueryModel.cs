...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayMarketingCardQueryModel : IEquatable<AlipayMarketingCardQueryModel>, IValidatableObject
    {
        ...
        /// <param name="targetCardNoType">卡号ID类型（会员卡查询，只能提供支付宝端的卡号） BIZ_CARD：支付宝卡号 D_QR_CODE：动态二维码（业务卡号对应的） D_BAR_CODE：动态条码（业务卡号对应的） EXTERNAL_CARD：外部卡号（业务卡号对应的）.</param>
        ...
        /// </summary>
        /// <value>卡号ID类型（会员卡查询，只能提供支付宝端的卡号） BIZ_CARD：支付宝卡号 D_QR_CODE：动态二维码（业务卡号对应的） D_BAR_CODE：动态条码（业务卡号对应的） EXTERNAL_CARD：外部卡号（业务卡号对应的）</value>
