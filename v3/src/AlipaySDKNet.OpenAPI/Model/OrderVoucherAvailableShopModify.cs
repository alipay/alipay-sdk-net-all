...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderVoucherAvailableShopModify")]
    public partial class OrderVoucherAvailableShopModify : IEquatable<OrderVoucherAvailableShopModify>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderVoucherAvailableShopModify" /> class.
        /// </summary>
        ...
        /// <param name="shopIds">券可使用的门店列表。列表中的门店id是通过调用接口ant.merchant.expand.shop.create创建门店返回的支付宝门店id 接口参数是列表类型。接口参数是列表类型。.</param>
        public OrderVoucherAvailableShopModify(OrderVoucherMerchantAllShopModify orderVoucherMerchantAllShop = default(OrderVoucherMerchantAllShopModify), List<string> realShopIds = default(List<string>), List<string> shopIds = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>券可使用的门店列表。列表中的门店id是通过调用接口ant.merchant.expand.shop.create创建门店返回的支付宝门店id 接口参数是列表类型。接口参数是列表类型。</value>
        ...
        {
            return this.Equals(input as OrderVoucherAvailableShopModify);
        }

        /// <summary>
        /// Returns true if OrderVoucherAvailableShopModify instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderVoucherAvailableShopModify to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderVoucherAvailableShopModify input)
        {
            if (input == null)
            {
                return false;
