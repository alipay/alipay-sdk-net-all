...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// DelayInfo
    /// </summary>
    [DataContract(Name = "DelayInfo")]
    public partial class DelayInfo : IEquatable<DelayInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DelayInfo" /> class.
        /// </summary>
        ...
        public DelayInfo(string type = default(string), string value = default(string))
        {
            this.Type = type;
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as DelayInfo);
        }

        /// <summary>
        /// Returns true if DelayInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of DelayInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DelayInfo input)
        {
            if (input == null)
            {
                return false;
