...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayMarketingCardTemplateQueryResponseModel : IEquatable<AlipayMarketingCardTemplateQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="spiAppId">spi应用id，若使用openspi模式开卡，该字段为创建模版时，设置的实现spi.alipay.user.opencard.get接口的app_id.</param>
        ...
        /// </summary>
        /// <value>spi应用id，若使用openspi模式开卡，该字段为创建模版时，设置的实现spi.alipay.user.opencard.get接口的app_id</value>
