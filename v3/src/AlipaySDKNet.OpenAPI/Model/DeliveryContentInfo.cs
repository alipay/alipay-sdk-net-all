...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class DeliveryContentInfo : IEquatable<DeliveryContentInfo>, IValidatableObject
    {
        ...
        public DeliveryContentInfo(DeliveryActivityContentInfo deliveryActivityContent = default(DeliveryActivityContentInfo), DeliveryMiniAppContentInfo deliveryAppContent = default(DeliveryMiniAppContentInfo), string deliveryContentType = default(string), DeliveryDisplayInfo deliveryDisplayInfo = default(DeliveryDisplayInfo))
        {
