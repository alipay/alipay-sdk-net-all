...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceInstitutionCreateModel : IEquatable<AlipayEbppInvoiceInstitutionCreateModel>, IValidatableObject
    {
        ...
        /// <param name="adapterType">制度适配范围.</param>
        ...
        public AlipayEbppInvoiceInstitutionCreateModel(string accountId = default(string), string adapterType = default(string), string agreementNo = default(string), string consultMode = default(string), string effectiveEndDate = default(string), string effectiveStartDate = default(string), string enterpriseId = default(string), string expenseType = default(string), string institutionDesc = default(string), string institutionName = default(string), List<IssueRuleInfo> issueRuleInfoList = default(List<IssueRuleInfo>), string outerSourceId = default(string), List<string> ownerIdList = default(List<string>), List<string> ownerOpenIdList = default(List<string>), string ownerType = default(string), string sceneType = default(string), List<StandardInfo> standardInfoList = default(List<StandardInfo>))
        {
