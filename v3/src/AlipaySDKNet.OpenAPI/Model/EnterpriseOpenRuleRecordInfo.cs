...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class EnterpriseOpenRuleRecordInfo : IEquatable<EnterpriseOpenRuleRecordInfo>, IValidatableObject
    {
        ...
        /// <param name="enterpriseId">企业ID【推荐使用】.</param>
        ...
        /// <param name="openApplyer">开票申请方：ENTERPRISE（企业发起），EMPLOYEE（员工发起）.</param>
        /// <param name="openMode">开票模式：汇总开、笔笔开 枚举定义：SUMMARY:汇总开 SINGLE:单笔开.</param>
        /// <param name="openType">开票申请类型：AUTO（自动开票），MANUAL（手动开票）.</param>
        ...
        /// </summary>
        /// <value>开票申请方：ENTERPRISE（企业发起），EMPLOYEE（员工发起）</value>
        ...
        /// </summary>
        /// <value>开票申请类型：AUTO（自动开票），MANUAL（手动开票）</value>
