...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayOpenAgentFacetofaceSignModel : IEquatable<AlipayOpenAgentFacetofaceSignModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="batchNo">代商户操作事务编号，通过&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/apis/api_50/alipay.open.agent.create\&quot;&gt;接口地址&lt;/a&gt; (开启代商户签约、创建应用事务)接口进行事务创建后获取。.</param>
        /// <param name="businessLicenseMobile">上传非经营者本人（签约账号）的营业执照时必填，填写营业执照法人支付宝账号对应的手机号。.</param>
        ...
        /// </summary>
        /// <value>代商户操作事务编号，通过&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/apis/api_50/alipay.open.agent.create\&quot;&gt;接口地址&lt;/a&gt; (开启代商户签约、创建应用事务)接口进行事务创建后获取。</value>
        ...
        /// </summary>
        /// <value>上传非经营者本人（签约账号）的营业执照时必填，填写营业执照法人支付宝账号对应的手机号。</value>
