...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class PromiseDetail : IEquatable<PromiseDetail>, IValidatableObject
    {
        ...
        public PromiseDetail(bool authStatus = default(bool), string createTime = default(string), string endTime = default(string), string finalTime = default(string), int finishPeriods = default(int), string merchantId = default(string), string merchantLogo = default(string), string merchantName = default(string), string periodType = default(string), string promiseName = default(string), string recordId = default(string), string recordStatus = default(string), string startTime = default(string), string subRecordStatus = default(string), string subTitle = default(string), string templateId = default(string), int totalPeriods = default(int))
        {
