...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class DatadigitalFincloudGeneralsaasFaceVerificationQueryResponseModel : IEquatable<DatadigitalFincloudGeneralsaasFaceVerificationQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="certifyState">人脸检测单据状态。PROCESSING：初始化；SUCCESS：检测成功；FAIL：检测失败.</param>
        /// <param name="quality">double值，人脸图片质量分.</param>
        /// <param name="score">double值，活体检测结果分数.</param>
        public DatadigitalFincloudGeneralsaasFaceVerificationQueryResponseModel(string alivePhoto = default(string), string attackFlag = default(string), string certifyState = default(string), string quality = default(string), string score = default(string))
        {
        ...
        /// </summary>
        /// <value>人脸检测单据状态。PROCESSING：初始化；SUCCESS：检测成功；FAIL：检测失败</value>
