...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class SubMerchant : IEquatable<SubMerchant>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="merchantId">支付宝二级商户编号。 间连受理商户的支付宝商户编号，通过间连商户入驻接口后由支付宝生成。 直付通和机构间连业务场景下必传。.</param>
        /// <param name="merchantType">二级商户编号类型。 枚举值： alipay:支付宝分配的间联商户编号； 目前仅支持alipay，默认可以不传。.</param>
        public SubMerchant(string merchantId = default(string), string merchantType = default(string))
        {
        ...
        /// </summary>
        /// <value>支付宝二级商户编号。 间连受理商户的支付宝商户编号，通过间连商户入驻接口后由支付宝生成。 直付通和机构间连业务场景下必传。</value>
        ...
        /// </summary>
        /// <value>二级商户编号类型。 枚举值： alipay:支付宝分配的间联商户编号； 目前仅支持alipay，默认可以不传。</value>
