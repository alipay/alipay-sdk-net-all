...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayCommerceTransportChargerChargerbindinfoSyncModel : IEquatable<AlipayCommerceTransportChargerChargerbindinfoSyncModel>, IValidatableObject
    {
        ...
        /// <param name="networkDataBeginTime">流量开始时间.</param>
        /// <param name="networkDataEndTime">流量结束时间.</param>
        ...
        /// </summary>
        /// <value>流量开始时间</value>
        [DataMember(Name = "network_data_begin_time", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>流量结束时间</value>
        [DataMember(Name = "network_data_end_time", EmitDefaultValue = false)]
        ...
        /// 设备有二级品牌商，需要传二级品牌编号
        /// </summary>
        /// <value>设备有二级品牌商，需要传二级品牌编号</value>
        [DataMember(Name = "s_brand_code", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NetworkDataBeginTime: ").Append(NetworkDataBeginTime).Append("\n");
            sb.Append("  NetworkDataEndTime: ").Append(NetworkDataEndTime).Append("\n");
            ...
            sb.Append("  SBrandCode: ").Append(SBrandCode).Append("\n");
        ...
        public bool Equals(AlipayCommerceTransportChargerChargerbindinfoSyncModel input)
        {
            ...
            return 
                ...
                (
                    this.NetworkDataBeginTime == input.NetworkDataBeginTime ||
                    (this.NetworkDataBeginTime != null &&
                    this.NetworkDataBeginTime.Equals(input.NetworkDataBeginTime))
                ) && 
                (
                    this.NetworkDataEndTime == input.NetworkDataEndTime ||
                    (this.NetworkDataEndTime != null &&
                    this.NetworkDataEndTime.Equals(input.NetworkDataEndTime))
                ) && 
                (
                ...
                (
                    this.SBrandCode == input.SBrandCode ||
                    (this.SBrandCode != null &&
                    this.SBrandCode.Equals(input.SBrandCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NetworkDataBeginTime != null)
                {
                    hashCode = (hashCode * 59) + this.NetworkDataBeginTime.GetHashCode();
                }
                if (this.NetworkDataEndTime != null)
                {
                    hashCode = (hashCode * 59) + this.NetworkDataEndTime.GetHashCode();
                }
                ...
                if (this.SBrandCode != null)
                {
                    hashCode = (hashCode * 59) + this.SBrandCode.GetHashCode();
                }
