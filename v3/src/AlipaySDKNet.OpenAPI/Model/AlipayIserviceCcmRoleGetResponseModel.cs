...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayIserviceCcmRoleGetResponseModel")]
    public partial class AlipayIserviceCcmRoleGetResponseModel : IEquatable<AlipayIserviceCcmRoleGetResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayIserviceCcmRoleGetResponseModel" /> class.
        /// </summary>
        /// <param name="ccsInstanceId">部门id（即租户实例ID、数据权限ID）.</param>
        /// <param name="createTime">创建时间.</param>
        /// <param name="creatorId">创建人id.</param>
        /// <param name="description">描述信息.</param>
        /// <param name="functionIds">角色关联的功能点id.</param>
        /// <param name="id">角色id.</param>
        /// <param name="name">角色名称.</param>
        /// <param name="updateTime">最后修改时间.</param>
        /// <param name="updaterId">最后修改人id.</param>
        public AlipayIserviceCcmRoleGetResponseModel(string ccsInstanceId = default(string), string createTime = default(string), string creatorId = default(string), string description = default(string), List<string> functionIds = default(List<string>), string id = default(string), string name = default(string), string updateTime = default(string), string updaterId = default(string))
        {
        ...
        {
            return this.Equals(input as AlipayIserviceCcmRoleGetResponseModel);
        }

        /// <summary>
        /// Returns true if AlipayIserviceCcmRoleGetResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayIserviceCcmRoleGetResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayIserviceCcmRoleGetResponseModel input)
        {
            if (input == null)
            {
                return false;
