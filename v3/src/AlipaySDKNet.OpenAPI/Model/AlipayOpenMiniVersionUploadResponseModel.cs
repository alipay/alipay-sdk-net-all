...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayOpenMiniVersionUploadResponseModel")]
    public partial class AlipayOpenMiniVersionUploadResponseModel : IEquatable<AlipayOpenMiniVersionUploadResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayOpenMiniVersionUploadResponseModel" /> class.
        /// </summary>
        /// <param name="buildStatus">构建的状态，0-构建排队中；1-正在构建；2-构建成功；3-构建失败；5-构建超时.</param>
        /// <param name="createStatus">创建版本的状态，0-构建排队中；1-正在构建；2-构建成功；3-构建失败；5-构建超时；6-版本创建成功.</param>
        /// <param name="needRotation">是否需要轮询.</param>
        /// <param name="versionCreated">是否创建了版本.</param>
        public AlipayOpenMiniVersionUploadResponseModel(string buildStatus = default(string), string createStatus = default(string), string needRotation = default(string), string versionCreated = default(string))
        {
        ...
        /// </summary>
        /// <value>创建版本的状态，0-构建排队中；1-正在构建；2-构建成功；3-构建失败；5-构建超时；6-版本创建成功</value>
        ...
        {
            return this.Equals(input as AlipayOpenMiniVersionUploadResponseModel);
        }

        /// <summary>
        /// Returns true if AlipayOpenMiniVersionUploadResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayOpenMiniVersionUploadResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayOpenMiniVersionUploadResponseModel input)
        {
            if (input == null)
            {
                return false;
