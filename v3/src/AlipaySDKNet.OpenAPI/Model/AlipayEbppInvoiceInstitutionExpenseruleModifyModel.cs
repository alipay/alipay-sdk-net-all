...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceInstitutionExpenseruleModifyModel : IEquatable<AlipayEbppInvoiceInstitutionExpenseruleModifyModel>, IValidatableObject
    {
        ...
        /// <param name="action">修改使用规则，操作枚举： ADD_RULE（新增使用条件）， DELETE_RULE（删除使用条件）， MODIFY_RULE（修改使用条件），MODIFY_BASIC_INFO（修改规则基本信息）.</param>
        /// <param name="agreementNo">授权签约协议号，可通过签约消息获取。配合企业共同账户id使用，当填写企业共同账户id时，此字段必填。.</param>
        /// <param name="consumeMode">该使用规则支持的资产消费模式，不填写则为默认模式，默认模式下有余额时使用余额，没有余额则使用规则中的限额.</param>
        /// <param name="enterpriseId">企业id.</param>
        /// <param name="expenseCtrlRuleInfoList">使用规则条件列表.</param>
        /// <param name="institutionId">制度id.</param>
        /// <param name="openRuleId">开票规则id，如果之前已关联开票规则，则更换开票规则id不生效.</param>
        /// <param name="paymentPolicy">当笔消费金额大于规则可用余额时，用于控制支付策略，该字段缺省时采取因公账户和个人账户组合支付策略COMBINATION.</param>
        /// <param name="standardConditionInfoList">规则条件列表.</param>
        /// <param name="standardDesc">规则描述（敏感词校验）.</param>
        /// <param name="standardId">使用规则id.</param>
        /// <param name="standardName">规则名称（敏感词校验）.</param>
        public AlipayEbppInvoiceInstitutionExpenseruleModifyModel(string accountId = default(string), string action = default(string), string agreementNo = default(string), string consumeMode = default(string), string enterpriseId = default(string), List<ExpenseCtrRuleInfo> expenseCtrlRuleInfoList = default(List<ExpenseCtrRuleInfo>), string institutionId = default(string), string openRuleId = default(string), string paymentPolicy = default(string), List<StandardConditionInfo> standardConditionInfoList = default(List<StandardConditionInfo>), string standardDesc = default(string), string standardId = default(string), string standardName = default(string))
        {
        ...
        /// </summary>
        /// <value>修改使用规则，操作枚举： ADD_RULE（新增使用条件）， DELETE_RULE（删除使用条件）， MODIFY_RULE（修改使用条件），MODIFY_BASIC_INFO（修改规则基本信息）</value>
        ...
        /// </summary>
        /// <value>该使用规则支持的资产消费模式，不填写则为默认模式，默认模式下有余额时使用余额，没有余额则使用规则中的限额</value>
        ...
        /// </summary>
        /// <value>开票规则id，如果之前已关联开票规则，则更换开票规则id不生效</value>
        ...
        /// </summary>
        /// <value>当笔消费金额大于规则可用余额时，用于控制支付策略，该字段缺省时采取因公账户和个人账户组合支付策略COMBINATION</value>
