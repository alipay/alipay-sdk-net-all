...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class VoucherPackageBaseInfo : IEquatable<VoucherPackageBaseInfo>, IValidatableObject
    {
        ...
        /// <param name="voucherPackageStatus">券包状态。 CREATED：已创建, ENABLE： 已发布（包含进行中和已过期，已过期以voucher_package_purchase_end_time为准）, PAUSED： 已暂停, DISABLE： 已停止;.</param>
        ...
        /// </summary>
        /// <value>券包状态。 CREATED：已创建, ENABLE： 已发布（包含进行中和已过期，已过期以voucher_package_purchase_end_time为准）, PAUSED： 已暂停, DISABLE： 已停止;</value>
