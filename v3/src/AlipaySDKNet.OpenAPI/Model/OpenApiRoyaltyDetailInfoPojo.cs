...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class OpenApiRoyaltyDetailInfoPojo : IEquatable<OpenApiRoyaltyDetailInfoPojo>, IValidatableObject
    {
        ...
        /// <param name="royaltyType">分账类型.  普通分账为：transfer;  补差为：replenish;  为空默认为分账transfer;.</param>
        ...
        /// <param name="transInType">收入方账户类型。userId表示是支付宝账号对应的支付宝唯一用户号;cardAliasNo表示是卡编号;loginName表示是支付宝登录号；.</param>
        ...
        /// <param name="transOutType">支出方账户类型。userId表示是支付宝账号对应的支付宝唯一用户号;loginName表示是支付宝登录号； 泛金融类商户分账时，该字段不要上送。.</param>
        ...
        /// </summary>
        /// <value>分账类型.  普通分账为：transfer;  补差为：replenish;  为空默认为分账transfer;</value>
        ...
        /// </summary>
        /// <value>收入方账户类型。userId表示是支付宝账号对应的支付宝唯一用户号;cardAliasNo表示是卡编号;loginName表示是支付宝登录号；</value>
        ...
        /// </summary>
        /// <value>支出方账户类型。userId表示是支付宝账号对应的支付宝唯一用户号;loginName表示是支付宝登录号； 泛金融类商户分账时，该字段不要上送。</value>
