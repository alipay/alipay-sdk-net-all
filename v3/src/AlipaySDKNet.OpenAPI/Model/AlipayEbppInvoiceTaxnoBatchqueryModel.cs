...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceTaxnoBatchqueryModel : IEquatable<AlipayEbppInvoiceTaxnoBatchqueryModel>, IValidatableObject
    {
        ...
        /// <param name="invoiceKindList">查询票种列表。枚举值如下： *PLAIN：增值税电子普通发票； *SPECIAL：增值税专用发票； *ALL_ELECTRONIC_GENERAL： \&quot;电子发票（普通发票）; *ALL_ELECTRONIC_SPECIAL： \&quot;电子发票（专用发票）; *PLAIN_INVOICE：增值税普通发票； *PAPER_INVOICE：增值税普通发票（卷式）； *SALSE_INVOICE：机动车销售统一发票。.</param>
        ...
        /// </summary>
        /// <value>查询票种列表。枚举值如下： *PLAIN：增值税电子普通发票； *SPECIAL：增值税专用发票； *ALL_ELECTRONIC_GENERAL： \&quot;电子发票（普通发票）; *ALL_ELECTRONIC_SPECIAL： \&quot;电子发票（专用发票）; *PLAIN_INVOICE：增值税普通发票； *PAPER_INVOICE：增值税普通发票（卷式）； *SALSE_INVOICE：机动车销售统一发票。</value>
