...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderVoucherShopFailInfo")]
    public partial class OrderVoucherShopFailInfo : IEquatable<OrderVoucherShopFailInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderVoucherShopFailInfo" /> class.
        /// </summary>
        /// <param name="failMessage">请求失败提示信息。.</param>
        /// <param name="failReasons">请求失败的原因。.</param>
        /// <param name="shopId">请求失败的支付门店 ID。.</param>
        public OrderVoucherShopFailInfo(string failMessage = default(string), List<string> failReasons = default(List<string>), string shopId = default(string))
        {
        ...
        {
            return this.Equals(input as OrderVoucherShopFailInfo);
        }

        /// <summary>
        /// Returns true if OrderVoucherShopFailInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderVoucherShopFailInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderVoucherShopFailInfo input)
        {
            if (input == null)
            {
                return false;
