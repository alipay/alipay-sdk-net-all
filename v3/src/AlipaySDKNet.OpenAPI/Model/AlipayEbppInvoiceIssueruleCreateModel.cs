...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceIssueruleCreateModel : IEquatable<AlipayEbppInvoiceIssueruleCreateModel>, IValidatableObject
    {
        ...
        /// <param name="effective">是否启用，\&quot;0\&quot;为停用，\&quot;1\&quot;为启用； 如果target_type指定INSTITUTION，则与制度一致,无需填写.</param>
        /// <param name="effectivePeriod">生效周期，时间不限格式：\&quot;{\\\&quot;all\\\&quot;:true}\&quot;.</param>
        /// <param name="enterpriseId">企业ID.</param>
        /// <param name="invalidMode">是否可累计，枚举：0（不可累计）、1（可累计），2（累计天数）、3（累计到指定日期）余额只允许可累计，按城市发放只允许不可累计，设置了生效周期只允许不可累计.</param>
        ...
        /// <param name="quotaType">额度类型，枚举：COUPON（点券）、CAP（余额）、ISV（外算额度）.</param>
        /// <param name="shareMode">是否可转赠，枚举：0（不可转赠）、1（可转赠）.</param>
        ...
        /// </summary>
        /// <value>是否启用，\&quot;0\&quot;为停用，\&quot;1\&quot;为启用； 如果target_type指定INSTITUTION，则与制度一致,无需填写</value>
        ...
        /// </summary>
        /// <value>生效周期，时间不限格式：\&quot;{\\\&quot;all\\\&quot;:true}\&quot;</value>
        ...
        /// </summary>
        /// <value>是否可累计，枚举：0（不可累计）、1（可累计），2（累计天数）、3（累计到指定日期）余额只允许可累计，按城市发放只允许不可累计，设置了生效周期只允许不可累计</value>
        ...
        /// </summary>
        /// <value>额度类型，枚举：COUPON（点券）、CAP（余额）、ISV（外算额度）</value>
        ...
        /// </summary>
        /// <value>是否可转赠，枚举：0（不可转赠）、1（可转赠）</value>
