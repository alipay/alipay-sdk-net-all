...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayCommerceEcEnterpriseAddressModifyModel : IEquatable<AlipayCommerceEcEnterpriseAddressModifyModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="accountId">共同账户id和enterprise_id二选一.</param>
        /// <param name="address">详细地址最长50个字符.</param>
        /// <param name="addressId">地址id.</param>
        /// <param name="agreementNo">协议号，如果填共同账户id，则该字段必填.</param>
        /// <param name="cityCode">市(国家统一行政规划编码).</param>
        /// <param name="cityName">城市名称.</param>
        /// <param name="community">小区/楼宇.</param>
        /// <param name="enterpriseId">企业id和account_id二选一.</param>
        /// <param name="latitude">纬度.</param>
        /// <param name="longitude">经度.</param>
        /// <param name="mark">备注.</param>
        /// <param name="poiId">高德地图poi.</param>
        /// <param name="status">状态(生效/失效) NORMAL INVALID.</param>
        ...
        /// </summary>
        /// <value>共同账户id和enterprise_id二选一</value>
        ...
        /// </summary>
        /// <value>协议号，如果填共同账户id，则该字段必填</value>
        ...
        /// 企业id和account_id二选一
        /// </summary>
        /// <value>企业id和account_id二选一</value>
        ...
        /// </summary>
        /// <value>状态(生效/失效) NORMAL INVALID</value>
