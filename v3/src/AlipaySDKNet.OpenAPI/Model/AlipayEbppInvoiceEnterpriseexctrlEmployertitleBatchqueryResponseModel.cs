...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel : IEquatable<AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel>, IValidatableObject
    {
        ...
        public AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel(string code = default(string), string msg = default(string), string titleCode = default(string), List<EnterpriseTitleInfo> titleInfoList = default(List<EnterpriseTitleInfo>))
        {
            this.Code = code;
            this.Msg = msg;
