...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayCommerceEcDepartmentCreateModel : IEquatable<AlipayCommerceEcDepartmentCreateModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="departmentCode">部门编码，不同部门的编码不可重复，如果为空则生成默认部门编码.</param>
        /// <param name="departmentName">部门名称.</param>
        /// <param name="enterpriseId">企业id.</param>
        /// <param name="parentDepartmentId">上级部门id，如果为空则默认设置上级部门为根部门.</param>
        ...
        /// </summary>
        /// <value>部门编码，不同部门的编码不可重复，如果为空则生成默认部门编码</value>
        ...
        /// </summary>
        /// <value>上级部门id，如果为空则默认设置上级部门为根部门</value>
