...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class VoucherAvailableGeographyShopInfo : IEquatable<VoucherAvailableGeographyShopInfo>, IValidatableObject
    {
        ...
        /// <param name="availableRealShopIds">券可使用的物理门店列表，列表中的门店id是调用接口alipay.business.relation.shop.create创建门店返回的real_shop_id 接口参数是列表类型。.</param>
        ...
        /// </summary>
        /// <value>券可使用的物理门店列表，列表中的门店id是调用接口alipay.business.relation.shop.create创建门店返回的real_shop_id 接口参数是列表类型。</value>
