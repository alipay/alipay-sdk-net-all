...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LogisticsAccountStatusDTO")]
    public partial class LogisticsAccountStatusDTO : IEquatable<LogisticsAccountStatusDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogisticsAccountStatusDTO" /> class.
        /// </summary>
        /// <param name="auditDesc">商家在配送公司的账户的审核说明.</param>
        /// <param name="logisticsCode">配送公司物流编码。.</param>
        /// <param name="logisticsName">配送公司名称。.</param>
        /// <param name="status">账户状态，AUDITING:审核中，AUDIT_REJECT:审核驳回，VALID:已生效.</param>
        public LogisticsAccountStatusDTO(string auditDesc = default(string), string logisticsCode = default(string), string logisticsName = default(string), string status = default(string))
        {
        ...
        /// </summary>
        /// <value>账户状态，AUDITING:审核中，AUDIT_REJECT:审核驳回，VALID:已生效</value>
        ...
        {
            return this.Equals(input as LogisticsAccountStatusDTO);
        }

        /// <summary>
        /// Returns true if LogisticsAccountStatusDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of LogisticsAccountStatusDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogisticsAccountStatusDTO input)
        {
            if (input == null)
            {
                return false;
