...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayMarketingCardTemplateCreateModel : IEquatable<AlipayMarketingCardTemplateCreateModel>, IValidatableObject
    {
        ...
        /// <param name="cardType">卡类型。可选类型如下： OUT_MEMBER_CARD：外部权益卡.</param>
        ...
        /// <param name="serviceLabelList">服务Code  HUABEI_FUWU：花呗服务（只有需要花呗服务时，才需要加入该标识）.</param>
        ...
        /// </summary>
        /// <value>卡类型。可选类型如下： OUT_MEMBER_CARD：外部权益卡</value>
        ...
        /// </summary>
        /// <value>服务Code  HUABEI_FUWU：花呗服务（只有需要花呗服务时，才需要加入该标识）</value>
