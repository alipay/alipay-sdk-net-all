...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// ItemSkuCreateInfo
    /// </summary>
    [DataContract(Name = "ItemSkuCreateInfo")]
    public partial class ItemSkuCreateInfo : IEquatable<ItemSkuCreateInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemSkuCreateInfo" /> class.
        /// </summary>
        /// <param name="costPrice">成本价，单位分.</param>
        /// <param name="extInfo">SKU扩展信息.</param>
        /// <param name="externalSkuId">外部SKU ID.</param>
        /// <param name="inventory">库存.</param>
        /// <param name="originalPrice">标价，单位分.</param>
        /// <param name="price">售价，单位分.</param>
        public ItemSkuCreateInfo(int costPrice = default(int), List<ItemExtInfo> extInfo = default(List<ItemExtInfo>), string externalSkuId = default(string), int inventory = default(int), int originalPrice = default(int), int price = default(int))
        {
        ...
        {
            return this.Equals(input as ItemSkuCreateInfo);
        }

        /// <summary>
        /// Returns true if ItemSkuCreateInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemSkuCreateInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemSkuCreateInfo input)
        {
            if (input == null)
            {
                return false;
