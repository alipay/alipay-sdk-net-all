...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class EnterpriseInfoDTO : IEquatable<EnterpriseInfoDTO>, IValidatableObject
    {
        ...
        /// <param name="enterpriseAliasAuditStatus">企业简称审核状态 PASSED： 通过 REJECTED： 驳回 AUDITING： 审核中.</param>
        ...
        public EnterpriseInfoDTO(string accountId = default(string), string activate = default(string), string authLevel = default(string), string authStatus = default(string), string authTime = default(string), string enterpriseAlias = default(string), string enterpriseAliasAuditStatus = default(string), string enterpriseCode = default(string), string enterpriseEmail = default(string), string enterpriseId = default(string), string enterpriseName = default(string), string gmtCreate = default(string), string gmtModified = default(string), string iotGroupId = default(string), string iotLogicGroupId = default(string), string platformCode = default(string), string platformOutId = default(string), string signStatus = default(string), string status = default(string))
        {
        ...
        /// </summary>
        /// <value>企业简称审核状态 PASSED： 通过 REJECTED： 驳回 AUDITING： 审核中</value>
        [DataMember(Name = "enterprise_alias_audit_status", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EnterpriseAliasAuditStatus: ").Append(EnterpriseAliasAuditStatus).Append("\n");
        ...
        public bool Equals(EnterpriseInfoDTO input)
        {
            ...
            return 
                ...
                (
                    this.EnterpriseAliasAuditStatus == input.EnterpriseAliasAuditStatus ||
                    (this.EnterpriseAliasAuditStatus != null &&
                    this.EnterpriseAliasAuditStatus.Equals(input.EnterpriseAliasAuditStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnterpriseAliasAuditStatus != null)
                {
                    hashCode = (hashCode * 59) + this.EnterpriseAliasAuditStatus.GetHashCode();
                }
