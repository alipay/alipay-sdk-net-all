...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class PaidOuterCardCycleInfoDTO : IEquatable<PaidOuterCardCycleInfoDTO>, IValidatableObject
    {
        ...
        /// <param name="closeReason">关闭连续购买原因。枚举如下： MANUAL_CLOSE(手动关闭) EXPIRE_CLOSE(过期关闭) CLOSE(关闭).</param>
        /// <param name="cycleType">用户开通连续购买类型。枚举如下： YEAR(年) QUARTER(季度) MONTH(月).</param>
        /// <param name="openStatus">开通连续购买状态。枚举如下： OPEN(打开) CLOSE(关闭).</param>
        ...
        /// </summary>
        /// <value>关闭连续购买原因。枚举如下： MANUAL_CLOSE(手动关闭) EXPIRE_CLOSE(过期关闭) CLOSE(关闭)</value>
        ...
        /// </summary>
        /// <value>用户开通连续购买类型。枚举如下： YEAR(年) QUARTER(季度) MONTH(月)</value>
        ...
        /// </summary>
        /// <value>开通连续购买状态。枚举如下： OPEN(打开) CLOSE(关闭)</value>
