...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class InvoiceItemOpenModel : IEquatable<InvoiceItemOpenModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="itemExTaxAmount">明细行不含税金额，保留两位小数.</param>
        ...
        /// <param name="itemSumAmount">明细行价税合计，必须保证item_sum_amount&#x3D;item_ex_tax_amount+item_tax_amount。.</param>
        /// <param name="itemTaxAmount">明细行税额，保留两位小数，无税或者免税情况下输入：0.00。.</param>
        /// <param name="itemTaxRate">明细行税率，无税或者免税情况下输入：0.00。.</param>
        /// <param name="itemUnit">单位.</param>
        /// <param name="itemUnitPrice">不含税单价; 1.当row_type&#x3D;0或2且item_quantity为空，可空 2.可精确到小数点后8位；.</param>
        ...
        /// </summary>
        /// <value>明细行价税合计，必须保证item_sum_amount&#x3D;item_ex_tax_amount+item_tax_amount。</value>
        ...
        /// </summary>
        /// <value>明细行税额，保留两位小数，无税或者免税情况下输入：0.00。</value>
        ...
        /// </summary>
        /// <value>不含税单价; 1.当row_type&#x3D;0或2且item_quantity为空，可空 2.可精确到小数点后8位；</value>
