...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ZhimaCreditPayafteruseCreditagreementTransferModel : IEquatable<ZhimaCreditPayafteruseCreditagreementTransferModel>, IValidatableObject
    {
        ...
        public ZhimaCreditPayafteruseCreditagreementTransferModel(string categoryId = default(string), string deductAgreementNo = default(string), string extendParams = default(string), string outAgreementNo = default(string), string productCode = default(string), string zmServiceId = default(string))
        {
