...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayCommerceTransportParkingPaymentinfoSyncModel : IEquatable<AlipayCommerceTransportParkingPaymentinfoSyncModel>, IValidatableObject
    {
        ...
        /// <param name="nodeType">表示当前请求类型：用户缴费或用户在岗亭前缴费准备离场状态.</param>
        /// <param name="openAppid">蚂蚁会员统一ID对应的归属应用appid.</param>
        /// <param name="openId">蚂蚁会员统一ID.</param>
        /// <param name="orderCreateTime">停车岗亭前订单创建时间，格式\&quot;YYYY-MM-DD HH:mm:ss\&quot;，24小时制，请保证服务器时间准确，创建时不应晚于当前网络时间.</param>
        ...
        public AlipayCommerceTransportParkingPaymentinfoSyncModel(string alipayTradeNo = default(string), string discountAmount = default(string), List<ParkingPaymentDiscountInfo> discountInformation = default(List<ParkingPaymentDiscountInfo>), string freeExitMinutes = default(string), bool inactiveUser = default(bool), bool isEncryptPlateNo = default(bool), string mobileNumber = default(string), string nodeType = default(string), string openAppid = default(string), string openId = default(string), string orderCreateTime = default(string), string outOrderNo = default(string), string outSerialNo = default(string), string payFrequency = default(string), string paymentAmount = default(string), string paymentTime = default(string), string paymentType = default(string), string paymentUserOpenId = default(string), string plateColor = default(string), string plateNo = default(string), string serviceUrl = default(string), string totalAmount = default(string))
        {
        ...
        /// </summary>
        /// <value>表示当前请求类型：用户缴费或用户在岗亭前缴费准备离场状态</value>
        [DataMember(Name = "node_type", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>停车岗亭前订单创建时间，格式\&quot;YYYY-MM-DD HH:mm:ss\&quot;，24小时制，请保证服务器时间准确，创建时不应晚于当前网络时间</value>
