...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel : IEquatable<DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="quality">人脸图片质量分，单位为分.</param>
        /// <param name="score">人脸比对分，单位分.</param>
        public DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel(string alivePhoto = default(string), string attackFlag = default(string), string certifyState = default(string), OpenCertifyMetaInfo metaInfo = default(OpenCertifyMetaInfo), string quality = default(string), string score = default(string))
        {
