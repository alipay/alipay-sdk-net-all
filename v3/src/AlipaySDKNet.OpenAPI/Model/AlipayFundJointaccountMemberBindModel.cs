...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayFundJointaccountMemberBindModel : IEquatable<AlipayFundJointaccountMemberBindModel>, IValidatableObject
    {
        ...
        /// <param name="identity">成员账号： identity_type是ALIPAY_USER_ID填支付宝会员ID（2088开头）； 是ALIPAY_LOGON_ID 填支付宝登录号； 是ALIPAY_OPEN_ID 填支付宝openId.</param>
        ...
        public AlipayFundJointaccountMemberBindModel(string accountId = default(string), JointAccountQuotaDTO accountQuota = default(JointAccountQuotaDTO), string agreementNo = default(string), string bizScene = default(string), InviteMemberBusinessParamsDTO businessParams = default(InviteMemberBusinessParamsDTO), string identity = default(string), string identityType = default(string), IdentityVerifiedInfoDTO identityVerifiedInfo = default(IdentityVerifiedInfoDTO), string name = default(string), string productCode = default(string))
        {
        ...
        /// </summary>
        /// <value>成员账号： identity_type是ALIPAY_USER_ID填支付宝会员ID（2088开头）； 是ALIPAY_LOGON_ID 填支付宝登录号； 是ALIPAY_OPEN_ID 填支付宝openId</value>
