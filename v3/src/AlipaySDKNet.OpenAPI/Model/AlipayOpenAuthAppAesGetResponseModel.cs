...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayOpenAuthAppAesGetResponseModel")]
    public partial class AlipayOpenAuthAppAesGetResponseModel : IEquatable<AlipayOpenAuthAppAesGetResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayOpenAuthAppAesGetResponseModel" /> class.
        /// </summary>
        ...
        public AlipayOpenAuthAppAesGetResponseModel(string aesKey = default(string))
        {
            this.AesKey = aesKey;
        }
        ...
        {
            return this.Equals(input as AlipayOpenAuthAppAesGetResponseModel);
        }

        /// <summary>
        /// Returns true if AlipayOpenAuthAppAesGetResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayOpenAuthAppAesGetResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayOpenAuthAppAesGetResponseModel input)
        {
            if (input == null)
            {
                return false;
