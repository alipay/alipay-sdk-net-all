...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ActivityExchangeVoucher : IEquatable<ActivityExchangeVoucher>, IValidatableObject
    {
        ...
        /// <param name="floorAmount">优惠门槛金额，表示只有当订单金额大于等于门槛金额时券才能使用。该字段为空时表示无门槛。 门槛金额的校验由服务商(商户)核销时自行校验，支付宝侧只做展示使用。 币种为人民币，单位为元。小数点以后最多保留两位。 设置门槛：取值范围:0.1&lt;&#x3D;x&lt;&#x3D; 50000。如果设置了门槛金额，则必须大于等于0.1，不可以等于0。.</param>
        ...
        /// </summary>
        /// <value>优惠门槛金额，表示只有当订单金额大于等于门槛金额时券才能使用。该字段为空时表示无门槛。 门槛金额的校验由服务商(商户)核销时自行校验，支付宝侧只做展示使用。 币种为人民币，单位为元。小数点以后最多保留两位。 设置门槛：取值范围:0.1&lt;&#x3D;x&lt;&#x3D; 50000。如果设置了门槛金额，则必须大于等于0.1，不可以等于0。</value>
