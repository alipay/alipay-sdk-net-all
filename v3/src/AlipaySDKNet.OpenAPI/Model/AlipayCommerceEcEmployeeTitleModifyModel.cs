...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayCommerceEcEmployeeTitleModifyModel : IEquatable<AlipayCommerceEcEmployeeTitleModifyModel>, IValidatableObject
    {
        ...
        /// <param name="multiTitleList">绑定的抬头ID列表.</param>
        /// <param name="newTitleId">修改后的抬头id.</param>
        /// <param name="oldTitleId">修改前的抬头id(数据库自行查询是否有有效抬头).</param>
        ...
        public AlipayCommerceEcEmployeeTitleModifyModel(string accountId = default(string), string createBy = default(string), string employeeId = default(string), string enterpriseId = default(string), string modifyBy = default(string), List<EcEmployeeTitleModifyTaxNoAndTitleId> multiTitleList = default(List<EcEmployeeTitleModifyTaxNoAndTitleId>), string newTitleId = default(string), string oldTitleId = default(string), string openId = default(string), string taxRegisterNo = default(string), string titleTag = default(string), string userId = default(string))
        {
        ...
        /// 绑定的抬头ID列表
        /// </summary>
        /// <value>绑定的抬头ID列表</value>
        [DataMember(Name = "multi_title_list", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>修改前的抬头id(数据库自行查询是否有有效抬头)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MultiTitleList: ").Append(MultiTitleList).Append("\n");
        ...
        public bool Equals(AlipayCommerceEcEmployeeTitleModifyModel input)
        {
            ...
            return 
                ...
                (
                    this.MultiTitleList == input.MultiTitleList ||
                    this.MultiTitleList != null &&
                    input.MultiTitleList != null &&
                    this.MultiTitleList.SequenceEqual(input.MultiTitleList)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.MultiTitleList.GetHashCode();
                }
