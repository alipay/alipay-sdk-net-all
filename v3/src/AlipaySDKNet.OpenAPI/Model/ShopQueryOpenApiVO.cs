...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ShopQueryOpenApiVO : IEquatable<ShopQueryOpenApiVO>, IValidatableObject
    {
        ...
        public ShopQueryOpenApiVO(AddressInfo businessAddress = default(AddressInfo), List<ShopBusinessTime> businessTime = default(List<ShopBusinessTime>), string contactMobile = default(string), string contactPhone = default(string), List<ComplexBusinessTime> newBusinessTime = default(List<ComplexBusinessTime>), string newShopCategory = default(string), string shopCategory = default(string), string shopId = default(string), string shopInfoStatus = default(string), string shopName = default(string), string shopStatus = default(string), string shopType = default(string), string storeId = default(string))
        {
