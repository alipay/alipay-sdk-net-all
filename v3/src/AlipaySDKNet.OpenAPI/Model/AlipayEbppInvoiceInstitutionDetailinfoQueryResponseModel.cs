...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceInstitutionDetailinfoQueryResponseModel : IEquatable<AlipayEbppInvoiceInstitutionDetailinfoQueryResponseModel>, IValidatableObject
    {
        ...
        public AlipayEbppInvoiceInstitutionDetailinfoQueryResponseModel(string adapterType = default(string), string consultMode = default(string), string currency = default(string), string effective = default(string), string effectiveEndDate = default(string), string effectiveStartDate = default(string), string expenseType = default(string), string institutionDesc = default(string), string institutionId = default(string), string institutionName = default(string), List<IssueRuleInfo> issueRuleInfoList = default(List<IssueRuleInfo>), string multiEmployeeShareMode = default(string), string outerSourceId = default(string), List<string> ownerIdList = default(List<string>), List<string> ownerOpenIdList = default(List<string>), string ownerType = default(string), string sceneType = default(string), List<StandardInfo> standardInfoDetailList = default(List<StandardInfo>), StandardInfo standardInfoList = default(StandardInfo))
        {
