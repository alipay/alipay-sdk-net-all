...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class Participant : IEquatable<Participant>, IValidatableObject
    {
        ...
        /// <param name="identityType">参与方的标识类型，目前支持如下类型： 1、ALIPAY_USER_ID 支付宝的会员ID 2、ALIPAY_LOGON_ID：支付宝登录号，支持邮箱和手机号格式 3、ALIPAY_OPEN_ID：支付宝openid.</param>
        ...
        public Participant(BankcardExtInfo bankcardExtInfo = default(BankcardExtInfo), string extInfo = default(string), string identity = default(string), string identityType = default(string), string merchantUserInfo = default(string), string name = default(string))
        {
        ...
        /// </summary>
        /// <value>参与方的标识类型，目前支持如下类型： 1、ALIPAY_USER_ID 支付宝的会员ID 2、ALIPAY_LOGON_ID：支付宝登录号，支持邮箱和手机号格式 3、ALIPAY_OPEN_ID：支付宝openid</value>
