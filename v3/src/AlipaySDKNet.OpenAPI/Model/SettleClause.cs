...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class SettleClause : IEquatable<SettleClause>, IValidatableObject
    {
        ...
        /// <param name="settleAccountIdType">结算账户id类型。  当settle_account_type 为bankCard时，本参数为cardSerialNo，表示结算账户id是银行卡编号; 当settle_account_type 为alipayBalance时，本参数为userId或者loginName，其中userId表示结算账户id是支付宝唯一用户号，loginName表示结算账户id是支付宝登录号; 当 settle_account_type 为 defaultSettle 时，本参数必须为空.</param>
        ...
        public SettleClause(string amount = default(string), string currency = default(string), string settleAccountEntity = default(string), string settleAccountId = default(string), string settleAccountIdType = default(string), string settleAccountType = default(string), string settleEntityId = default(string), string settleEntityType = default(string), SubMerchant subMerchant = default(SubMerchant))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>结算账户id类型。  当settle_account_type 为bankCard时，本参数为cardSerialNo，表示结算账户id是银行卡编号; 当settle_account_type 为alipayBalance时，本参数为userId或者loginName，其中userId表示结算账户id是支付宝唯一用户号，loginName表示结算账户id是支付宝登录号; 当 settle_account_type 为 defaultSettle 时，本参数必须为空</value>
