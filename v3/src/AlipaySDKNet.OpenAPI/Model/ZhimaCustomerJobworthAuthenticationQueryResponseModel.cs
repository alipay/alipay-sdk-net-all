...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ZhimaCustomerJobworthAuthenticationQueryResponseModel : IEquatable<ZhimaCustomerJobworthAuthenticationQueryResponseModel>, IValidatableObject
    {
        ...
        public ZhimaCustomerJobworthAuthenticationQueryResponseModel(string identityResult = default(string), string identityResultSkipUrl = default(string), string tokenStatus = default(string))
        {
