...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayOpenAppServiceQueryResponseModel : IEquatable<AlipayOpenAppServiceQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="status">服务状态，EDITING(编辑中)/AUDITING(审核中)/AUDIT_REJECT(审核驳回)/PROMOTION(可推广)/STOP_PROMOTION(停止推广)/INVALID(失效)/PUNISHED(处罚).</param>
        /// <param name="templateType">服务模板类型.</param>
        public AlipayOpenAppServiceQueryResponseModel(string rejectReason = default(string), string serviceCode = default(string), string serviceXml = default(string), string status = default(string), string templateType = default(string))
        {
        ...
        /// </summary>
        /// <value>服务状态，EDITING(编辑中)/AUDITING(审核中)/AUDIT_REJECT(审核驳回)/PROMOTION(可推广)/STOP_PROMOTION(停止推广)/INVALID(失效)/PUNISHED(处罚)</value>
