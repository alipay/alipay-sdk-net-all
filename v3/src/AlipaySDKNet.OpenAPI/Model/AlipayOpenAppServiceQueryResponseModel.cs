...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayOpenAppServiceQueryResponseModel : IEquatable<AlipayOpenAppServiceQueryResponseModel>, IValidatableObject
    {
        ...
        public AlipayOpenAppServiceQueryResponseModel(string rejectReason = default(string), string serviceCode = default(string), string serviceXml = default(string), string status = default(string))
        {
