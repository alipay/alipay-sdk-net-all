...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class UserInfomation : IEquatable<UserInfomation>, IValidatableObject
    {
        ...
        /// <param name="certType">身份证：IDENTITY_CARD、护照：PASSPORT、军官证：OFFICER_CARD、士兵证：SOLDIER_CARD、户口本：HOKOU等。.</param>
        /// <param name="extInfo">扩展信息.</param>
        /// <param name="mobile">手机号.</param>
        /// <param name="name">姓名.</param>
        /// <param name="openId">用户（user_id）在应用（appId）下的唯一用户标识.</param>
        ...
        /// </summary>
        /// <value>身份证：IDENTITY_CARD、护照：PASSPORT、军官证：OFFICER_CARD、士兵证：SOLDIER_CARD、户口本：HOKOU等。</value>
        ...
        /// </summary>
        /// <value>用户（user_id）在应用（appId）下的唯一用户标识</value>
