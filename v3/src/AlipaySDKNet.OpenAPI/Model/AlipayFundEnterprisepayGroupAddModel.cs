...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayFundEnterprisepayGroupAddModel")]
    public partial class AlipayFundEnterprisepayGroupAddModel : IEquatable<AlipayFundEnterprisepayGroupAddModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayFundEnterprisepayGroupAddModel" /> class.
        /// </summary>
        ...
        /// <param name="outBizNo">外部业务号，外部群组号.</param>
        /// <param name="productCode">产品码，默认值 ENTERPRISE_PAY.</param>
        public AlipayFundEnterprisepayGroupAddModel(string accountId = default(string), string agreementNo = default(string), string bizScene = default(string), FundExtInfo fundExtInfo = default(FundExtInfo), string name = default(string), string outBizNo = default(string), string productCode = default(string))
        {
        ...
        {
            return this.Equals(input as AlipayFundEnterprisepayGroupAddModel);
        }

        /// <summary>
        /// Returns true if AlipayFundEnterprisepayGroupAddModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayFundEnterprisepayGroupAddModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayFundEnterprisepayGroupAddModel input)
        {
            if (input == null)
            {
                return false;
