...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class EinvTrade : IEquatable<EinvTrade>, IValidatableObject
    {
        ...
        /// <param name="paymentAmount">支付金额  对应账单中的交易金额.</param>
        /// <param name="paymentTime">支付时间  对应账单中的账单日期.</param>
        /// <param name="souce">交易类型来源 需要按照枚举映射  consume 账单  hotel 酒店水单  itinerary 打车行程单  catering 餐饮小票.</param>
        ...
        /// </summary>
        /// <value>交易类型来源 需要按照枚举映射  consume 账单  hotel 酒店水单  itinerary 打车行程单  catering 餐饮小票</value>
