...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayTradeOrderPayResponseModel : IEquatable<AlipayTradeOrderPayResponseModel>, IValidatableObject
    {
        ...
        public AlipayTradeOrderPayResponseModel(string asyncPaymentMode = default(string), string gmtPayment = default(string), string outRequestNo = default(string), string outTradeNo = default(string), string totalAmount = default(string), string tradeNo = default(string))
        {
