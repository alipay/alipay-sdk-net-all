...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class DatadigitalFincloudGeneralsaasFaceVerificationInitializeModel : IEquatable<DatadigitalFincloudGeneralsaasFaceVerificationInitializeModel>, IValidatableObject
    {
        ...
        /// <param name="certType">证件类型，目前只支持身份证:IDENTITY_CARD.</param>
        ...
        public DatadigitalFincloudGeneralsaasFaceVerificationInitializeModel(string bizCode = default(string), string certName = default(string), string certNo = default(string), string certType = default(string), string faceReserveStrategy = default(string), string identityType = default(string), string outerOrderNo = default(string), string phoneNo = default(string))
        {
        ...
        /// </summary>
        /// <value>证件类型，目前只支持身份证:IDENTITY_CARD</value>
