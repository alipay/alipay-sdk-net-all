...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayFundAuthOperationDetailQueryResponseModel : IEquatable<AlipayFundAuthOperationDetailQueryResponseModel>, IValidatableObject
    {
        ...
        /// <param name="operationType">支付宝资金操作类型，表示当前查询到的这笔明细的操作类型。 目前支持：  FREEZE：冻结 UNFREEZE：解冻 PAY：支付.</param>
        ...
        /// </summary>
        /// <value>支付宝资金操作类型，表示当前查询到的这笔明细的操作类型。 目前支持：  FREEZE：冻结 UNFREEZE：解冻 PAY：支付</value>
