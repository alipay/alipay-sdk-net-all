...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayMarketingActivityOrdervoucherUseResponseModel")]
    public partial class AlipayMarketingActivityOrdervoucherUseResponseModel : IEquatable<AlipayMarketingActivityOrdervoucherUseResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayMarketingActivityOrdervoucherUseResponseModel" /> class.
        /// </summary>
        /// <param name="activityId">优惠券活动id.</param>
        /// <param name="voucherUseDetailResultInfo">voucherUseDetailResultInfo.</param>
        public AlipayMarketingActivityOrdervoucherUseResponseModel(string activityId = default(string), VoucherUseDetailResultInfo voucherUseDetailResultInfo = default(VoucherUseDetailResultInfo))
        {
        ...
        {
            return this.Equals(input as AlipayMarketingActivityOrdervoucherUseResponseModel);
        }

        /// <summary>
        /// Returns true if AlipayMarketingActivityOrdervoucherUseResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayMarketingActivityOrdervoucherUseResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayMarketingActivityOrdervoucherUseResponseModel input)
        {
            if (input == null)
            {
                return false;
