...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceEnterpriseconsumeEnterpriseopenruleCreateModel : IEquatable<AlipayEbppInvoiceEnterpriseconsumeEnterpriseopenruleCreateModel>, IValidatableObject
    {
        ...
        /// <param name="agreementNo">授权签约协议号（仅使用account_id时必传）.</param>
        /// <param name="billMonthDay">账期结束日期，可选范围1-31，只有汇总开需要.</param>
        /// <param name="enterpriseId">企业id.</param>
        /// <param name="invoiceRuleName">开票规则名称.</param>
        /// <param name="invoiceTitleId">汇总开需要抬头，笔笔开不需要传抬头.</param>
        /// <param name="openMode">开票模式：汇总开、笔笔开 枚举定义：SUMMARY:汇总开 SINGLE:单笔开.</param>
        /// <param name="sellerType">销方类型：TP开票、商户开票， 枚举定义：MERCHANT（商户）、TP（TP），不填默认商户.</param>
        /// <param name="tag">开票规则标记： DEFAULT-默认 EMPLOYEE_TITLE_FIRST-员工签约抬头优先于开票规则.</param>
        ...
        /// </summary>
        /// <value>授权签约协议号（仅使用account_id时必传）</value>
        ...
        /// </summary>
        /// <value>账期结束日期，可选范围1-31，只有汇总开需要</value>
        ...
        /// </summary>
        /// <value>开票模式：汇总开、笔笔开 枚举定义：SUMMARY:汇总开 SINGLE:单笔开</value>
        ...
        /// </summary>
        /// <value>销方类型：TP开票、商户开票， 枚举定义：MERCHANT（商户）、TP（TP），不填默认商户</value>
        ...
        /// </summary>
        /// <value>开票规则标记： DEFAULT-默认 EMPLOYEE_TITLE_FIRST-员工签约抬头优先于开票规则</value>
