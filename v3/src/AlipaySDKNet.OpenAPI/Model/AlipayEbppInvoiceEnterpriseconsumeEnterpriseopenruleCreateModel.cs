...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceEnterpriseconsumeEnterpriseopenruleCreateModel : IEquatable<AlipayEbppInvoiceEnterpriseconsumeEnterpriseopenruleCreateModel>, IValidatableObject
    {
        ...
        public AlipayEbppInvoiceEnterpriseconsumeEnterpriseopenruleCreateModel(string accountId = default(string), string agreementNo = default(string), int billMonthDay = default(int), string enterpriseId = default(string), string invoiceRuleName = default(string), string invoiceTitleId = default(string), string openMode = default(string), string receiveAddress = default(string), string receiveName = default(string), string receivePhone = default(string), string sellerType = default(string), string tag = default(string))
        {
