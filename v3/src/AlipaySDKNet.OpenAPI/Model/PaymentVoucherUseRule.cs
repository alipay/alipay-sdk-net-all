...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class PaymentVoucherUseRule : IEquatable<PaymentVoucherUseRule>, IValidatableObject
    {
        ...
        /// <param name="useMode">核销跳转方式,默认CAN_USE(详情页展示可使用按钮) 枚举值: SCAN_CODE 跳转到支付宝收钱码 SELF_LINK 跳转至商家指定页面 CAN_USE 卡包券详情页显示可使用按钮.</param>
        ...
        /// </summary>
        /// <value>核销跳转方式,默认CAN_USE(详情页展示可使用按钮) 枚举值: SCAN_CODE 跳转到支付宝收钱码 SELF_LINK 跳转至商家指定页面 CAN_USE 卡包券详情页显示可使用按钮</value>
