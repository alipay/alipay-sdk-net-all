...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayFundAuthOrderAppFreezeResponseModel")]
    public partial class AlipayFundAuthOrderAppFreezeResponseModel : IEquatable<AlipayFundAuthOrderAppFreezeResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayFundAuthOrderAppFreezeResponseModel" /> class.
        /// </summary>
        /// <param name="amount">本次操作冻结的金额，单位为：元（人民币），精确到小数点后两位.</param>
        /// <param name="authNo">支付宝的资金授权订单号.</param>
        /// <param name="creditAmount">本次冻结操作中信用冻结金额，单位为：元（人民币），精确到小数点后两位.</param>
        /// <param name="fundAmount">本次冻结操作中自有资金冻结金额，单位为：元（人民币），精确到小数点后两位.</param>
        /// <param name="gmtTrans">资金授权成功时间  格式：YYYY-MM-DD HH:MM:SS.</param>
        /// <param name="operationId">支付宝的资金操作流水号.</param>
        /// <param name="orderStr">获取签名后的业务数据.</param>
        /// <param name="outOrderNo">商户的授权资金订单号.</param>
        /// <param name="outRequestNo">商户本次资金操作的请求流水号.</param>
        /// <param name="payerOpenId">支付宝openId，用户（userId）在应用（appId）下的唯一用户标识。.</param>
        /// <param name="payerUserId">付款方支付宝用户号.</param>
        /// <param name="preAuthType">预授权类型，目前支持 CREDIT_AUTH(信用预授权);  商户可根据该标识来判断该笔预授权的类型，当返回值为\&quot;CREDIT_AUTH\&quot;表明该笔预授权为信用预授权，没有真实冻结资金；当返回值为空或者不为\&quot;CREDIT_AUTH\&quot;则表明该笔预授权为普通资金预授权，会冻结用户资金。.</param>
        /// <param name="status">资金预授权明细的状态  目前支持：    INIT：初始  SUCCESS: 成功  CLOSED：关闭.</param>
        /// <param name="transCurrency">标价币种,  amount 对应的币种单位。支持澳元：AUD, 新西兰元：NZD, 台币：TWD, 美元：USD, 欧元：EUR, 英镑：GBP, 人民币：CNY.</param>
        public AlipayFundAuthOrderAppFreezeResponseModel(string amount = default(string), string authNo = default(string), string creditAmount = default(string), string fundAmount = default(string), string gmtTrans = default(string), string operationId = default(string), string orderStr = default(string), string outOrderNo = default(string), string outRequestNo = default(string), string payerOpenId = default(string), string payerUserId = default(string), string preAuthType = default(string), string status = default(string), string transCurrency = default(string))
        {
            this.Amount = amount;
            this.AuthNo = authNo;
        ...
        /// </summary>
        /// <value>本次操作冻结的金额，单位为：元（人民币），精确到小数点后两位</value>
        ...
        /// </summary>
        /// <value>本次冻结操作中信用冻结金额，单位为：元（人民币），精确到小数点后两位</value>
        ...
        /// </summary>
        /// <value>本次冻结操作中自有资金冻结金额，单位为：元（人民币），精确到小数点后两位</value>
        ...
        /// </summary>
        /// <value>资金授权成功时间  格式：YYYY-MM-DD HH:MM:SS</value>
        ...
        /// 获取签名后的业务数据
        /// </summary>
        /// <value>获取签名后的业务数据</value>
        [DataMember(Name = "orderStr", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>支付宝openId，用户（userId）在应用（appId）下的唯一用户标识。</value>
        ...
        /// </summary>
        /// <value>预授权类型，目前支持 CREDIT_AUTH(信用预授权);  商户可根据该标识来判断该笔预授权的类型，当返回值为\&quot;CREDIT_AUTH\&quot;表明该笔预授权为信用预授权，没有真实冻结资金；当返回值为空或者不为\&quot;CREDIT_AUTH\&quot;则表明该笔预授权为普通资金预授权，会冻结用户资金。</value>
        ...
        /// </summary>
        /// <value>资金预授权明细的状态  目前支持：    INIT：初始  SUCCESS: 成功  CLOSED：关闭</value>
        ...
        {
            return this.Equals(input as AlipayFundAuthOrderAppFreezeResponseModel);
        }

        /// <summary>
        /// Returns true if AlipayFundAuthOrderAppFreezeResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayFundAuthOrderAppFreezeResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayFundAuthOrderAppFreezeResponseModel input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OrderStr == input.OrderStr ||
                    (this.OrderStr != null &&
                    this.OrderStr.Equals(input.OrderStr))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.OrderStr.GetHashCode();
                }
