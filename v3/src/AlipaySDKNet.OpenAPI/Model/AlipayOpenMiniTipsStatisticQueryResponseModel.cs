...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayOpenMiniTipsStatisticQueryResponseModel : IEquatable<AlipayOpenMiniTipsStatisticQueryResponseModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="appCollectCnt">昨日（接口调用当日的前一天）小程序收藏人数，时间内未创建投放活动，则响应时不传出参数。单位：个。.</param>
        /// <param name="appUv">昨日（接口调用当日的前一天）小程序访问人数。当小程序日访问量为0，或以活动维度查询，或时间内未创建投放活动，则响应时不传出参数。单位：个。.</param>
        ...
        /// <param name="tipsCollectUv">昨日（接口调用当日的前一天）收藏引导文案收藏用户数，时间内未创建投放活动，则响应时不传出参数。单位：个。.</param>
        /// <param name="tipsExpoUv">昨日（接口调用当日的前一天）收藏引导文案曝光用户数，时间内未创建投放活动，则响应时不传出参数。单位：个。.</param>
        /// <param name="totalAppCollectCnt">时间段内累计小程序收藏人数，时间内未创建投放活动，则响应时不传出参数。单位：个。.</param>
        /// <param name="totalAppUv">时间段内累计小程序访问人数。当小程序日访问量为0，或以活动维度查询，或时间内未创建投放活动，则响应时不传出参数。单位：个。.</param>
        /// <param name="totalTipsCollectRate">时间段内收藏引导文案收藏转化率，数据为小数字符串类型，取小数点后两位，单位为百分比。小程序曝光数为0，或时间内未创建投放活动，则响应时不传出参数。.</param>
        /// <param name="totalTipsCollectUv">时间段内累计收藏引导文案收藏用户数，时间内未创建投放活动，则响应时不传出参数。单位：个。.</param>
        /// <param name="totalTipsExpoUv">时间段内累计收藏引导文案曝光用户数，仅当小程序/活动投放活动时返回。时间内未创建投放活动，则响应时不传出参数。单位：个。.</param>
        ...
        /// </summary>
        /// <value>昨日（接口调用当日的前一天）小程序收藏人数，时间内未创建投放活动，则响应时不传出参数。单位：个。</value>
        ...
        /// </summary>
        /// <value>昨日（接口调用当日的前一天）小程序访问人数。当小程序日访问量为0，或以活动维度查询，或时间内未创建投放活动，则响应时不传出参数。单位：个。</value>
        ...
        /// </summary>
        /// <value>昨日（接口调用当日的前一天）收藏引导文案收藏用户数，时间内未创建投放活动，则响应时不传出参数。单位：个。</value>
        ...
        /// </summary>
        /// <value>昨日（接口调用当日的前一天）收藏引导文案曝光用户数，时间内未创建投放活动，则响应时不传出参数。单位：个。</value>
        ...
        /// </summary>
        /// <value>时间段内累计小程序收藏人数，时间内未创建投放活动，则响应时不传出参数。单位：个。</value>
        ...
        /// </summary>
        /// <value>时间段内累计小程序访问人数。当小程序日访问量为0，或以活动维度查询，或时间内未创建投放活动，则响应时不传出参数。单位：个。</value>
        ...
        /// </summary>
        /// <value>时间段内累计收藏引导文案收藏用户数，时间内未创建投放活动，则响应时不传出参数。单位：个。</value>
        ...
        /// </summary>
        /// <value>时间段内累计收藏引导文案曝光用户数，仅当小程序/活动投放活动时返回。时间内未创建投放活动，则响应时不传出参数。单位：个。</value>
