...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class ActivityLiteInfo : IEquatable<ActivityLiteInfo>, IValidatableObject
    {
        ...
        /// <param name="activityName">活动名称。 不对支付宝用户进行展示，仅供商家在后台管理活动使用。.</param>
        /// <param name="activityStatus">活动状态。.</param>
        /// <param name="belongMerchantId">归属商户 PID。.</param>
        ...
        /// </summary>
        /// <value>活动名称。 不对支付宝用户进行展示，仅供商家在后台管理活动使用。</value>
