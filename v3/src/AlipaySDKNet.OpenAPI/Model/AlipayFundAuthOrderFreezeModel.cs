...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayFundAuthOrderFreezeModel : IEquatable<AlipayFundAuthOrderFreezeModel>, IValidatableObject
    {
        ...
        public AlipayFundAuthOrderFreezeModel(string amount = default(string), string authCode = default(string), string authCodeType = default(string), string businessParams = default(string), string disablePayChannels = default(string), string enablePayChannels = default(string), string extraParam = default(string), string identityParams = default(string), string notifyUrl = default(string), string orderTitle = default(string), string outOrderNo = default(string), string outRequestNo = default(string), string payTimeout = default(string), string payeeLogonId = default(string), string payeeUserId = default(string), string productCode = default(string), string sceneCode = default(string), string settleCurrency = default(string), string terminalParams = default(string), string timeoutExpress = default(string), string transCurrency = default(string))
        {
            this.Amount = amount;
