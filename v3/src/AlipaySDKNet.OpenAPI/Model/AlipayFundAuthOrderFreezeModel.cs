...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayFundAuthOrderFreezeModel")]
    public partial class AlipayFundAuthOrderFreezeModel : IEquatable<AlipayFundAuthOrderFreezeModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayFundAuthOrderFreezeModel" /> class.
        /// </summary>
        /// <param name="amount">需要冻结的金额，单位为：元（人民币），精确到小数点后两位。 取值范围：[0.01,100000000.00].</param>
        /// <param name="authCode">用户付款码。 1.条码场景：25~30开头的长度为16~24位的数字，实际字符串长度以开发者获取的付款码长度为准； 2.刷脸场景： 1）fp开头的35位字符串； 2）300-700字符的随机字符串； 注：刷脸场景考虑到未来可能拓展更多格式，建议外围不必做规则拦截，由支付宝统一做有效性校验.</param>
        /// <param name="authCodeType">付款码类型。 1.条码场景：bar_code 2.刷脸场景：security_code.</param>
        /// <param name="businessParams">业务参数，如风控参数outRiskInfo等。.</param>
        /// <param name="depositProductMode">免押受理台模式，使用免押产品必传该字段。根据免押不同业务模式将开通受理台区分三种模式，商家可根据调用预授权冻结接口传入的参数决定该笔免押订单选择哪种受理台模式。不同受理台模式需要传入不同参数，其中：POSTPAY 表示后付金额已知，POSTPAY_UNCERTAIN 表示后付金额未知，DEPOSIT_ONLY 表示纯免押。 具体规则参考文档：https://opendocs.alipay.com/b/08tf3t?pathHash&#x3D;d67d7545.</param>
        ...
        /// <param name="identityParams">用户实名信息参数，包含：姓名+身份证号的hash值、指定用户的uid。商户传入用户实名信息参数，支付宝会对比用户在支付宝端的实名信息。 姓名+身份证号hash值使用SHA256摘要方式与UTF8编码,返回十六进制的字符串。 identity_hash和alipay_user_id都是可选的，如果两个都传，则会先校验identity_hash，然后校验alipay_user_id。其中identity_hash的待加密字样如\&quot;张三4566498798498498498498\&quot;.</param>
        ...
        public AlipayFundAuthOrderFreezeModel(string amount = default(string), string authCode = default(string), string authCodeType = default(string), string businessParams = default(string), string depositProductMode = default(string), string disablePayChannels = default(string), string enablePayChannels = default(string), string extraParam = default(string), string identityParams = default(string), string notifyUrl = default(string), string orderTitle = default(string), string outOrderNo = default(string), string outRequestNo = default(string), string payTimeout = default(string), string payeeLogonId = default(string), string payeeUserId = default(string), List<PostPayment> postPayments = default(List<PostPayment>), string productCode = default(string), string sceneCode = default(string), string settleCurrency = default(string), string terminalParams = default(string), string timeoutExpress = default(string), string transCurrency = default(string))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>用户付款码。 1.条码场景：25~30开头的长度为16~24位的数字，实际字符串长度以开发者获取的付款码长度为准； 2.刷脸场景： 1）fp开头的35位字符串； 2）300-700字符的随机字符串； 注：刷脸场景考虑到未来可能拓展更多格式，建议外围不必做规则拦截，由支付宝统一做有效性校验</value>
        ...
        /// </summary>
        /// <value>付款码类型。 1.条码场景：bar_code 2.刷脸场景：security_code</value>
        [DataMember(Name = "auth_code_type", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>免押受理台模式，使用免押产品必传该字段。根据免押不同业务模式将开通受理台区分三种模式，商家可根据调用预授权冻结接口传入的参数决定该笔免押订单选择哪种受理台模式。不同受理台模式需要传入不同参数，其中：POSTPAY 表示后付金额已知，POSTPAY_UNCERTAIN 表示后付金额未知，DEPOSIT_ONLY 表示纯免押。 具体规则参考文档：https://opendocs.alipay.com/b/08tf3t?pathHash&#x3D;d67d7545</value>
        ...
        /// </summary>
        /// <value>用户实名信息参数，包含：姓名+身份证号的hash值、指定用户的uid。商户传入用户实名信息参数，支付宝会对比用户在支付宝端的实名信息。 姓名+身份证号hash值使用SHA256摘要方式与UTF8编码,返回十六进制的字符串。 identity_hash和alipay_user_id都是可选的，如果两个都传，则会先校验identity_hash，然后校验alipay_user_id。其中identity_hash的待加密字样如\&quot;张三4566498798498498498498\&quot;</value>
        ...
        /// </summary>
        /// <value>场景码。 刷脸场景下传入HOTEL，其他情况下无需传入</value>
        ...
        /// </summary>
        /// <value>机具管控sdk加签参数，参数示例 \&quot;terminal_params\&quot;:\&quot;{\&quot;terminalType\&quot;:\&quot;IOT\&quot;,\&quot;signature\&quot;:\&quot;QIIAX8DqbFbNf2oe97FI1RSLAycC/tU4GVjer3bN8K4qLtAB\&quot;,\&quot;apdidToken\&quot;:\&quot;xPA3ptuArwYc3F6Va_pjVwv7Qx7Tg5TJdrA_Jb_moYte9AqGZgEAAA&#x3D;&#x3D;\&quot;,\&quot;hardToken\&quot;:\&quot;\&quot;,\&quot;time\&quot;:\&quot;1539847253\&quot;,\&quot;bizCode\&quot;:\&quot;11000200040004000121\&quot;,\&quot;bizTid\&quot;:\&quot;010100F01i1XyacMgpOinHerfdBw1xA9dNDocctlnqhLD8lfODr1A7Q\&quot;,\&quot;signedKeys\&quot;:\&quot;authCode,totalAmount,apdidToken,hardToken,time,bizCode,bizTid\&quot;}\&quot;</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AuthCodeType: ").Append(AuthCodeType).Append("\n");
        ...
        {
            return this.Equals(input as AlipayFundAuthOrderFreezeModel);
        }

        /// <summary>
        /// Returns true if AlipayFundAuthOrderFreezeModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayFundAuthOrderFreezeModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayFundAuthOrderFreezeModel input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AuthCodeType == input.AuthCodeType ||
                    (this.AuthCodeType != null &&
                    this.AuthCodeType.Equals(input.AuthCodeType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AuthCodeType != null)
                {
                    hashCode = (hashCode * 59) + this.AuthCodeType.GetHashCode();
                }
