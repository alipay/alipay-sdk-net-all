...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// WaybillInvoiceIstd
    /// </summary>
    [DataContract(Name = "WaybillInvoiceIstd")]
    public partial class WaybillInvoiceIstd : IEquatable<WaybillInvoiceIstd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WaybillInvoiceIstd" /> class.
        /// </summary>
        /// <param name="reason">失败原因，需要传单个配送单的驳回原因.</param>
        /// <param name="shopNo">商家门店编号.</param>
        /// <param name="waybillAmount">即时配送运单金额，waybill_invoce_status为1的情况下不能为空.</param>
        /// <param name="waybillInvoiceStatus">明细的运单开票状态，1：开票成功 2：不可开票 3：可开票；整体开票状态为0的情况下，无开票明细；整体开票状态为1，明细开票状态全部是1；整体开票状态为2，明细开票状态为2或者3.</param>
        /// <param name="waybillNo">即时配送运单编号.</param>
        public WaybillInvoiceIstd(string reason = default(string), string shopNo = default(string), string waybillAmount = default(string), int waybillInvoiceStatus = default(int), string waybillNo = default(string))
        {
            this.Reason = reason;
            this.ShopNo = shopNo;
        ...
        /// 失败原因，需要传单个配送单的驳回原因
        /// </summary>
        /// <value>失败原因，需要传单个配送单的驳回原因</value>
        ...
        /// </summary>
        /// <value>明细的运单开票状态，1：开票成功 2：不可开票 3：可开票；整体开票状态为0的情况下，无开票明细；整体开票状态为1，明细开票状态全部是1；整体开票状态为2，明细开票状态为2或者3</value>
        ...
        {
            return this.Equals(input as WaybillInvoiceIstd);
        }

        /// <summary>
        /// Returns true if WaybillInvoiceIstd instances are equal
        /// </summary>
        /// <param name="input">Instance of WaybillInvoiceIstd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WaybillInvoiceIstd input)
        {
            if (input == null)
            {
                return false;
