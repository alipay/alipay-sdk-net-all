...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ZhimaMerchantZmgoTemplateCreateModel")]
    public partial class ZhimaMerchantZmgoTemplateCreateModel : IEquatable<ZhimaMerchantZmgoTemplateCreateModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZhimaMerchantZmgoTemplateCreateModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ZhimaMerchantZmgoTemplateCreateModel);
        }

        /// <summary>
        /// Returns true if ZhimaMerchantZmgoTemplateCreateModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ZhimaMerchantZmgoTemplateCreateModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZhimaMerchantZmgoTemplateCreateModel input)
        {
            if (input == null)
            {
                return false;
