...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class AlipayEbppInvoiceIssueruleModifyModel : IEquatable<AlipayEbppInvoiceIssueruleModifyModel>, IValidatableObject
    {
        ...
        /// <param name="invalidMode">是否可累计（不传则不修改），枚举：0（不可累计）、1（可累计），2（累计天数），3（累计到固定时间）.</param>
        /// <param name="invalidModeValue">累计值.</param>
        /// <param name="issueAmountValue">发放金额（不传则不修改）.</param>
        ...
        /// </summary>
        /// <value>是否可累计（不传则不修改），枚举：0（不可累计）、1（可累计），2（累计天数），3（累计到固定时间）</value>
