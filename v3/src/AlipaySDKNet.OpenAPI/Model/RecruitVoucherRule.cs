...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    public partial class RecruitVoucherRule : IEquatable<RecruitVoucherRule>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="amountMax">券面额（每张代金券可以抵扣的金额）的的最大值。 币种为人民币，单位为元。小数点以后最多保留两位。 该字段为空时表示不限制。.</param>
        ...
        /// </summary>
        /// <value>券面额（每张代金券可以抵扣的金额）的的最大值。 币种为人民币，单位为元。小数点以后最多保留两位。 该字段为空时表示不限制。</value>
