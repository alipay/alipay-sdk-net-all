...
namespace AlipaySDKNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlipayOpenPublicMatchuserLabelDeleteResponseModel")]
    public partial class AlipayOpenPublicMatchuserLabelDeleteResponseModel : IEquatable<AlipayOpenPublicMatchuserLabelDeleteResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlipayOpenPublicMatchuserLabelDeleteResponseModel" /> class.
        /// </summary>
        /// <param name="errorCount">用户打标失败数量.</param>
        /// <param name="errorMatchers">出错的匹配器列表.</param>
        public AlipayOpenPublicMatchuserLabelDeleteResponseModel(int errorCount = default(int), List<ErrorMatcher> errorMatchers = default(List<ErrorMatcher>))
        {
        ...
        {
            return this.Equals(input as AlipayOpenPublicMatchuserLabelDeleteResponseModel);
        }

        /// <summary>
        /// Returns true if AlipayOpenPublicMatchuserLabelDeleteResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AlipayOpenPublicMatchuserLabelDeleteResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlipayOpenPublicMatchuserLabelDeleteResponseModel input)
        {
            if (input == null)
            {
                return false;
