...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicSinglearticleDataApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenPublicSinglearticleDataBatchqueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayOpenPublicSinglearticleDataBatchqueryResponseModel> BatchqueryAsync(AlipayOpenPublicSinglearticleDataBatchqueryModel alipayOpenPublicSinglearticleDataBatchqueryModel = default(AlipayOpenPublicSinglearticleDataBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenPublicSinglearticleDataBatchqueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayOpenPublicSinglearticleDataBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(AlipayOpenPublicSinglearticleDataBatchqueryModel alipayOpenPublicSinglearticleDataBatchqueryModel = default(AlipayOpenPublicSinglearticleDataBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicSinglearticleDataApi : IAlipayOpenPublicSinglearticleDataApiSync, IAlipayOpenPublicSinglearticleDataApiAsync
    {
    ...
    public partial class AlipayOpenPublicSinglearticleDataApi : IAlipayOpenPublicSinglearticleDataApi
    {
        ...
        public AlipayOpenPublicSinglearticleDataApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenPublicSinglearticleDataBatchqueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOpenPublicSinglearticleDataBatchqueryResponseModel> BatchqueryAsync(AlipayOpenPublicSinglearticleDataBatchqueryModel alipayOpenPublicSinglearticleDataBatchqueryModel = default(AlipayOpenPublicSinglearticleDataBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenPublicSinglearticleDataBatchqueryResponseModel> localVarResponse = await BatchqueryWithHttpInfoAsync(alipayOpenPublicSinglearticleDataBatchqueryModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenPublicSinglearticleDataBatchqueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenPublicSinglearticleDataBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(AlipayOpenPublicSinglearticleDataBatchqueryModel alipayOpenPublicSinglearticleDataBatchqueryModel = default(AlipayOpenPublicSinglearticleDataBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayOpenPublicSinglearticleDataBatchqueryResponseModel>("/v3/alipay/open/public/singlearticle/data/batchquery", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
