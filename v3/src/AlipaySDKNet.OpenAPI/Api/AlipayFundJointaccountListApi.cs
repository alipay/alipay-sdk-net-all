...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundJointaccountListApi : IAlipayFundJointaccountListApiSync
    {
    ...
    public partial class AlipayFundJointaccountListApi : IAlipayFundJointaccountListApi
    {
        ...
        public AlipayFundJointaccountListApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
