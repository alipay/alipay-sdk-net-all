...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicMessageCustomApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Object> SendAsync(AlipayOpenPublicMessageCustomSendModel alipayOpenPublicMessageCustomSendModel = default(AlipayOpenPublicMessageCustomSendModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> SendWithHttpInfoAsync(AlipayOpenPublicMessageCustomSendModel alipayOpenPublicMessageCustomSendModel = default(AlipayOpenPublicMessageCustomSendModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicMessageCustomApi : IAlipayOpenPublicMessageCustomApiSync, IAlipayOpenPublicMessageCustomApiAsync
    {
    ...
    public partial class AlipayOpenPublicMessageCustomApi : IAlipayOpenPublicMessageCustomApi
    {
        ...
        public AlipayOpenPublicMessageCustomApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> SendAsync(AlipayOpenPublicMessageCustomSendModel alipayOpenPublicMessageCustomSendModel = default(AlipayOpenPublicMessageCustomSendModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<Object> localVarResponse = await SendWithHttpInfoAsync(alipayOpenPublicMessageCustomSendModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<Object>> SendWithHttpInfoAsync(AlipayOpenPublicMessageCustomSendModel alipayOpenPublicMessageCustomSendModel = default(AlipayOpenPublicMessageCustomSendModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/v3/alipay/open/public/message/custom/send", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
