...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMarketingCampaignOrderVoucherApi : IAlipayMarketingCampaignOrderVoucherApiSync
    {
    ...
    public partial class AlipayMarketingCampaignOrderVoucherApi : IAlipayMarketingCampaignOrderVoucherApi
    {
        ...
        public AlipayMarketingCampaignOrderVoucherApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
