...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayIserviceCcmOlsChatrecordApi : IAlipayIserviceCcmOlsChatrecordApiSync
    {
    ...
    public partial class AlipayIserviceCcmOlsChatrecordApi : IAlipayIserviceCcmOlsChatrecordApi
    {
        ...
        public AlipayIserviceCcmOlsChatrecordApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
