...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceInstitutionPageinfoApi : IAlipayEbppInvoiceInstitutionPageinfoApiSync
    {
    ...
    public partial class AlipayEbppInvoiceInstitutionPageinfoApi : IAlipayEbppInvoiceInstitutionPageinfoApi
    {
        ...
        public AlipayEbppInvoiceInstitutionPageinfoApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
