...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceOrderApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceOrderQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEbppInvoiceOrderQueryResponseModel> QueryAsync(string orderNo = default(string), string mShortName = default(string), string subMShortName = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceOrderQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEbppInvoiceOrderQueryResponseModel>> QueryWithHttpInfoAsync(string orderNo = default(string), string mShortName = default(string), string subMShortName = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceOrderApi : IAlipayEbppInvoiceOrderApiSync, IAlipayEbppInvoiceOrderApiAsync
    {
    ...
    public partial class AlipayEbppInvoiceOrderApi : IAlipayEbppInvoiceOrderApi
    {
        ...
        public AlipayEbppInvoiceOrderApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceOrderQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEbppInvoiceOrderQueryResponseModel> QueryAsync(string orderNo = default(string), string mShortName = default(string), string subMShortName = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceOrderQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(orderNo, mShortName, subMShortName, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceOrderQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceOrderQueryResponseModel>> QueryWithHttpInfoAsync(string orderNo = default(string), string mShortName = default(string), string subMShortName = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayEbppInvoiceOrderQueryResponseModel>("/v3/alipay/ebpp/invoice/order/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
