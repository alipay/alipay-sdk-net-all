...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniIndividualBusinessApi : IAlipayOpenMiniIndividualBusinessApiSync
    {
    ...
    public partial class AlipayOpenMiniIndividualBusinessApi : IAlipayOpenMiniIndividualBusinessApi
    {
        ...
        public AlipayOpenMiniIndividualBusinessApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
