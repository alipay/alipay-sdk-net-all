...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipaySocialBaseContentlibStandardcontentApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel> BatchqueryAsync(AlipaySocialBaseContentlibStandardcontentBatchqueryModel alipaySocialBaseContentlibStandardcontentBatchqueryModel = default(AlipaySocialBaseContentlibStandardcontentBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(AlipaySocialBaseContentlibStandardcontentBatchqueryModel alipaySocialBaseContentlibStandardcontentBatchqueryModel = default(AlipaySocialBaseContentlibStandardcontentBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipaySocialBaseContentlibStandardcontentApi : IAlipaySocialBaseContentlibStandardcontentApiSync, IAlipaySocialBaseContentlibStandardcontentApiAsync
    {
    ...
    public partial class AlipaySocialBaseContentlibStandardcontentApi : IAlipaySocialBaseContentlibStandardcontentApi
    {
        ...
        public AlipaySocialBaseContentlibStandardcontentApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel> BatchqueryAsync(AlipaySocialBaseContentlibStandardcontentBatchqueryModel alipaySocialBaseContentlibStandardcontentBatchqueryModel = default(AlipaySocialBaseContentlibStandardcontentBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel> localVarResponse = await BatchqueryWithHttpInfoAsync(alipaySocialBaseContentlibStandardcontentBatchqueryModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(AlipaySocialBaseContentlibStandardcontentBatchqueryModel alipaySocialBaseContentlibStandardcontentBatchqueryModel = default(AlipaySocialBaseContentlibStandardcontentBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel>("/v3/alipay/social/base/contentlib/standardcontent/batchquery", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
