...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMerchantLiveChannelApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMerchantLiveChannelQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayMerchantLiveChannelQueryResponseModel> QueryAsync(string secret = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMerchantLiveChannelQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayMerchantLiveChannelQueryResponseModel>> QueryWithHttpInfoAsync(string secret = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMerchantLiveChannelApi : IAlipayMerchantLiveChannelApiSync, IAlipayMerchantLiveChannelApiAsync
    {
    ...
    public partial class AlipayMerchantLiveChannelApi : IAlipayMerchantLiveChannelApi
    {
        ...
        public AlipayMerchantLiveChannelApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMerchantLiveChannelQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayMerchantLiveChannelQueryResponseModel> QueryAsync(string secret = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMerchantLiveChannelQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(secret, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMerchantLiveChannelQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMerchantLiveChannelQueryResponseModel>> QueryWithHttpInfoAsync(string secret = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayMerchantLiveChannelQueryResponseModel>("/v3/alipay/merchant/live/channel/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
