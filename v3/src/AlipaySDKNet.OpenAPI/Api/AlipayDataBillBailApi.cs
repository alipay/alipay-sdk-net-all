...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayDataBillBailApiSync : IApiAccessor
    {
        ...
        /// <param name="bailType">保证金类型，目前支持TMALL_BAIL-天猫保证金，TAOBAO_BAIL-淘宝保证金 (optional)</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayDataBillBailApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayDataBillBailQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayDataBillBailQueryResponseModel> QueryAsync(string startTime = default(string), string endTime = default(string), string bailType = default(string), string transLogId = default(string), string bizOrigNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayDataBillBailQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayDataBillBailQueryResponseModel>> QueryWithHttpInfoAsync(string startTime = default(string), string endTime = default(string), string bailType = default(string), string transLogId = default(string), string bizOrigNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayDataBillBailApi : IAlipayDataBillBailApiSync, IAlipayDataBillBailApiAsync
    {
    ...
    public partial class AlipayDataBillBailApi : IAlipayDataBillBailApi
    {
        ...
        public AlipayDataBillBailApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayDataBillBailQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayDataBillBailQueryResponseModel> QueryAsync(string startTime = default(string), string endTime = default(string), string bailType = default(string), string transLogId = default(string), string bizOrigNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayDataBillBailQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(startTime, endTime, bailType, transLogId, bizOrigNo, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayDataBillBailQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayDataBillBailQueryResponseModel>> QueryWithHttpInfoAsync(string startTime = default(string), string endTime = default(string), string bailType = default(string), string transLogId = default(string), string bizOrigNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayDataBillBailQueryResponseModel>("/v3/alipay/data/bill/bail/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
