...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicMessageLabelApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Object> SendAsync(AlipayOpenPublicMessageLabelSendModel alipayOpenPublicMessageLabelSendModel = default(AlipayOpenPublicMessageLabelSendModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> SendWithHttpInfoAsync(AlipayOpenPublicMessageLabelSendModel alipayOpenPublicMessageLabelSendModel = default(AlipayOpenPublicMessageLabelSendModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicMessageLabelApi : IAlipayOpenPublicMessageLabelApiSync, IAlipayOpenPublicMessageLabelApiAsync
    {
    ...
    public partial class AlipayOpenPublicMessageLabelApi : IAlipayOpenPublicMessageLabelApi
    {
        ...
        public AlipayOpenPublicMessageLabelApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> SendAsync(AlipayOpenPublicMessageLabelSendModel alipayOpenPublicMessageLabelSendModel = default(AlipayOpenPublicMessageLabelSendModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<Object> localVarResponse = await SendWithHttpInfoAsync(alipayOpenPublicMessageLabelSendModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<Object>> SendWithHttpInfoAsync(AlipayOpenPublicMessageLabelSendModel alipayOpenPublicMessageLabelSendModel = default(AlipayOpenPublicMessageLabelSendModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/v3/alipay/open/public/message/label/send", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
