...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayCommerceEcEmployeeInfoApiSync : IApiAccessor
    {
        ...
        /// <param name="mobile">员工手机号码 (optional)</param>
        /// <param name="alipayLogonId">支付宝登录号（手机号或邮箱） (optional)</param>
        /// <param name="employeeCertType">员工证件类型 (optional)</param>
        /// <param name="employeeCertNo">员工证件号码 (optional)</param>
        /// <param name="employeeEmail">员工邮箱 (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>AlipayCommerceEcEmployeeInfoQueryResponseModel</returns>
        AlipayCommerceEcEmployeeInfoQueryResponseModel Query(string enterpriseId = default(string), string openId = default(string), string userId = default(string), string employeeId = default(string), string mobile = default(string), string alipayLogonId = default(string), string employeeCertType = default(string), string employeeCertNo = default(string), string employeeEmail = default(string), int operationIndex = 0, CustomizedParams customizedParams = null);
        ...
        ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> QueryWithHttpInfo(string enterpriseId = default(string), string openId = default(string), string userId = default(string), string employeeId = default(string), string mobile = default(string), string alipayLogonId = default(string), string employeeCertType = default(string), string employeeCertNo = default(string), string employeeEmail = default(string), int operationIndex = 0, CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayCommerceEcEmployeeInfoApi : IAlipayCommerceEcEmployeeInfoApiSync
    {
    ...
    public partial class AlipayCommerceEcEmployeeInfoApi : IAlipayCommerceEcEmployeeInfoApi
    {
        ...
        public AlipayCommerceEcEmployeeInfoApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>AlipayCommerceEcEmployeeInfoQueryResponseModel</returns>
        public AlipayCommerceEcEmployeeInfoQueryResponseModel Query(string enterpriseId = default(string), string openId = default(string), string userId = default(string), string employeeId = default(string), string mobile = default(string), string alipayLogonId = default(string), string employeeCertType = default(string), string employeeCertNo = default(string), string employeeEmail = default(string), int operationIndex = 0, CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> localVarResponse = QueryWithHttpInfo(enterpriseId, openId, userId, employeeId, mobile, alipayLogonId, employeeCertType, employeeCertNo, employeeEmail, operationIndex, customizedParams);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>ApiResponse of AlipayCommerceEcEmployeeInfoQueryResponseModel</returns>
        public AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> QueryWithHttpInfo(string enterpriseId = default(string), string openId = default(string), string userId = default(string), string employeeId = default(string), string mobile = default(string), string alipayLogonId = default(string), string employeeCertType = default(string), string employeeCertNo = default(string), string employeeEmail = default(string), int operationIndex = 0, CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.RequestOptions localVarRequestOptions = new AlipaySDKNet.OpenAPI.Client.RequestOptions();
            ...
            if (mobile != null)
            {
                localVarRequestOptions.QueryParameters.Add(AlipaySDKNet.OpenAPI.Client.ClientUtils.ParameterToMultiMap("", "mobile", mobile));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(AlipaySDKNet.OpenAPI.Client.ClientUtils.ParameterToMultiMap("", "employee_cert_type", employeeCertType));
            }
            if (employeeCertNo != null)
            {
                localVarRequestOptions.QueryParameters.Add(AlipaySDKNet.OpenAPI.Client.ClientUtils.ParameterToMultiMap("", "employee_cert_no", employeeCertNo));
            }
            if (employeeEmail != null)
            {
                localVarRequestOptions.QueryParameters.Add(AlipaySDKNet.OpenAPI.Client.ClientUtils.ParameterToMultiMap("", "employee_email", employeeEmail));
            }
