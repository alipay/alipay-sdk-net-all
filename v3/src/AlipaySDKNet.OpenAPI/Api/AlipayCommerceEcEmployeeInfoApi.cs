...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayCommerceEcEmployeeInfoApiSync : IApiAccessor
    {
        ...
        AlipayCommerceEcEmployeeInfoQueryResponseModel Query(string enterpriseId = default(string), string employeeId = default(string), string openId = default(string), string userId = default(string), string mobile = default(string), int operationIndex = 0, CustomizedParams customizedParams = null);
        ...
        ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> QueryWithHttpInfo(string enterpriseId = default(string), string employeeId = default(string), string openId = default(string), string userId = default(string), string mobile = default(string), int operationIndex = 0, CustomizedParams customizedParams = null);
    ...
    public partial class AlipayCommerceEcEmployeeInfoApi : IAlipayCommerceEcEmployeeInfoApi
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>AlipayCommerceEcEmployeeInfoQueryResponseModel</returns>
        public AlipayCommerceEcEmployeeInfoQueryResponseModel Query(string enterpriseId = default(string), string employeeId = default(string), string openId = default(string), string userId = default(string), string mobile = default(string), int operationIndex = 0, CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> localVarResponse = QueryWithHttpInfo(enterpriseId, employeeId, openId, userId, mobile, operationIndex, customizedParams);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>ApiResponse of AlipayCommerceEcEmployeeInfoQueryResponseModel</returns>
        public AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> QueryWithHttpInfo(string enterpriseId = default(string), string employeeId = default(string), string openId = default(string), string userId = default(string), string mobile = default(string), int operationIndex = 0, CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.RequestOptions localVarRequestOptions = new AlipaySDKNet.OpenAPI.Client.RequestOptions();
