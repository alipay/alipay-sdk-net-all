...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZhimaCustomerJobworthInfoApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaCustomerJobworthInfoQueryResponseModel</returns>
        System.Threading.Tasks.Task<ZhimaCustomerJobworthInfoQueryResponseModel> QueryAsync(string userName = default(string), string connKey = default(string), string certNo = default(string), string userId = default(string), string openId = default(string), string backUrl = default(string), string certType = default(string), string kaVisitorId = default(string), string visitorType = default(string), string visitorName = default(string), string companyCertificate = default(string), string visitorUrl = default(string), bool? hasButton = default(bool?), bool? hasNumber = default(bool?), bool? hasQrCode = default(bool?), bool? hasHtml = default(bool?), string jobId = default(string), string industryId = default(string), string cloudResumeScene = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaCustomerJobworthInfoQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<ZhimaCustomerJobworthInfoQueryResponseModel>> QueryWithHttpInfoAsync(string userName = default(string), string connKey = default(string), string certNo = default(string), string userId = default(string), string openId = default(string), string backUrl = default(string), string certType = default(string), string kaVisitorId = default(string), string visitorType = default(string), string visitorName = default(string), string companyCertificate = default(string), string visitorUrl = default(string), bool? hasButton = default(bool?), bool? hasNumber = default(bool?), bool? hasQrCode = default(bool?), bool? hasHtml = default(bool?), string jobId = default(string), string industryId = default(string), string cloudResumeScene = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZhimaCustomerJobworthInfoApi : IZhimaCustomerJobworthInfoApiSync, IZhimaCustomerJobworthInfoApiAsync
    {
    ...
    public partial class ZhimaCustomerJobworthInfoApi : IZhimaCustomerJobworthInfoApi
    {
        ...
        public ZhimaCustomerJobworthInfoApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaCustomerJobworthInfoQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<ZhimaCustomerJobworthInfoQueryResponseModel> QueryAsync(string userName = default(string), string connKey = default(string), string certNo = default(string), string userId = default(string), string openId = default(string), string backUrl = default(string), string certType = default(string), string kaVisitorId = default(string), string visitorType = default(string), string visitorName = default(string), string companyCertificate = default(string), string visitorUrl = default(string), bool? hasButton = default(bool?), bool? hasNumber = default(bool?), bool? hasQrCode = default(bool?), bool? hasHtml = default(bool?), string jobId = default(string), string industryId = default(string), string cloudResumeScene = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaCustomerJobworthInfoQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(userName, connKey, certNo, userId, openId, backUrl, certType, kaVisitorId, visitorType, visitorName, companyCertificate, visitorUrl, hasButton, hasNumber, hasQrCode, hasHtml, jobId, industryId, cloudResumeScene, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaCustomerJobworthInfoQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaCustomerJobworthInfoQueryResponseModel>> QueryWithHttpInfoAsync(string userName = default(string), string connKey = default(string), string certNo = default(string), string userId = default(string), string openId = default(string), string backUrl = default(string), string certType = default(string), string kaVisitorId = default(string), string visitorType = default(string), string visitorName = default(string), string companyCertificate = default(string), string visitorUrl = default(string), bool? hasButton = default(bool?), bool? hasNumber = default(bool?), bool? hasQrCode = default(bool?), bool? hasHtml = default(bool?), string jobId = default(string), string industryId = default(string), string cloudResumeScene = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ZhimaCustomerJobworthInfoQueryResponseModel>("/v3/zhima/customer/jobworth/info/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
