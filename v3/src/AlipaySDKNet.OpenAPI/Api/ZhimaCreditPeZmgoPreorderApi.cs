...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZhimaCreditPeZmgoPreorderApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaCreditPeZmgoPreorderCreateResponseModel</returns>
        System.Threading.Tasks.Task<ZhimaCreditPeZmgoPreorderCreateResponseModel> CreateAsync(ZhimaCreditPeZmgoPreorderCreateModel zhimaCreditPeZmgoPreorderCreateModel = default(ZhimaCreditPeZmgoPreorderCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaCreditPeZmgoPreorderCreateResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<ZhimaCreditPeZmgoPreorderCreateResponseModel>> CreateWithHttpInfoAsync(ZhimaCreditPeZmgoPreorderCreateModel zhimaCreditPeZmgoPreorderCreateModel = default(ZhimaCreditPeZmgoPreorderCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZhimaCreditPeZmgoPreorderApi : IZhimaCreditPeZmgoPreorderApiSync, IZhimaCreditPeZmgoPreorderApiAsync
    {
    ...
    public partial class ZhimaCreditPeZmgoPreorderApi : IZhimaCreditPeZmgoPreorderApi
    {
        ...
        public ZhimaCreditPeZmgoPreorderApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaCreditPeZmgoPreorderCreateResponseModel</returns>
        public async System.Threading.Tasks.Task<ZhimaCreditPeZmgoPreorderCreateResponseModel> CreateAsync(ZhimaCreditPeZmgoPreorderCreateModel zhimaCreditPeZmgoPreorderCreateModel = default(ZhimaCreditPeZmgoPreorderCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaCreditPeZmgoPreorderCreateResponseModel> localVarResponse = await CreateWithHttpInfoAsync(zhimaCreditPeZmgoPreorderCreateModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaCreditPeZmgoPreorderCreateResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaCreditPeZmgoPreorderCreateResponseModel>> CreateWithHttpInfoAsync(ZhimaCreditPeZmgoPreorderCreateModel zhimaCreditPeZmgoPreorderCreateModel = default(ZhimaCreditPeZmgoPreorderCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<ZhimaCreditPeZmgoPreorderCreateResponseModel>("/v3/zhima/credit/pe/zmgo/preorder/create", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
