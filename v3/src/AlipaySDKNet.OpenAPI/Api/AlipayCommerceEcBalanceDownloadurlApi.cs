...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayCommerceEcBalanceDownloadurlApiSync : IApiAccessor
    {
        ...
        /// <param name="accountId">共同账户ID，没有企业ID可以用此ID查询 (optional)</param>
        /// <param name="agreementNo">授权签约协议号，以共同账户ID查询时必传 (optional)</param>
        /// <param name="billType">账单类型，商户通过接口或商户经开放平台授权后其所属服务商通过接口可以获取以下账单类型，支持： enterprisetrade：商户基于企业码交易收单的业务账单; (optional)</param>
