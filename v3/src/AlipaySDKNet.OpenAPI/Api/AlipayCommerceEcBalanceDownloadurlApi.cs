...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayCommerceEcBalanceDownloadurlApi : IAlipayCommerceEcBalanceDownloadurlApiSync
    {
    ...
    public partial class AlipayCommerceEcBalanceDownloadurlApi : IAlipayCommerceEcBalanceDownloadurlApi
    {
        ...
        public AlipayCommerceEcBalanceDownloadurlApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
