...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayEbppInvoiceEnterpriseexctrlEmployertitleApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="AlipaySDKNet.OpenAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountId">共同账户id，与enterprise_id两者必填其一 (optional)</param>
        /// <param name="enterpriseId">企业id，与account_id两者必填其一 (optional)</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceEnterpriseexctrlEmployertitleApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel> BatchqueryAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel alipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel alipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        /// <summary>
        /// 新增企业抬头
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel> CreateAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel alipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel>> CreateWithHttpInfoAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel alipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        /// <summary>
        /// 修改企业抬头
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel> ModifyAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel alipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel>> ModifyWithHttpInfoAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel alipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        /// <summary>
        /// 查询企业抬头
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel> QueryAsync(string accountId = default(string), string enterpriseId = default(string), string agreementNo = default(string), string titleId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel>> QueryWithHttpInfoAsync(string accountId = default(string), string enterpriseId = default(string), string agreementNo = default(string), string titleId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceEnterpriseexctrlEmployertitleApi : IAlipayEbppInvoiceEnterpriseexctrlEmployertitleApiSync, IAlipayEbppInvoiceEnterpriseexctrlEmployertitleApiAsync
    {
    ...
    public partial class AlipayEbppInvoiceEnterpriseexctrlEmployertitleApi : IAlipayEbppInvoiceEnterpriseexctrlEmployertitleApi
    {
        ...
        public AlipayEbppInvoiceEnterpriseexctrlEmployertitleApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel> BatchqueryAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel alipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel> localVarResponse = await BatchqueryWithHttpInfoAsync(alipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel alipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayEbppInvoiceEnterpriseexctrlEmployertitleBatchqueryResponseModel>("/v3/alipay/ebpp/invoice/enterpriseexctrl/employertitle/batchquery", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel> CreateAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel alipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel> localVarResponse = await CreateWithHttpInfoAsync(alipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel>> CreateWithHttpInfoAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel alipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayEbppInvoiceEnterpriseexctrlEmployertitleCreateResponseModel>("/v3/alipay/ebpp/invoice/enterpriseexctrl/employertitle/create", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel> ModifyAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel alipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel> localVarResponse = await ModifyWithHttpInfoAsync(alipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel>> ModifyWithHttpInfoAsync(AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel alipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel = default(AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<AlipayEbppInvoiceEnterpriseexctrlEmployertitleModifyResponseModel>("/v3/alipay/ebpp/invoice/enterpriseexctrl/employertitle", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel> QueryAsync(string accountId = default(string), string enterpriseId = default(string), string agreementNo = default(string), string titleId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(accountId, enterpriseId, agreementNo, titleId, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel>> QueryWithHttpInfoAsync(string accountId = default(string), string enterpriseId = default(string), string agreementNo = default(string), string titleId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayEbppInvoiceEnterpriseexctrlEmployertitleQueryResponseModel>("/v3/alipay/ebpp/invoice/enterpriseexctrl/employertitle/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
