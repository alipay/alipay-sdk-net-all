...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceFileOutputApi : IAlipayEbppInvoiceFileOutputApiSync
    {
    ...
    public partial class AlipayEbppInvoiceFileOutputApi : IAlipayEbppInvoiceFileOutputApi
    {
        ...
        public AlipayEbppInvoiceFileOutputApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
