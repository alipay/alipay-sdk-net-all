...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayPcreditHuabeiAuthOrderApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayPcreditHuabeiAuthOrderQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayPcreditHuabeiAuthOrderQueryResponseModel> QueryAsync(string authOptId = default(string), string alipayUserId = default(string), string openId = default(string), string outRequestNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayPcreditHuabeiAuthOrderQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayPcreditHuabeiAuthOrderQueryResponseModel>> QueryWithHttpInfoAsync(string authOptId = default(string), string alipayUserId = default(string), string openId = default(string), string outRequestNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        /// <summary>
        /// 花呗先享解冻或解约接口
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel</returns>
        System.Threading.Tasks.Task<AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel> UnfreezeAsync(AlipayPcreditHuabeiAuthOrderUnfreezeModel alipayPcreditHuabeiAuthOrderUnfreezeModel = default(AlipayPcreditHuabeiAuthOrderUnfreezeModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel>> UnfreezeWithHttpInfoAsync(AlipayPcreditHuabeiAuthOrderUnfreezeModel alipayPcreditHuabeiAuthOrderUnfreezeModel = default(AlipayPcreditHuabeiAuthOrderUnfreezeModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayPcreditHuabeiAuthOrderApi : IAlipayPcreditHuabeiAuthOrderApiSync, IAlipayPcreditHuabeiAuthOrderApiAsync
    {
    ...
    public partial class AlipayPcreditHuabeiAuthOrderApi : IAlipayPcreditHuabeiAuthOrderApi
    {
        ...
        public AlipayPcreditHuabeiAuthOrderApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayPcreditHuabeiAuthOrderQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayPcreditHuabeiAuthOrderQueryResponseModel> QueryAsync(string authOptId = default(string), string alipayUserId = default(string), string openId = default(string), string outRequestNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayPcreditHuabeiAuthOrderQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(authOptId, alipayUserId, openId, outRequestNo, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayPcreditHuabeiAuthOrderQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayPcreditHuabeiAuthOrderQueryResponseModel>> QueryWithHttpInfoAsync(string authOptId = default(string), string alipayUserId = default(string), string openId = default(string), string outRequestNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayPcreditHuabeiAuthOrderQueryResponseModel>("/v3/alipay/pcredit/huabei/auth/order/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel> UnfreezeAsync(AlipayPcreditHuabeiAuthOrderUnfreezeModel alipayPcreditHuabeiAuthOrderUnfreezeModel = default(AlipayPcreditHuabeiAuthOrderUnfreezeModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel> localVarResponse = await UnfreezeWithHttpInfoAsync(alipayPcreditHuabeiAuthOrderUnfreezeModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel>> UnfreezeWithHttpInfoAsync(AlipayPcreditHuabeiAuthOrderUnfreezeModel alipayPcreditHuabeiAuthOrderUnfreezeModel = default(AlipayPcreditHuabeiAuthOrderUnfreezeModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<AlipayPcreditHuabeiAuthOrderUnfreezeResponseModel>("/v3/alipay/pcredit/huabei/auth/order/unfreeze", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
