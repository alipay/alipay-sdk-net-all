...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMarketingCardActivateurlApi : IAlipayMarketingCardActivateurlApiSync
    {
    ...
    public partial class AlipayMarketingCardActivateurlApi : IAlipayMarketingCardActivateurlApi
    {
        ...
        public AlipayMarketingCardActivateurlApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
