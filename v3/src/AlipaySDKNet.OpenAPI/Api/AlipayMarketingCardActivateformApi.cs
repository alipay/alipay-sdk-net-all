...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayMarketingCardActivateformApiSync : IApiAccessor
    {
        ...
        /// <param name="bizType">开放表单信息查询业务类型 (optional)</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMarketingCardActivateformApi : IAlipayMarketingCardActivateformApiSync
    {
    ...
    public partial class AlipayMarketingCardActivateformApi : IAlipayMarketingCardActivateformApi
    {
        ...
        public AlipayMarketingCardActivateformApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
