...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayCommerceEcEmployeeInviteApiSync : IApiAccessor
    {
        ...
        /// <param name="withholdingSignStr">代扣签约串 (optional)</param>
    ...
    public interface IAlipayCommerceEcEmployeeInviteApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<AlipayCommerceEcEmployeeInviteQueryResponseModel>> QueryWithHttpInfoAsync(string enterpriseId = default(string), string employeeId = default(string), string pageContentCode = default(string), string withholdingSignStr = default(string), string createShareCode = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    public partial class AlipayCommerceEcEmployeeInviteApi : IAlipayCommerceEcEmployeeInviteApi
    {
        ...
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayCommerceEcEmployeeInviteQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(enterpriseId, employeeId, pageContentCode, withholdingSignStr, createShareCode, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
