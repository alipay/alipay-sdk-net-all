...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenSpIsvBillApi : IAlipayOpenSpIsvBillApiSync
    {
    ...
    public partial class AlipayOpenSpIsvBillApi : IAlipayOpenSpIsvBillApi
    {
        ...
        public AlipayOpenSpIsvBillApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
