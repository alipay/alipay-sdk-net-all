...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenAgentOrderApi : IAlipayOpenAgentOrderApiSync
    {
    ...
    public partial class AlipayOpenAgentOrderApi : IAlipayOpenAgentOrderApi
    {
        ...
        public AlipayOpenAgentOrderApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
