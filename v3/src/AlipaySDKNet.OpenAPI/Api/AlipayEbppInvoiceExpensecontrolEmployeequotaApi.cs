...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceExpensecontrolEmployeequotaApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel> CreateAsync(AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel = default(AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel>> CreateWithHttpInfoAsync(AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel = default(AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceExpensecontrolEmployeequotaApi : IAlipayEbppInvoiceExpensecontrolEmployeequotaApiSync, IAlipayEbppInvoiceExpensecontrolEmployeequotaApiAsync
    {
    ...
    public partial class AlipayEbppInvoiceExpensecontrolEmployeequotaApi : IAlipayEbppInvoiceExpensecontrolEmployeequotaApi
    {
        ...
        public AlipayEbppInvoiceExpensecontrolEmployeequotaApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel> CreateAsync(AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel = default(AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel> localVarResponse = await CreateWithHttpInfoAsync(alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel>> CreateWithHttpInfoAsync(AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel = default(AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel>("/v3/alipay/ebpp/invoice/expensecontrol/employeequota/create", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
