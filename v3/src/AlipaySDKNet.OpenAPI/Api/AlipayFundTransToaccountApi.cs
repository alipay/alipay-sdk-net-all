...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundTransToaccountApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundTransToaccountTransferResponseModel</returns>
        System.Threading.Tasks.Task<AlipayFundTransToaccountTransferResponseModel> TransferAsync(AlipayFundTransToaccountTransferModel alipayFundTransToaccountTransferModel = default(AlipayFundTransToaccountTransferModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundTransToaccountTransferResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayFundTransToaccountTransferResponseModel>> TransferWithHttpInfoAsync(AlipayFundTransToaccountTransferModel alipayFundTransToaccountTransferModel = default(AlipayFundTransToaccountTransferModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundTransToaccountApi : IAlipayFundTransToaccountApiSync, IAlipayFundTransToaccountApiAsync
    {
    ...
    public partial class AlipayFundTransToaccountApi : IAlipayFundTransToaccountApi
    {
        ...
        public AlipayFundTransToaccountApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundTransToaccountTransferResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayFundTransToaccountTransferResponseModel> TransferAsync(AlipayFundTransToaccountTransferModel alipayFundTransToaccountTransferModel = default(AlipayFundTransToaccountTransferModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundTransToaccountTransferResponseModel> localVarResponse = await TransferWithHttpInfoAsync(alipayFundTransToaccountTransferModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundTransToaccountTransferResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundTransToaccountTransferResponseModel>> TransferWithHttpInfoAsync(AlipayFundTransToaccountTransferModel alipayFundTransToaccountTransferModel = default(AlipayFundTransToaccountTransferModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayFundTransToaccountTransferResponseModel>("/v3/alipay/fund/trans/toaccount/transfer", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
