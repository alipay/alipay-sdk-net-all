...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOfflineMaterialImageApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOfflineMaterialImageUploadResponseModel</returns>
        System.Threading.Tasks.Task<AlipayOfflineMaterialImageUploadResponseModel> UploadAsync(AlipayOfflineMaterialImageUploadModel data = default(AlipayOfflineMaterialImageUploadModel), System.IO.Stream imageContent = default(System.IO.Stream), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOfflineMaterialImageUploadResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayOfflineMaterialImageUploadResponseModel>> UploadWithHttpInfoAsync(AlipayOfflineMaterialImageUploadModel data = default(AlipayOfflineMaterialImageUploadModel), System.IO.Stream imageContent = default(System.IO.Stream), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOfflineMaterialImageApi : IAlipayOfflineMaterialImageApiSync, IAlipayOfflineMaterialImageApiAsync
    {
    ...
    public partial class AlipayOfflineMaterialImageApi : IAlipayOfflineMaterialImageApi
    {
        ...
        public AlipayOfflineMaterialImageApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOfflineMaterialImageUploadResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOfflineMaterialImageUploadResponseModel> UploadAsync(AlipayOfflineMaterialImageUploadModel data = default(AlipayOfflineMaterialImageUploadModel), System.IO.Stream imageContent = default(System.IO.Stream), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOfflineMaterialImageUploadResponseModel> localVarResponse = await UploadWithHttpInfoAsync(data, imageContent, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOfflineMaterialImageUploadResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOfflineMaterialImageUploadResponseModel>> UploadWithHttpInfoAsync(AlipayOfflineMaterialImageUploadModel data = default(AlipayOfflineMaterialImageUploadModel), System.IO.Stream imageContent = default(System.IO.Stream), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayOfflineMaterialImageUploadResponseModel>("/v3/alipay/offline/material/image/upload", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
