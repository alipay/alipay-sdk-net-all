...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundAuthOrderAppApi : IAlipayFundAuthOrderAppApiSync
    {
    ...
    public partial class AlipayFundAuthOrderAppApi : IAlipayFundAuthOrderAppApi
    {
        ...
        public AlipayFundAuthOrderAppApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
