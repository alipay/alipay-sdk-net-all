...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayCommerceTransportParkingPaymentinfoApi : IAlipayCommerceTransportParkingPaymentinfoApiSync
    {
    ...
    public partial class AlipayCommerceTransportParkingPaymentinfoApi : IAlipayCommerceTransportParkingPaymentinfoApi
    {
        ...
        public AlipayCommerceTransportParkingPaymentinfoApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
