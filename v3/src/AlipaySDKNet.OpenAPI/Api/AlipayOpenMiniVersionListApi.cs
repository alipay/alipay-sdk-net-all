...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniVersionListApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenMiniVersionListQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayOpenMiniVersionListQueryResponseModel> QueryAsync(string bundleId = default(string), string versionStatus = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenMiniVersionListQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayOpenMiniVersionListQueryResponseModel>> QueryWithHttpInfoAsync(string bundleId = default(string), string versionStatus = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniVersionListApi : IAlipayOpenMiniVersionListApiSync, IAlipayOpenMiniVersionListApiAsync
    {
    ...
    public partial class AlipayOpenMiniVersionListApi : IAlipayOpenMiniVersionListApi
    {
        ...
        public AlipayOpenMiniVersionListApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenMiniVersionListQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOpenMiniVersionListQueryResponseModel> QueryAsync(string bundleId = default(string), string versionStatus = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenMiniVersionListQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(bundleId, versionStatus, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenMiniVersionListQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenMiniVersionListQueryResponseModel>> QueryWithHttpInfoAsync(string bundleId = default(string), string versionStatus = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayOpenMiniVersionListQueryResponseModel>("/v3/alipay/open/mini/version/list/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
