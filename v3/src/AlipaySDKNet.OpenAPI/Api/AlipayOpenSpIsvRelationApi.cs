...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenSpIsvRelationApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenSpIsvRelationQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayOpenSpIsvRelationQueryResponseModel> QueryAsync(string commodityId = default(string), string pageSize = default(string), string pageNum = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenSpIsvRelationQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayOpenSpIsvRelationQueryResponseModel>> QueryWithHttpInfoAsync(string commodityId = default(string), string pageSize = default(string), string pageNum = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenSpIsvRelationApi : IAlipayOpenSpIsvRelationApiSync, IAlipayOpenSpIsvRelationApiAsync
    {
    ...
    public partial class AlipayOpenSpIsvRelationApi : IAlipayOpenSpIsvRelationApi
    {
        ...
        public AlipayOpenSpIsvRelationApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenSpIsvRelationQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOpenSpIsvRelationQueryResponseModel> QueryAsync(string commodityId = default(string), string pageSize = default(string), string pageNum = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenSpIsvRelationQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(commodityId, pageSize, pageNum, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenSpIsvRelationQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenSpIsvRelationQueryResponseModel>> QueryWithHttpInfoAsync(string commodityId = default(string), string pageSize = default(string), string pageNum = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayOpenSpIsvRelationQueryResponseModel>("/v3/alipay/open/sp/isv/relation/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
