...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayCommerceEcDepartmentInfoApi : IAlipayCommerceEcDepartmentInfoApiSync
    {
    ...
    public partial class AlipayCommerceEcDepartmentInfoApi : IAlipayCommerceEcDepartmentInfoApi
    {
        ...
        public AlipayCommerceEcDepartmentInfoApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
