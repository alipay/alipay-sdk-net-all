...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayOpenAppServiceSchemaApiSync : IApiAccessor
    {
        ...
        /// <param name="templateType">服务模版类型。若当前服务类目只有一个服务模版，可不填。 (optional)</param>
    ...
    public interface IAlipayOpenAppServiceSchemaApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AlipayOpenAppServiceSchemaQueryResponseModel> QueryAsync(string categoryId = default(string), string templateType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<AlipayOpenAppServiceSchemaQueryResponseModel>> QueryWithHttpInfoAsync(string categoryId = default(string), string templateType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    public partial class AlipayOpenAppServiceSchemaApi : IAlipayOpenAppServiceSchemaApi
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenAppServiceSchemaQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOpenAppServiceSchemaQueryResponseModel> QueryAsync(string categoryId = default(string), string templateType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenAppServiceSchemaQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(categoryId, templateType, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenAppServiceSchemaQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenAppServiceSchemaQueryResponseModel>> QueryWithHttpInfoAsync(string categoryId = default(string), string templateType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
