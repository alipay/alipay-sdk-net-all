...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayCommerceLogisticsOrderInstantdeliveryApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel</returns>
        System.Threading.Tasks.Task<AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel> CancelAsync(AlipayCommerceLogisticsOrderInstantdeliveryCancelModel alipayCommerceLogisticsOrderInstantdeliveryCancelModel = default(AlipayCommerceLogisticsOrderInstantdeliveryCancelModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel>> CancelWithHttpInfoAsync(AlipayCommerceLogisticsOrderInstantdeliveryCancelModel alipayCommerceLogisticsOrderInstantdeliveryCancelModel = default(AlipayCommerceLogisticsOrderInstantdeliveryCancelModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        /// <summary>
        /// 下即时配送订单
        /// </summary>
        /// <remarks>
    ...
    public partial class AlipayCommerceLogisticsOrderInstantdeliveryApi : IAlipayCommerceLogisticsOrderInstantdeliveryApi
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel> CancelAsync(AlipayCommerceLogisticsOrderInstantdeliveryCancelModel alipayCommerceLogisticsOrderInstantdeliveryCancelModel = default(AlipayCommerceLogisticsOrderInstantdeliveryCancelModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel> localVarResponse = await CancelWithHttpInfoAsync(alipayCommerceLogisticsOrderInstantdeliveryCancelModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel>> CancelWithHttpInfoAsync(AlipayCommerceLogisticsOrderInstantdeliveryCancelModel alipayCommerceLogisticsOrderInstantdeliveryCancelModel = default(AlipayCommerceLogisticsOrderInstantdeliveryCancelModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayCommerceLogisticsOrderInstantdeliveryCancelResponseModel>("/v3/alipay/commerce/logistics/order/instantdelivery/cancel", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
