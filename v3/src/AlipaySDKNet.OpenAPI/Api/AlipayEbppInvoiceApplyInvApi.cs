...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceApplyInvApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceApplyInvUploadResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEbppInvoiceApplyInvUploadResponseModel> UploadAsync(AlipayEbppInvoiceApplyInvUploadModel alipayEbppInvoiceApplyInvUploadModel = default(AlipayEbppInvoiceApplyInvUploadModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceApplyInvUploadResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEbppInvoiceApplyInvUploadResponseModel>> UploadWithHttpInfoAsync(AlipayEbppInvoiceApplyInvUploadModel alipayEbppInvoiceApplyInvUploadModel = default(AlipayEbppInvoiceApplyInvUploadModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceApplyInvApi : IAlipayEbppInvoiceApplyInvApiSync, IAlipayEbppInvoiceApplyInvApiAsync
    {
    ...
    public partial class AlipayEbppInvoiceApplyInvApi : IAlipayEbppInvoiceApplyInvApi
    {
        ...
        public AlipayEbppInvoiceApplyInvApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceApplyInvUploadResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEbppInvoiceApplyInvUploadResponseModel> UploadAsync(AlipayEbppInvoiceApplyInvUploadModel alipayEbppInvoiceApplyInvUploadModel = default(AlipayEbppInvoiceApplyInvUploadModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceApplyInvUploadResponseModel> localVarResponse = await UploadWithHttpInfoAsync(alipayEbppInvoiceApplyInvUploadModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceApplyInvUploadResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceApplyInvUploadResponseModel>> UploadWithHttpInfoAsync(AlipayEbppInvoiceApplyInvUploadModel alipayEbppInvoiceApplyInvUploadModel = default(AlipayEbppInvoiceApplyInvUploadModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<AlipayEbppInvoiceApplyInvUploadResponseModel>("/v3/alipay/ebpp/invoice/apply/inv/upload", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
