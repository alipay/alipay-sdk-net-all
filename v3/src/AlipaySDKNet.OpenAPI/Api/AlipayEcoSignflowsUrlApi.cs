...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEcoSignflowsUrlApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEcoSignflowsUrlQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEcoSignflowsUrlQueryResponseModel> QueryAsync(string targetAppId = default(string), string flowId = default(string), string thirdPartyUserId = default(string), string orgThirdPartyUserId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEcoSignflowsUrlQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEcoSignflowsUrlQueryResponseModel>> QueryWithHttpInfoAsync(string targetAppId = default(string), string flowId = default(string), string thirdPartyUserId = default(string), string orgThirdPartyUserId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEcoSignflowsUrlApi : IAlipayEcoSignflowsUrlApiSync, IAlipayEcoSignflowsUrlApiAsync
    {
    ...
    public partial class AlipayEcoSignflowsUrlApi : IAlipayEcoSignflowsUrlApi
    {
        ...
        public AlipayEcoSignflowsUrlApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEcoSignflowsUrlQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEcoSignflowsUrlQueryResponseModel> QueryAsync(string targetAppId = default(string), string flowId = default(string), string thirdPartyUserId = default(string), string orgThirdPartyUserId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEcoSignflowsUrlQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(targetAppId, flowId, thirdPartyUserId, orgThirdPartyUserId, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEcoSignflowsUrlQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEcoSignflowsUrlQueryResponseModel>> QueryWithHttpInfoAsync(string targetAppId = default(string), string flowId = default(string), string thirdPartyUserId = default(string), string orgThirdPartyUserId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayEcoSignflowsUrlQueryResponseModel>("/v3/alipay/eco/signflows/url/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
