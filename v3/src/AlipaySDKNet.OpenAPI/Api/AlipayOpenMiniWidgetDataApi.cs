...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniWidgetDataApi : IAlipayOpenMiniWidgetDataApiSync
    {
    ...
    public partial class AlipayOpenMiniWidgetDataApi : IAlipayOpenMiniWidgetDataApi
    {
        ...
        public AlipayOpenMiniWidgetDataApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
