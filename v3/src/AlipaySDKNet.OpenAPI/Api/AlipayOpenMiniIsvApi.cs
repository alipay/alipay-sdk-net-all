...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniIsvApi : IAlipayOpenMiniIsvApiSync
    {
    ...
    public partial class AlipayOpenMiniIsvApi : IAlipayOpenMiniIsvApi
    {
        ...
        public AlipayOpenMiniIsvApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
