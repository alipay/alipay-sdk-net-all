...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayTradeRefundApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayTradeRefundApplyResponseModel</returns>
        System.Threading.Tasks.Task<AlipayTradeRefundApplyResponseModel> ApplyAsync(AlipayTradeRefundApplyModel alipayTradeRefundApplyModel = default(AlipayTradeRefundApplyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayTradeRefundApplyResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayTradeRefundApplyResponseModel>> ApplyWithHttpInfoAsync(AlipayTradeRefundApplyModel alipayTradeRefundApplyModel = default(AlipayTradeRefundApplyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayTradeRefundApi : IAlipayTradeRefundApiSync, IAlipayTradeRefundApiAsync
    {
    ...
    public partial class AlipayTradeRefundApi : IAlipayTradeRefundApi
    {
        ...
        public AlipayTradeRefundApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayTradeRefundApplyResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayTradeRefundApplyResponseModel> ApplyAsync(AlipayTradeRefundApplyModel alipayTradeRefundApplyModel = default(AlipayTradeRefundApplyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayTradeRefundApplyResponseModel> localVarResponse = await ApplyWithHttpInfoAsync(alipayTradeRefundApplyModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayTradeRefundApplyResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayTradeRefundApplyResponseModel>> ApplyWithHttpInfoAsync(AlipayTradeRefundApplyModel alipayTradeRefundApplyModel = default(AlipayTradeRefundApplyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayTradeRefundApplyResponseModel>("/v3/alipay/trade/refund/apply", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
