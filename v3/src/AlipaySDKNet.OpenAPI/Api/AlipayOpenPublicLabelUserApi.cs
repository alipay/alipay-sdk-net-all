...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicLabelUserApi : IAlipayOpenPublicLabelUserApiSync
    {
    ...
    public partial class AlipayOpenPublicLabelUserApi : IAlipayOpenPublicLabelUserApi
    {
        ...
        public AlipayOpenPublicLabelUserApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
