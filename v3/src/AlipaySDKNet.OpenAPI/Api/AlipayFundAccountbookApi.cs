...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundAccountbookApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundAccountbookCreateResponseModel</returns>
        System.Threading.Tasks.Task<AlipayFundAccountbookCreateResponseModel> CreateAsync(AlipayFundAccountbookCreateModel alipayFundAccountbookCreateModel = default(AlipayFundAccountbookCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundAccountbookCreateResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayFundAccountbookCreateResponseModel>> CreateWithHttpInfoAsync(AlipayFundAccountbookCreateModel alipayFundAccountbookCreateModel = default(AlipayFundAccountbookCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        /// <summary>
        /// 资金记账本的信息查询
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundAccountbookQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayFundAccountbookQueryResponseModel> QueryAsync(string accountBookId = default(string), string merchantUserId = default(string), string sceneCode = default(string), string extInfo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundAccountbookQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayFundAccountbookQueryResponseModel>> QueryWithHttpInfoAsync(string accountBookId = default(string), string merchantUserId = default(string), string sceneCode = default(string), string extInfo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundAccountbookApi : IAlipayFundAccountbookApiSync, IAlipayFundAccountbookApiAsync
    {
    ...
    public partial class AlipayFundAccountbookApi : IAlipayFundAccountbookApi
    {
        ...
        public AlipayFundAccountbookApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundAccountbookCreateResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayFundAccountbookCreateResponseModel> CreateAsync(AlipayFundAccountbookCreateModel alipayFundAccountbookCreateModel = default(AlipayFundAccountbookCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundAccountbookCreateResponseModel> localVarResponse = await CreateWithHttpInfoAsync(alipayFundAccountbookCreateModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundAccountbookCreateResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundAccountbookCreateResponseModel>> CreateWithHttpInfoAsync(AlipayFundAccountbookCreateModel alipayFundAccountbookCreateModel = default(AlipayFundAccountbookCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayFundAccountbookCreateResponseModel>("/v3/alipay/fund/accountbook/create", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundAccountbookQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayFundAccountbookQueryResponseModel> QueryAsync(string accountBookId = default(string), string merchantUserId = default(string), string sceneCode = default(string), string extInfo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundAccountbookQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(accountBookId, merchantUserId, sceneCode, extInfo, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundAccountbookQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundAccountbookQueryResponseModel>> QueryWithHttpInfoAsync(string accountBookId = default(string), string merchantUserId = default(string), string sceneCode = default(string), string extInfo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayFundAccountbookQueryResponseModel>("/v3/alipay/fund/accountbook/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
