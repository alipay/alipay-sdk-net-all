...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniAppdeployBydeployversionApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenMiniAppdeployBydeployversionQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayOpenMiniAppdeployBydeployversionQueryResponseModel> QueryAsync(string bundleId = default(string), string miniAppId = default(string), string instCode = default(string), string deployVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenMiniAppdeployBydeployversionQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayOpenMiniAppdeployBydeployversionQueryResponseModel>> QueryWithHttpInfoAsync(string bundleId = default(string), string miniAppId = default(string), string instCode = default(string), string deployVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniAppdeployBydeployversionApi : IAlipayOpenMiniAppdeployBydeployversionApiSync, IAlipayOpenMiniAppdeployBydeployversionApiAsync
    {
    ...
    public partial class AlipayOpenMiniAppdeployBydeployversionApi : IAlipayOpenMiniAppdeployBydeployversionApi
    {
        ...
        public AlipayOpenMiniAppdeployBydeployversionApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenMiniAppdeployBydeployversionQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOpenMiniAppdeployBydeployversionQueryResponseModel> QueryAsync(string bundleId = default(string), string miniAppId = default(string), string instCode = default(string), string deployVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenMiniAppdeployBydeployversionQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(bundleId, miniAppId, instCode, deployVersion, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenMiniAppdeployBydeployversionQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenMiniAppdeployBydeployversionQueryResponseModel>> QueryWithHttpInfoAsync(string bundleId = default(string), string miniAppId = default(string), string instCode = default(string), string deployVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayOpenMiniAppdeployBydeployversionQueryResponseModel>("/v3/alipay/open/mini/appdeploy/bydeployversion/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
