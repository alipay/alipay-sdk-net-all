...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenAuthTokenAppApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenAuthTokenAppQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayOpenAuthTokenAppQueryResponseModel> QueryAsync(string appAuthToken = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenAuthTokenAppQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayOpenAuthTokenAppQueryResponseModel>> QueryWithHttpInfoAsync(string appAuthToken = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenAuthTokenAppApi : IAlipayOpenAuthTokenAppApiSync, IAlipayOpenAuthTokenAppApiAsync
    {
    ...
    public partial class AlipayOpenAuthTokenAppApi : IAlipayOpenAuthTokenAppApi
    {
        ...
        public AlipayOpenAuthTokenAppApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenAuthTokenAppQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOpenAuthTokenAppQueryResponseModel> QueryAsync(string appAuthToken = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenAuthTokenAppQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(appAuthToken, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenAuthTokenAppQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenAuthTokenAppQueryResponseModel>> QueryWithHttpInfoAsync(string appAuthToken = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayOpenAuthTokenAppQueryResponseModel>("/v3/alipay/open/auth/token/app/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
