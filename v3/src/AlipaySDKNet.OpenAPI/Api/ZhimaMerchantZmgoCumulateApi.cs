...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZhimaMerchantZmgoCumulateApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaMerchantZmgoCumulateQueryResponseModel</returns>
        System.Threading.Tasks.Task<ZhimaMerchantZmgoCumulateQueryResponseModel> QueryAsync(string agreementId = default(string), string userId = default(string), string openId = default(string), string providerPid = default(string), bool? needDetail = default(bool?), int? pageNo = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaMerchantZmgoCumulateQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<ZhimaMerchantZmgoCumulateQueryResponseModel>> QueryWithHttpInfoAsync(string agreementId = default(string), string userId = default(string), string openId = default(string), string providerPid = default(string), bool? needDetail = default(bool?), int? pageNo = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        /// <summary>
        /// 商家芝麻GO累计数据回传接口
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaMerchantZmgoCumulateSyncResponseModel</returns>
        System.Threading.Tasks.Task<ZhimaMerchantZmgoCumulateSyncResponseModel> SyncAsync(ZhimaMerchantZmgoCumulateSyncModel zhimaMerchantZmgoCumulateSyncModel = default(ZhimaMerchantZmgoCumulateSyncModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaMerchantZmgoCumulateSyncResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<ZhimaMerchantZmgoCumulateSyncResponseModel>> SyncWithHttpInfoAsync(ZhimaMerchantZmgoCumulateSyncModel zhimaMerchantZmgoCumulateSyncModel = default(ZhimaMerchantZmgoCumulateSyncModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZhimaMerchantZmgoCumulateApi : IZhimaMerchantZmgoCumulateApiSync, IZhimaMerchantZmgoCumulateApiAsync
    {
    ...
    public partial class ZhimaMerchantZmgoCumulateApi : IZhimaMerchantZmgoCumulateApi
    {
        ...
        public ZhimaMerchantZmgoCumulateApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaMerchantZmgoCumulateQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<ZhimaMerchantZmgoCumulateQueryResponseModel> QueryAsync(string agreementId = default(string), string userId = default(string), string openId = default(string), string providerPid = default(string), bool? needDetail = default(bool?), int? pageNo = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaMerchantZmgoCumulateQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(agreementId, userId, openId, providerPid, needDetail, pageNo, pageSize, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaMerchantZmgoCumulateQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaMerchantZmgoCumulateQueryResponseModel>> QueryWithHttpInfoAsync(string agreementId = default(string), string userId = default(string), string openId = default(string), string providerPid = default(string), bool? needDetail = default(bool?), int? pageNo = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ZhimaMerchantZmgoCumulateQueryResponseModel>("/v3/zhima/merchant/zmgo/cumulate/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaMerchantZmgoCumulateSyncResponseModel</returns>
        public async System.Threading.Tasks.Task<ZhimaMerchantZmgoCumulateSyncResponseModel> SyncAsync(ZhimaMerchantZmgoCumulateSyncModel zhimaMerchantZmgoCumulateSyncModel = default(ZhimaMerchantZmgoCumulateSyncModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaMerchantZmgoCumulateSyncResponseModel> localVarResponse = await SyncWithHttpInfoAsync(zhimaMerchantZmgoCumulateSyncModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaMerchantZmgoCumulateSyncResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaMerchantZmgoCumulateSyncResponseModel>> SyncWithHttpInfoAsync(ZhimaMerchantZmgoCumulateSyncModel zhimaMerchantZmgoCumulateSyncModel = default(ZhimaMerchantZmgoCumulateSyncModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ZhimaMerchantZmgoCumulateSyncResponseModel>("/v3/zhima/merchant/zmgo/cumulate/sync", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
