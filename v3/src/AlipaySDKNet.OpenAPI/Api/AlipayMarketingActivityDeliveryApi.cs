...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMarketingActivityDeliveryApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMarketingActivityDeliveryCreateResponseModel</returns>
        System.Threading.Tasks.Task<AlipayMarketingActivityDeliveryCreateResponseModel> CreateAsync(AlipayMarketingActivityDeliveryCreateModel alipayMarketingActivityDeliveryCreateModel = default(AlipayMarketingActivityDeliveryCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMarketingActivityDeliveryCreateResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayMarketingActivityDeliveryCreateResponseModel>> CreateWithHttpInfoAsync(AlipayMarketingActivityDeliveryCreateModel alipayMarketingActivityDeliveryCreateModel = default(AlipayMarketingActivityDeliveryCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        /// <summary>
        /// 查询推广计划
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMarketingActivityDeliveryQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayMarketingActivityDeliveryQueryResponseModel> QueryAsync(string deliveryId, AlipayMarketingActivityDeliveryQueryModel alipayMarketingActivityDeliveryQueryModel = default(AlipayMarketingActivityDeliveryQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMarketingActivityDeliveryQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayMarketingActivityDeliveryQueryResponseModel>> QueryWithHttpInfoAsync(string deliveryId, AlipayMarketingActivityDeliveryQueryModel alipayMarketingActivityDeliveryQueryModel = default(AlipayMarketingActivityDeliveryQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        /// <summary>
        /// 停止推广计划
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMarketingActivityDeliveryStopResponseModel</returns>
        System.Threading.Tasks.Task<AlipayMarketingActivityDeliveryStopResponseModel> StopAsync(string deliveryId, AlipayMarketingActivityDeliveryStopModel alipayMarketingActivityDeliveryStopModel = default(AlipayMarketingActivityDeliveryStopModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMarketingActivityDeliveryStopResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayMarketingActivityDeliveryStopResponseModel>> StopWithHttpInfoAsync(string deliveryId, AlipayMarketingActivityDeliveryStopModel alipayMarketingActivityDeliveryStopModel = default(AlipayMarketingActivityDeliveryStopModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMarketingActivityDeliveryApi : IAlipayMarketingActivityDeliveryApiSync, IAlipayMarketingActivityDeliveryApiAsync
    {
    ...
    public partial class AlipayMarketingActivityDeliveryApi : IAlipayMarketingActivityDeliveryApi
    {
        ...
        public AlipayMarketingActivityDeliveryApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// 创建推广计划 创建推广计划将内容推广到指定展位，用户可在指定展位领取推广内容。 不同展位支持的推广内容、推广规则、推广玩法、推广配置可能存在差异，使用时请仔细阅读接口说明文档。 创建推广成功后，请依据推广变更消息alipay.marketing.activity.delivery.message感知推广变更状态。
        /// </summary>
        /// <exception cref="AlipaySDKNet.OpenAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="alipayMarketingActivityDeliveryCreateModel"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMarketingActivityDeliveryCreateResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayMarketingActivityDeliveryCreateResponseModel> CreateAsync(AlipayMarketingActivityDeliveryCreateModel alipayMarketingActivityDeliveryCreateModel = default(AlipayMarketingActivityDeliveryCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMarketingActivityDeliveryCreateResponseModel> localVarResponse = await CreateWithHttpInfoAsync(alipayMarketingActivityDeliveryCreateModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMarketingActivityDeliveryCreateResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMarketingActivityDeliveryCreateResponseModel>> CreateWithHttpInfoAsync(AlipayMarketingActivityDeliveryCreateModel alipayMarketingActivityDeliveryCreateModel = default(AlipayMarketingActivityDeliveryCreateModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayMarketingActivityDeliveryCreateResponseModel>("/v3/alipay/marketing/delivery", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMarketingActivityDeliveryQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayMarketingActivityDeliveryQueryResponseModel> QueryAsync(string deliveryId, AlipayMarketingActivityDeliveryQueryModel alipayMarketingActivityDeliveryQueryModel = default(AlipayMarketingActivityDeliveryQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMarketingActivityDeliveryQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(deliveryId, alipayMarketingActivityDeliveryQueryModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMarketingActivityDeliveryQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMarketingActivityDeliveryQueryResponseModel>> QueryWithHttpInfoAsync(string deliveryId, AlipayMarketingActivityDeliveryQueryModel alipayMarketingActivityDeliveryQueryModel = default(AlipayMarketingActivityDeliveryQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            // verify the required parameter 'deliveryId' is set
            if (deliveryId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayMarketingActivityDeliveryQueryResponseModel>("/v3/alipay/marketing/delivery/{delivery_id}/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMarketingActivityDeliveryStopResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayMarketingActivityDeliveryStopResponseModel> StopAsync(string deliveryId, AlipayMarketingActivityDeliveryStopModel alipayMarketingActivityDeliveryStopModel = default(AlipayMarketingActivityDeliveryStopModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMarketingActivityDeliveryStopResponseModel> localVarResponse = await StopWithHttpInfoAsync(deliveryId, alipayMarketingActivityDeliveryStopModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMarketingActivityDeliveryStopResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMarketingActivityDeliveryStopResponseModel>> StopWithHttpInfoAsync(string deliveryId, AlipayMarketingActivityDeliveryStopModel alipayMarketingActivityDeliveryStopModel = default(AlipayMarketingActivityDeliveryStopModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            // verify the required parameter 'deliveryId' is set
            if (deliveryId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<AlipayMarketingActivityDeliveryStopResponseModel>("/v3/alipay/marketing/delivery/{delivery_id}/stop", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
