...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAntMerchantExpandIndirectImageApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AntMerchantExpandIndirectImageUploadResponseModel</returns>
        System.Threading.Tasks.Task<AntMerchantExpandIndirectImageUploadResponseModel> UploadAsync(AntMerchantExpandIndirectImageUploadModel data = default(AntMerchantExpandIndirectImageUploadModel), System.IO.Stream imageContent = default(System.IO.Stream), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AntMerchantExpandIndirectImageUploadResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AntMerchantExpandIndirectImageUploadResponseModel>> UploadWithHttpInfoAsync(AntMerchantExpandIndirectImageUploadModel data = default(AntMerchantExpandIndirectImageUploadModel), System.IO.Stream imageContent = default(System.IO.Stream), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAntMerchantExpandIndirectImageApi : IAntMerchantExpandIndirectImageApiSync, IAntMerchantExpandIndirectImageApiAsync
    {
    ...
    public partial class AntMerchantExpandIndirectImageApi : IAntMerchantExpandIndirectImageApi
    {
        ...
        public AntMerchantExpandIndirectImageApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AntMerchantExpandIndirectImageUploadResponseModel</returns>
        public async System.Threading.Tasks.Task<AntMerchantExpandIndirectImageUploadResponseModel> UploadAsync(AntMerchantExpandIndirectImageUploadModel data = default(AntMerchantExpandIndirectImageUploadModel), System.IO.Stream imageContent = default(System.IO.Stream), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AntMerchantExpandIndirectImageUploadResponseModel> localVarResponse = await UploadWithHttpInfoAsync(data, imageContent, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AntMerchantExpandIndirectImageUploadResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AntMerchantExpandIndirectImageUploadResponseModel>> UploadWithHttpInfoAsync(AntMerchantExpandIndirectImageUploadModel data = default(AntMerchantExpandIndirectImageUploadModel), System.IO.Stream imageContent = default(System.IO.Stream), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AntMerchantExpandIndirectImageUploadResponseModel>("/v3/ant/merchant/indirect/image", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
