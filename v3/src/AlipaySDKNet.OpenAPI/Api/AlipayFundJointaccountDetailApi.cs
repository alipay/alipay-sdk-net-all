...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundJointaccountDetailApi : IAlipayFundJointaccountDetailApiSync
    {
    ...
    public partial class AlipayFundJointaccountDetailApi : IAlipayFundJointaccountDetailApi
    {
        ...
        public AlipayFundJointaccountDetailApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
