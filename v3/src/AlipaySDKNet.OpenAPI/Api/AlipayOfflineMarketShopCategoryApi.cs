...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOfflineMarketShopCategoryApi : IAlipayOfflineMarketShopCategoryApiSync
    {
    ...
    public partial class AlipayOfflineMarketShopCategoryApi : IAlipayOfflineMarketShopCategoryApi
    {
        ...
        public AlipayOfflineMarketShopCategoryApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
