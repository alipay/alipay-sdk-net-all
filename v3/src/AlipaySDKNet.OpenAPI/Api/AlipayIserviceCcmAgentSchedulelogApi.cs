...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayIserviceCcmAgentSchedulelogApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayIserviceCcmAgentSchedulelogQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayIserviceCcmAgentSchedulelogQueryResponseModel> QueryAsync(AlipayIserviceCcmAgentSchedulelogQueryModel alipayIserviceCcmAgentSchedulelogQueryModel = default(AlipayIserviceCcmAgentSchedulelogQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayIserviceCcmAgentSchedulelogQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayIserviceCcmAgentSchedulelogQueryResponseModel>> QueryWithHttpInfoAsync(AlipayIserviceCcmAgentSchedulelogQueryModel alipayIserviceCcmAgentSchedulelogQueryModel = default(AlipayIserviceCcmAgentSchedulelogQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayIserviceCcmAgentSchedulelogApi : IAlipayIserviceCcmAgentSchedulelogApiSync, IAlipayIserviceCcmAgentSchedulelogApiAsync
    {
    ...
    public partial class AlipayIserviceCcmAgentSchedulelogApi : IAlipayIserviceCcmAgentSchedulelogApi
    {
        ...
        public AlipayIserviceCcmAgentSchedulelogApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayIserviceCcmAgentSchedulelogQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayIserviceCcmAgentSchedulelogQueryResponseModel> QueryAsync(AlipayIserviceCcmAgentSchedulelogQueryModel alipayIserviceCcmAgentSchedulelogQueryModel = default(AlipayIserviceCcmAgentSchedulelogQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayIserviceCcmAgentSchedulelogQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(alipayIserviceCcmAgentSchedulelogQueryModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayIserviceCcmAgentSchedulelogQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayIserviceCcmAgentSchedulelogQueryResponseModel>> QueryWithHttpInfoAsync(AlipayIserviceCcmAgentSchedulelogQueryModel alipayIserviceCcmAgentSchedulelogQueryModel = default(AlipayIserviceCcmAgentSchedulelogQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayIserviceCcmAgentSchedulelogQueryResponseModel>("/v3/alipay/iservice/ccm/agent/schedulelog/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
