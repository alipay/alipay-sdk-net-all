...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniInnerversionUploadstatusApi : IAlipayOpenMiniInnerversionUploadstatusApiSync
    {
    ...
    public partial class AlipayOpenMiniInnerversionUploadstatusApi : IAlipayOpenMiniInnerversionUploadstatusApi
    {
        ...
        public AlipayOpenMiniInnerversionUploadstatusApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
