...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceMerchantEnterstatusApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel> QueryAsync(string mShortName = default(string), string productCode = default(string), string processId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel>> QueryWithHttpInfoAsync(string mShortName = default(string), string productCode = default(string), string processId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceMerchantEnterstatusApi : IAlipayEbppInvoiceMerchantEnterstatusApiSync, IAlipayEbppInvoiceMerchantEnterstatusApiAsync
    {
    ...
    public partial class AlipayEbppInvoiceMerchantEnterstatusApi : IAlipayEbppInvoiceMerchantEnterstatusApi
    {
        ...
        public AlipayEbppInvoiceMerchantEnterstatusApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel> QueryAsync(string mShortName = default(string), string productCode = default(string), string processId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(mShortName, productCode, processId, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel>> QueryWithHttpInfoAsync(string mShortName = default(string), string productCode = default(string), string processId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayEbppInvoiceMerchantEnterstatusQueryResponseModel>("/v3/alipay/ebpp/invoice/merchant/enterstatus/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
