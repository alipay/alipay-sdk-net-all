...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IZhimaCustomerJobworthAuthenticationApiSync : IApiAccessor
    {
        ...
        /// <param name="identityType">01:医生，02:教师，具体参考文档 (optional)</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZhimaCustomerJobworthAuthenticationApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaCustomerJobworthAuthenticationQueryResponseModel</returns>
        System.Threading.Tasks.Task<ZhimaCustomerJobworthAuthenticationQueryResponseModel> QueryAsync(string connKey = default(string), string onceToken = default(string), string queryType = default(string), string identityType = default(string), string serviceId = default(string), string userId = default(string), string openId = default(string), string certNo = default(string), string certType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaCustomerJobworthAuthenticationQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<ZhimaCustomerJobworthAuthenticationQueryResponseModel>> QueryWithHttpInfoAsync(string connKey = default(string), string onceToken = default(string), string queryType = default(string), string identityType = default(string), string serviceId = default(string), string userId = default(string), string openId = default(string), string certNo = default(string), string certType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZhimaCustomerJobworthAuthenticationApi : IZhimaCustomerJobworthAuthenticationApiSync, IZhimaCustomerJobworthAuthenticationApiAsync
    {
    ...
    public partial class ZhimaCustomerJobworthAuthenticationApi : IZhimaCustomerJobworthAuthenticationApi
    {
        ...
        public ZhimaCustomerJobworthAuthenticationApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZhimaCustomerJobworthAuthenticationQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<ZhimaCustomerJobworthAuthenticationQueryResponseModel> QueryAsync(string connKey = default(string), string onceToken = default(string), string queryType = default(string), string identityType = default(string), string serviceId = default(string), string userId = default(string), string openId = default(string), string certNo = default(string), string certType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaCustomerJobworthAuthenticationQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(connKey, onceToken, queryType, identityType, serviceId, userId, openId, certNo, certType, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZhimaCustomerJobworthAuthenticationQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<ZhimaCustomerJobworthAuthenticationQueryResponseModel>> QueryWithHttpInfoAsync(string connKey = default(string), string onceToken = default(string), string queryType = default(string), string identityType = default(string), string serviceId = default(string), string userId = default(string), string openId = default(string), string certNo = default(string), string certType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ZhimaCustomerJobworthAuthenticationQueryResponseModel>("/v3/zhima/customer/jobworth/authentication", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
