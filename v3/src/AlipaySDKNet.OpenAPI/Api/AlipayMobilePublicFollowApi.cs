...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMobilePublicFollowApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMobilePublicFollowListResponseModel</returns>
        System.Threading.Tasks.Task<AlipayMobilePublicFollowListResponseModel> ListAsync(string bizContent = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMobilePublicFollowListResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayMobilePublicFollowListResponseModel>> ListWithHttpInfoAsync(string bizContent = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMobilePublicFollowApi : IAlipayMobilePublicFollowApiSync, IAlipayMobilePublicFollowApiAsync
    {
    ...
    public partial class AlipayMobilePublicFollowApi : IAlipayMobilePublicFollowApi
    {
        ...
        public AlipayMobilePublicFollowApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMobilePublicFollowListResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayMobilePublicFollowListResponseModel> ListAsync(string bizContent = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMobilePublicFollowListResponseModel> localVarResponse = await ListWithHttpInfoAsync(bizContent, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMobilePublicFollowListResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMobilePublicFollowListResponseModel>> ListWithHttpInfoAsync(string bizContent = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayMobilePublicFollowListResponseModel>("/v3/alipay/mobile/public/follow/list", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
