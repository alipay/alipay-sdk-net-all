...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundUsertradeApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundUsertradeBatchqueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayFundUsertradeBatchqueryResponseModel> BatchqueryAsync(string authToken = default(string), AlipayFundUsertradeBatchqueryModel alipayFundUsertradeBatchqueryModel = default(AlipayFundUsertradeBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundUsertradeBatchqueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayFundUsertradeBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(string authToken = default(string), AlipayFundUsertradeBatchqueryModel alipayFundUsertradeBatchqueryModel = default(AlipayFundUsertradeBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundUsertradeApi : IAlipayFundUsertradeApiSync, IAlipayFundUsertradeApiAsync
    {
    ...
    public partial class AlipayFundUsertradeApi : IAlipayFundUsertradeApi
    {
        ...
        public AlipayFundUsertradeApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundUsertradeBatchqueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayFundUsertradeBatchqueryResponseModel> BatchqueryAsync(string authToken = default(string), AlipayFundUsertradeBatchqueryModel alipayFundUsertradeBatchqueryModel = default(AlipayFundUsertradeBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundUsertradeBatchqueryResponseModel> localVarResponse = await BatchqueryWithHttpInfoAsync(authToken, alipayFundUsertradeBatchqueryModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundUsertradeBatchqueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundUsertradeBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(string authToken = default(string), AlipayFundUsertradeBatchqueryModel alipayFundUsertradeBatchqueryModel = default(AlipayFundUsertradeBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayFundUsertradeBatchqueryResponseModel>("/v3/alipay/fund/usertrade/batchquery", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
