...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicPayeeBindApi : IAlipayOpenPublicPayeeBindApiSync
    {
    ...
    public partial class AlipayOpenPublicPayeeBindApi : IAlipayOpenPublicPayeeBindApi
    {
        ...
        public AlipayOpenPublicPayeeBindApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
