...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicFollowApi : IAlipayOpenPublicFollowApiSync
    {
    ...
    public partial class AlipayOpenPublicFollowApi : IAlipayOpenPublicFollowApi
    {
        ...
        public AlipayOpenPublicFollowApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
