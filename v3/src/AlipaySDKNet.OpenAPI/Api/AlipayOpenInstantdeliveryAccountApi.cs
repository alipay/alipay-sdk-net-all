...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenInstantdeliveryAccountApi : IAlipayOpenInstantdeliveryAccountApiSync
    {
    ...
    public partial class AlipayOpenInstantdeliveryAccountApi : IAlipayOpenInstantdeliveryAccountApi
    {
        ...
        public AlipayOpenInstantdeliveryAccountApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
