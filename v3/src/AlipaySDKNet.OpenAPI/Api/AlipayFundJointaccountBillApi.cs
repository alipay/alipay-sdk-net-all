...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundJointaccountBillApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundJointaccountBillQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayFundJointaccountBillQueryResponseModel> QueryAsync(string productCode = default(string), string bizScene = default(string), string accountId = default(string), string pageNum = default(string), string pageSize = default(string), string userId = default(string), string openId = default(string), string startDate = default(string), string endDate = default(string), string agreementNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundJointaccountBillQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayFundJointaccountBillQueryResponseModel>> QueryWithHttpInfoAsync(string productCode = default(string), string bizScene = default(string), string accountId = default(string), string pageNum = default(string), string pageSize = default(string), string userId = default(string), string openId = default(string), string startDate = default(string), string endDate = default(string), string agreementNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundJointaccountBillApi : IAlipayFundJointaccountBillApiSync, IAlipayFundJointaccountBillApiAsync
    {
    ...
    public partial class AlipayFundJointaccountBillApi : IAlipayFundJointaccountBillApi
    {
        ...
        public AlipayFundJointaccountBillApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundJointaccountBillQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayFundJointaccountBillQueryResponseModel> QueryAsync(string productCode = default(string), string bizScene = default(string), string accountId = default(string), string pageNum = default(string), string pageSize = default(string), string userId = default(string), string openId = default(string), string startDate = default(string), string endDate = default(string), string agreementNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundJointaccountBillQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(productCode, bizScene, accountId, pageNum, pageSize, userId, openId, startDate, endDate, agreementNo, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundJointaccountBillQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundJointaccountBillQueryResponseModel>> QueryWithHttpInfoAsync(string productCode = default(string), string bizScene = default(string), string accountId = default(string), string pageNum = default(string), string pageSize = default(string), string userId = default(string), string openId = default(string), string startDate = default(string), string endDate = default(string), string agreementNo = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayFundJointaccountBillQueryResponseModel>("/v3/alipay/fund/jointaccount/bill/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
