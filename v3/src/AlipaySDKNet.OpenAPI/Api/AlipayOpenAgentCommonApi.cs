...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public partial class AlipayOpenAgentCommonApi : IAlipayOpenAgentCommonApi
    {
        ...
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<Object> localVarResponse = await SignWithHttpInfoAsync(appAuthPic, appDemo, appHomeScreenshot, appItemScreenshot, appPayScreenshot, businessLicenseAuthPic, businessLicensePic, data, h5ExtraPic, h5HomeScreenshot, h5ItemScreenshot, h5PayScreenshot, h5SitesLoa, miniAppScreenshot, shopScenePic, shopSignBoardPic, specialLicensePic, webHomeScreenshot, webItemScreenshot, webPayScreenshot, webSitesLoa, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
