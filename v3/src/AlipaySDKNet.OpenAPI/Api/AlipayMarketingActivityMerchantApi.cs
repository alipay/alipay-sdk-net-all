...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMarketingActivityMerchantApi : IAlipayMarketingActivityMerchantApiSync
    {
    ...
    public partial class AlipayMarketingActivityMerchantApi : IAlipayMarketingActivityMerchantApi
    {
        ...
        public AlipayMarketingActivityMerchantApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
