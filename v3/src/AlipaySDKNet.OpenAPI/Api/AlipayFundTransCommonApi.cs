...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundTransCommonApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundTransCommonQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayFundTransCommonQueryResponseModel> QueryAsync(string productCode = default(string), string bizScene = default(string), string outBizNo = default(string), string orderId = default(string), string payFundOrderId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundTransCommonQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayFundTransCommonQueryResponseModel>> QueryWithHttpInfoAsync(string productCode = default(string), string bizScene = default(string), string outBizNo = default(string), string orderId = default(string), string payFundOrderId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayFundTransCommonApi : IAlipayFundTransCommonApiSync, IAlipayFundTransCommonApiAsync
    {
    ...
    public partial class AlipayFundTransCommonApi : IAlipayFundTransCommonApi
    {
        ...
        public AlipayFundTransCommonApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayFundTransCommonQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayFundTransCommonQueryResponseModel> QueryAsync(string productCode = default(string), string bizScene = default(string), string outBizNo = default(string), string orderId = default(string), string payFundOrderId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundTransCommonQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(productCode, bizScene, outBizNo, orderId, payFundOrderId, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayFundTransCommonQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayFundTransCommonQueryResponseModel>> QueryWithHttpInfoAsync(string productCode = default(string), string bizScene = default(string), string outBizNo = default(string), string orderId = default(string), string payFundOrderId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayFundTransCommonQueryResponseModel>("/v3/alipay/fund/trans/common/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
