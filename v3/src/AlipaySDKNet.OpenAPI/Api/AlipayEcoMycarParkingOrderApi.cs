...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEcoMycarParkingOrderApi : IAlipayEcoMycarParkingOrderApiSync
    {
    ...
    public partial class AlipayEcoMycarParkingOrderApi : IAlipayEcoMycarParkingOrderApi
    {
        ...
        public AlipayEcoMycarParkingOrderApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
