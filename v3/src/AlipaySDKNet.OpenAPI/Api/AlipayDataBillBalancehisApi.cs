...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayDataBillBalancehisApi : IAlipayDataBillBalancehisApiSync
    {
    ...
    public partial class AlipayDataBillBalancehisApi : IAlipayDataBillBalancehisApi
    {
        ...
        public AlipayDataBillBalancehisApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
