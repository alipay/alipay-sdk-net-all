...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceExpensecomsueOutsourceApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel</returns>
        System.Threading.Tasks.Task<AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel> NotifyAsync(AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel alipayEbppInvoiceExpensecomsueOutsourceNotifyModel = default(AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel>> NotifyWithHttpInfoAsync(AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel alipayEbppInvoiceExpensecomsueOutsourceNotifyModel = default(AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceExpensecomsueOutsourceApi : IAlipayEbppInvoiceExpensecomsueOutsourceApiSync, IAlipayEbppInvoiceExpensecomsueOutsourceApiAsync
    {
    ...
    public partial class AlipayEbppInvoiceExpensecomsueOutsourceApi : IAlipayEbppInvoiceExpensecomsueOutsourceApi
    {
        ...
        public AlipayEbppInvoiceExpensecomsueOutsourceApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel> NotifyAsync(AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel alipayEbppInvoiceExpensecomsueOutsourceNotifyModel = default(AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel> localVarResponse = await NotifyWithHttpInfoAsync(alipayEbppInvoiceExpensecomsueOutsourceNotifyModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel>> NotifyWithHttpInfoAsync(AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel alipayEbppInvoiceExpensecomsueOutsourceNotifyModel = default(AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel>("/v3/alipay/ebpp/invoice/expensecomsue/outsource/notify", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
