...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZolozAuthenticationSmilepayApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZolozAuthenticationSmilepayInitializeResponseModel</returns>
        System.Threading.Tasks.Task<ZolozAuthenticationSmilepayInitializeResponseModel> InitializeAsync(ZolozAuthenticationSmilepayInitializeModel zolozAuthenticationSmilepayInitializeModel = default(ZolozAuthenticationSmilepayInitializeModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZolozAuthenticationSmilepayInitializeResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<ZolozAuthenticationSmilepayInitializeResponseModel>> InitializeWithHttpInfoAsync(ZolozAuthenticationSmilepayInitializeModel zolozAuthenticationSmilepayInitializeModel = default(ZolozAuthenticationSmilepayInitializeModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZolozAuthenticationSmilepayApi : IZolozAuthenticationSmilepayApiSync, IZolozAuthenticationSmilepayApiAsync
    {
    ...
    public partial class ZolozAuthenticationSmilepayApi : IZolozAuthenticationSmilepayApi
    {
        ...
        public ZolozAuthenticationSmilepayApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ZolozAuthenticationSmilepayInitializeResponseModel</returns>
        public async System.Threading.Tasks.Task<ZolozAuthenticationSmilepayInitializeResponseModel> InitializeAsync(ZolozAuthenticationSmilepayInitializeModel zolozAuthenticationSmilepayInitializeModel = default(ZolozAuthenticationSmilepayInitializeModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<ZolozAuthenticationSmilepayInitializeResponseModel> localVarResponse = await InitializeWithHttpInfoAsync(zolozAuthenticationSmilepayInitializeModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (ZolozAuthenticationSmilepayInitializeResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<ZolozAuthenticationSmilepayInitializeResponseModel>> InitializeWithHttpInfoAsync(ZolozAuthenticationSmilepayInitializeModel zolozAuthenticationSmilepayInitializeModel = default(ZolozAuthenticationSmilepayInitializeModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ZolozAuthenticationSmilepayInitializeResponseModel>("/v3/zoloz/authentication/smilepay/initialize", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
