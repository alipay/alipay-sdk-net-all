...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenPublicTemplateMessageApi : IAlipayOpenPublicTemplateMessageApiSync
    {
    ...
    public partial class AlipayOpenPublicTemplateMessageApi : IAlipayOpenPublicTemplateMessageApi
    {
        ...
        public AlipayOpenPublicTemplateMessageApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
