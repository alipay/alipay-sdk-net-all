...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IZhimaCreditPeZmgoAgreementApi : IZhimaCreditPeZmgoAgreementApiSync
    {
    ...
    public partial class ZhimaCreditPeZmgoAgreementApi : IZhimaCreditPeZmgoAgreementApi
    {
        ...
        public ZhimaCreditPeZmgoAgreementApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
