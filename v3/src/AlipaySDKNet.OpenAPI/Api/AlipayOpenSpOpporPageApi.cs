...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenSpOpporPageApi : IAlipayOpenSpOpporPageApiSync
    {
    ...
    public partial class AlipayOpenSpOpporPageApi : IAlipayOpenSpOpporPageApi
    {
        ...
        public AlipayOpenSpOpporPageApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
