...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMonitorHeartbeatApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of MonitorHeartbeatSynResponseModel</returns>
        System.Threading.Tasks.Task<MonitorHeartbeatSynResponseModel> SynAsync(MonitorHeartbeatSynModel monitorHeartbeatSynModel = default(MonitorHeartbeatSynModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (MonitorHeartbeatSynResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<MonitorHeartbeatSynResponseModel>> SynWithHttpInfoAsync(MonitorHeartbeatSynModel monitorHeartbeatSynModel = default(MonitorHeartbeatSynModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMonitorHeartbeatApi : IMonitorHeartbeatApiSync, IMonitorHeartbeatApiAsync
    {
    ...
    public partial class MonitorHeartbeatApi : IMonitorHeartbeatApi
    {
        ...
        public MonitorHeartbeatApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of MonitorHeartbeatSynResponseModel</returns>
        public async System.Threading.Tasks.Task<MonitorHeartbeatSynResponseModel> SynAsync(MonitorHeartbeatSynModel monitorHeartbeatSynModel = default(MonitorHeartbeatSynModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<MonitorHeartbeatSynResponseModel> localVarResponse = await SynWithHttpInfoAsync(monitorHeartbeatSynModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (MonitorHeartbeatSynResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<MonitorHeartbeatSynResponseModel>> SynWithHttpInfoAsync(MonitorHeartbeatSynModel monitorHeartbeatSynModel = default(MonitorHeartbeatSynModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<MonitorHeartbeatSynResponseModel>("/v3/monitor/heartbeat/syn", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
