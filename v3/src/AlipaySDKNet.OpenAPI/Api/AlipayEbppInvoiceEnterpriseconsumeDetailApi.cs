...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayEbppInvoiceEnterpriseconsumeDetailApi : IAlipayEbppInvoiceEnterpriseconsumeDetailApiSync
    {
    ...
    public partial class AlipayEbppInvoiceEnterpriseconsumeDetailApi : IAlipayEbppInvoiceEnterpriseconsumeDetailApi
    {
        ...
        public AlipayEbppInvoiceEnterpriseconsumeDetailApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
