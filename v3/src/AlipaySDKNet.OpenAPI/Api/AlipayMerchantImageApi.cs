...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMerchantImageApi : IAlipayMerchantImageApiSync
    {
    ...
    public partial class AlipayMerchantImageApi : IAlipayMerchantImageApi
    {
        ...
        public AlipayMerchantImageApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
