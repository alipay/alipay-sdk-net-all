...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniInnerversionModelforofflineApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenMiniInnerversionModelforofflineQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayOpenMiniInnerversionModelforofflineQueryResponseModel> QueryAsync(string miniAppId = default(string), string appVersion = default(string), string bundleId = default(string), string instCode = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenMiniInnerversionModelforofflineQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayOpenMiniInnerversionModelforofflineQueryResponseModel>> QueryWithHttpInfoAsync(string miniAppId = default(string), string appVersion = default(string), string bundleId = default(string), string instCode = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniInnerversionModelforofflineApi : IAlipayOpenMiniInnerversionModelforofflineApiSync, IAlipayOpenMiniInnerversionModelforofflineApiAsync
    {
    ...
    public partial class AlipayOpenMiniInnerversionModelforofflineApi : IAlipayOpenMiniInnerversionModelforofflineApi
    {
        ...
        public AlipayOpenMiniInnerversionModelforofflineApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenMiniInnerversionModelforofflineQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOpenMiniInnerversionModelforofflineQueryResponseModel> QueryAsync(string miniAppId = default(string), string appVersion = default(string), string bundleId = default(string), string instCode = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenMiniInnerversionModelforofflineQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(miniAppId, appVersion, bundleId, instCode, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenMiniInnerversionModelforofflineQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenMiniInnerversionModelforofflineQueryResponseModel>> QueryWithHttpInfoAsync(string miniAppId = default(string), string appVersion = default(string), string bundleId = default(string), string instCode = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayOpenMiniInnerversionModelforofflineQueryResponseModel>("/v3/alipay/open/mini/innerversion/modelforoffline/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
