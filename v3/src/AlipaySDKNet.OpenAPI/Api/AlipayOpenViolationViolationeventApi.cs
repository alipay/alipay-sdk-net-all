...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenViolationViolationeventApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenViolationViolationeventBatchqueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayOpenViolationViolationeventBatchqueryResponseModel> BatchqueryAsync(AlipayOpenViolationViolationeventBatchqueryModel alipayOpenViolationViolationeventBatchqueryModel = default(AlipayOpenViolationViolationeventBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenViolationViolationeventBatchqueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayOpenViolationViolationeventBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(AlipayOpenViolationViolationeventBatchqueryModel alipayOpenViolationViolationeventBatchqueryModel = default(AlipayOpenViolationViolationeventBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenViolationViolationeventApi : IAlipayOpenViolationViolationeventApiSync, IAlipayOpenViolationViolationeventApiAsync
    {
    ...
    public partial class AlipayOpenViolationViolationeventApi : IAlipayOpenViolationViolationeventApi
    {
        ...
        public AlipayOpenViolationViolationeventApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenViolationViolationeventBatchqueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOpenViolationViolationeventBatchqueryResponseModel> BatchqueryAsync(AlipayOpenViolationViolationeventBatchqueryModel alipayOpenViolationViolationeventBatchqueryModel = default(AlipayOpenViolationViolationeventBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenViolationViolationeventBatchqueryResponseModel> localVarResponse = await BatchqueryWithHttpInfoAsync(alipayOpenViolationViolationeventBatchqueryModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenViolationViolationeventBatchqueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenViolationViolationeventBatchqueryResponseModel>> BatchqueryWithHttpInfoAsync(AlipayOpenViolationViolationeventBatchqueryModel alipayOpenViolationViolationeventBatchqueryModel = default(AlipayOpenViolationViolationeventBatchqueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayOpenViolationViolationeventBatchqueryResponseModel>("/v3/alipay/open/violation/violationevent/batchquery", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
