...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenSpOperationResultApi : IAlipayOpenSpOperationResultApiSync
    {
    ...
    public partial class AlipayOpenSpOperationResultApi : IAlipayOpenSpOperationResultApi
    {
        ...
        public AlipayOpenSpOperationResultApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
