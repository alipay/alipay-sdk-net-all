...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    public interface IAlipayOpenMiniVersionBuildApiSync : IApiAccessor
    {
        ...
        /// <param name="bundleId">小程序投放的端参数，默认为支付宝端。支持：  com.alipay.alipaywallet：支付宝端。 com.alipay.iot.xpaas：IOT端。 例如：投放到支付宝钱包为支付宝端需传入 com.alipay.alipaywallet。 (optional)</param>
