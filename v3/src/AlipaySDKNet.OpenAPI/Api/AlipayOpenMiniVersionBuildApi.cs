...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniVersionBuildApi : IAlipayOpenMiniVersionBuildApiSync
    {
    ...
    public partial class AlipayOpenMiniVersionBuildApi : IAlipayOpenMiniVersionBuildApi
    {
        ...
        public AlipayOpenMiniVersionBuildApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
