...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniInnerbaseinfoApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenMiniInnerbaseinfoQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayOpenMiniInnerbaseinfoQueryResponseModel> QueryAsync(string miniAppId = default(string), string instCode = default(string), string miniAppName = default(string), string appSubType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenMiniInnerbaseinfoQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayOpenMiniInnerbaseinfoQueryResponseModel>> QueryWithHttpInfoAsync(string miniAppId = default(string), string instCode = default(string), string miniAppName = default(string), string appSubType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayOpenMiniInnerbaseinfoApi : IAlipayOpenMiniInnerbaseinfoApiSync, IAlipayOpenMiniInnerbaseinfoApiAsync
    {
    ...
    public partial class AlipayOpenMiniInnerbaseinfoApi : IAlipayOpenMiniInnerbaseinfoApi
    {
        ...
        public AlipayOpenMiniInnerbaseinfoApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayOpenMiniInnerbaseinfoQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayOpenMiniInnerbaseinfoQueryResponseModel> QueryAsync(string miniAppId = default(string), string instCode = default(string), string miniAppName = default(string), string appSubType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenMiniInnerbaseinfoQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(miniAppId, instCode, miniAppName, appSubType, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayOpenMiniInnerbaseinfoQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayOpenMiniInnerbaseinfoQueryResponseModel>> QueryWithHttpInfoAsync(string miniAppId = default(string), string instCode = default(string), string miniAppName = default(string), string appSubType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlipayOpenMiniInnerbaseinfoQueryResponseModel>("/v3/alipay/open/mini/innerbaseinfo/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
