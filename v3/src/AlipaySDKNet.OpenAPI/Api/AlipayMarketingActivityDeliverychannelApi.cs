...
namespace AlipaySDKNet.OpenAPI.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMarketingActivityDeliverychannelApiAsync : IApiAccessor
    {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMarketingActivityDeliverychannelQueryResponseModel</returns>
        System.Threading.Tasks.Task<AlipayMarketingActivityDeliverychannelQueryResponseModel> QueryAsync(AlipayMarketingActivityDeliverychannelQueryModel alipayMarketingActivityDeliverychannelQueryModel = default(AlipayMarketingActivityDeliverychannelQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMarketingActivityDeliverychannelQueryResponseModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlipayMarketingActivityDeliverychannelQueryResponseModel>> QueryWithHttpInfoAsync(AlipayMarketingActivityDeliverychannelQueryModel alipayMarketingActivityDeliverychannelQueryModel = default(AlipayMarketingActivityDeliverychannelQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlipayMarketingActivityDeliverychannelApi : IAlipayMarketingActivityDeliverychannelApiSync, IAlipayMarketingActivityDeliverychannelApiAsync
    {
    ...
    public partial class AlipayMarketingActivityDeliverychannelApi : IAlipayMarketingActivityDeliverychannelApi
    {
        ...
        public AlipayMarketingActivityDeliverychannelApi(AlipaySDKNet.OpenAPI.Client.ISynchronousClient client, AlipaySDKNet.OpenAPI.Client.IAsynchronousClient asyncClient, AlipaySDKNet.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of AlipayMarketingActivityDeliverychannelQueryResponseModel</returns>
        public async System.Threading.Tasks.Task<AlipayMarketingActivityDeliverychannelQueryResponseModel> QueryAsync(AlipayMarketingActivityDeliverychannelQueryModel alipayMarketingActivityDeliverychannelQueryModel = default(AlipayMarketingActivityDeliverychannelQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMarketingActivityDeliverychannelQueryResponseModel> localVarResponse = await QueryWithHttpInfoAsync(alipayMarketingActivityDeliverychannelQueryModel, operationIndex, cancellationToken, customizedParams).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customizedParams">customizedParams</param>
        /// <returns>Task of ApiResponse (AlipayMarketingActivityDeliverychannelQueryResponseModel)</returns>
        public async System.Threading.Tasks.Task<AlipaySDKNet.OpenAPI.Client.ApiResponse<AlipayMarketingActivityDeliverychannelQueryResponseModel>> QueryWithHttpInfoAsync(AlipayMarketingActivityDeliverychannelQueryModel alipayMarketingActivityDeliverychannelQueryModel = default(AlipayMarketingActivityDeliverychannelQueryModel), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), CustomizedParams customizedParams = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AlipayMarketingActivityDeliverychannelQueryResponseModel>("/v3/alipay/marketing/activity/deliverychannel/query", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
