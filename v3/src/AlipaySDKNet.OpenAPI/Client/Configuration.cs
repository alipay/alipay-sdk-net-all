...
namespace AlipaySDKNet.OpenAPI.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/3.0.16/csharp";
            BasePath = "https://openapi.alipay.com";
            DefaultHeaders = new ConcurrentDictionary<string, string>();
            DefaultHeaders.Add("alipay-sdk-version", "OpenAPI-Generator/3.0.16/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 2024-10-08\n";
            report += "    SDK Package Version: 3.0.16\n";
