...
namespace AlipaySDKNet.OpenAPI.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
        {
            ...
            {
                string traceId = response.Headers != null && response.Headers.TryGetValue("alipay-trace-id", out var list)
                    ? list[0] : null;
                return new ApiException(status,
                    string.Format("Error calling {0}: response code:{1}, response body:{2}, traceId:{3}, errorText:{4}", methodName, status, response.RawContent, traceId, response.ErrorText),
                    response.RawContent, response.Headers);
            }
            if (response.Content == null && !string.IsNullOrEmpty(response.ErrorText))
            {
                string traceId = response.Headers != null && response.Headers.TryGetValue("alipay-trace-id", out var list)
                    ? list[0] : null;
                return new ApiException(500,
                    string.Format("Error calling {0}: {1}, response body:{2}, traceId:{3}", methodName, response.ErrorText, response.RawContent, traceId),
                    response.ErrorText);
            }
            return null;
        };
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/3.0.20/csharp";
            BasePath = "https://openapi.alipay.com";
            DefaultHeaders = new ConcurrentDictionary<string, string>();
            DefaultHeaders.Add("alipay-sdk-version", "OpenAPI-Generator/3.0.20/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://openapi.alipay.com") : this()
        {
        ...
        {
            string report = "C# SDK (AlipaySDKNet.OpenAPI) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2024-11-12\n";
            report += "    SDK Package Version: 3.0.20\n";
