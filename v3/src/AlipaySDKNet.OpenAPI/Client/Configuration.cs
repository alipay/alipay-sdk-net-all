...
namespace AlipaySDKNet.OpenAPI.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/2.3.17/csharp";
            BasePath = "https://openapi.alipay.com";
            DefaultHeaders = new ConcurrentDictionary<string, string>();
            DefaultHeaders.Add("alipay-sdk-version", "OpenAPI-Generator/2.3.17/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 2023-10-25\n";
            report += "    SDK Package Version: 2.3.17\n";
