...
{
    /// <summary>
    /// AlipayCloudNextbuilderAgentChatGenerateResponse.
    /// </summary>
    public class AlipayCloudNextbuilderAgentChatGenerateResponse : AopResponse
    {
        /// <summary>
        /// 返回结果消息体内的具体内容
        /// </summary>
        [XmlElement("data")]
        public NbChatChunk Data { get; set; }
