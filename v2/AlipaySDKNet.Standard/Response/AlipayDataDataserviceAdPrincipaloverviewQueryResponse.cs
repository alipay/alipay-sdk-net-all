...
{
    /// <summary>
    /// AlipayDataDataserviceAdPrincipaloverviewQueryResponse.
    /// </summary>
    public class AlipayDataDataserviceAdPrincipaloverviewQueryResponse : AopResponse
    {
        /// <summary>
        /// 可用余额(元)
        /// </summary>
        ...
        /// 账户日预算(元)
        /// </summary>
        [XmlElement("format_daily_budget")]
        public string FormatDailyBudget { get; set; }
