...
{
    /// <summary>
    /// AlipayCommerceMerchantcardBookingshopQueryResponse.
    /// </summary>
    public class AlipayCommerceMerchantcardBookingshopQueryResponse : AopResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// 库存获取方式 ync     同步：服务商同步门店的排期，并在库存有变化时每次同步给安心付 query    查询：每次在预约时，安心付实时查询服务商的库存
        /// </summary>
