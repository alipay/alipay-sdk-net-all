...
{
    /// <summary>
    /// AnttechOceanbaseObglobalGetmonorecordingQueryResponse.
    /// </summary>
    public class AnttechOceanbaseObglobalGetmonorecordingQueryResponse : AopResponse
    {
        /// <summary>
        /// 业务错误码
        /// </summary>
        ...
        /// </summary>
        [XmlElement("result")]
        public MonoRecordDTO Result { get; set; }
    }
}
