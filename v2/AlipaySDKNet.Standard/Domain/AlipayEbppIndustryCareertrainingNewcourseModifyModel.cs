...
{
    /// <summary>
    /// AlipayEbppIndustryCareertrainingNewcourseModifyModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayEbppIndustryCareertrainingNewcourseModifyModel : AopObject
    {
        /// <summary>
        /// null
        /// </summary>
        ...
        [XmlArrayItem("syllabus_structured_modify_v_o")]
        public List<SyllabusStructuredModifyVO> SyllabusStructured { get; set; }
