...
{
    /// <summary>
    /// InsureRecomProductPlan Data Structure.
    /// </summary>
    [Serializable]
    public class InsureRecomProductPlan : AopObject
    {
        /// <summary>
        ...
        [XmlArrayItem("insure_prod_resource")]
        public List<InsureProdResource> ResourceList { get; set; }
