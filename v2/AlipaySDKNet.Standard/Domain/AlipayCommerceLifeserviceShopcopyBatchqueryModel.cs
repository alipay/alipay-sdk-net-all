...
{
    /// <summary>
    /// AlipayCommerceLifeserviceShopcopyBatchqueryModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCommerceLifeserviceShopcopyBatchqueryModel : AopObject
    {
        /// <summary>
        /// null
        /// </summary>
        ...
        /// null
        /// </summary>
        [XmlArray("copy_id_list")]
        [XmlArrayItem("string")]
        public List<string> CopyIdList { get; set; }
