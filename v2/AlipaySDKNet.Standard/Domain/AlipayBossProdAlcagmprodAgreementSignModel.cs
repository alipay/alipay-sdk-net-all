...
{
    /// <summary>
    /// AlipayBossProdAlcagmprodAgreementSignModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayBossProdAlcagmprodAgreementSignModel : AopObject
    {
        /// <summary>
        ...
        /// 场景描述
        /// </summary>
        [XmlElement("scenario_memo")]
        public string ScenarioMemo { get; set; }
