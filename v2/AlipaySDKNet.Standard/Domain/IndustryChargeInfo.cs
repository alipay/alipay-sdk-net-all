...
{
    /// <summary>
    /// IndustryChargeInfo Data Structure.
    /// </summary>
    [Serializable]
    public class IndustryChargeInfo : AopObject
    {
        /// <summary>
        /// 实收费用。单位：元。
        /// </summary>
        ...
        [XmlArrayItem("industry_sub_fee")]
        public List<IndustrySubFee> SubFeeDetailList { get; set; }
