...
{
    /// <summary>
    /// AlipayCommerceWithholdrepayorderTradeRefundModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCommerceWithholdrepayorderTradeRefundModel : AopObject
    {
        /// <summary>
        /// 退款包含的商品列表信息，Json格式。
        /// </summary>
        ...
        /// 退款包含的商品列表信息
        /// </summary>
        [XmlElement("refund_goods_detail")]
        public RefundGoodsDetail RefundGoodsDetail { get; set; }
        ...
        /// </summary>
        [XmlElement("refund_royalty_parameters")]
        public OpenApiRoyaltyDetailInfoPojo RefundRoyaltyParameters { get; set; }
