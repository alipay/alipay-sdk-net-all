...
{
    /// <summary>
    /// AlipayCommerceMedicalNosubscribeOrdermsgSendModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCommerceMedicalNosubscribeOrdermsgSendModel : AopObject
    {
        /// <summary>
        /// 支付宝openid
        /// </summary>
        ...
        /// </summary>
        [XmlElement("ext_info")]
        public MedicalNoSubscribeOrderMsgInfo ExtInfo { get; set; }
