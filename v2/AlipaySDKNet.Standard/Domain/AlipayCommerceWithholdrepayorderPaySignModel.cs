...
{
    /// <summary>
    /// AlipayCommerceWithholdrepayorderPaySignModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCommerceWithholdrepayorderPaySignModel : AopObject
    {
        /// <summary>
        /// 签约参数。如果希望在sdk中支付并签约，需要在这里传入签约信息。 周期扣款场景 product_code 为 CYCLE_PAY_AUTH 时必填。
        /// </summary>
        [XmlElement("agreement_sign_params")]
        public SignParam AgreementSignParams { get; set; }
        ...
        public OpenInvoiceInfo InvoiceInfo { get; set; }
