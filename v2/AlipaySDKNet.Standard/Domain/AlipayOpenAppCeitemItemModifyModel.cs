...
{
    /// <summary>
    /// AlipayOpenAppCeitemItemModifyModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayOpenAppCeitemItemModifyModel : AopObject
    {
        /// <summary>
        /// null
        /// </summary>
        [XmlArray("attrs")]
        [XmlArrayItem("ce_app_item_attr_v_o")]
        public List<CeAppItemAttrVO> Attrs { get; set; }
        ...
        public CeItemDescInfoModifyVO DescInfo { get; set; }
        ...
        /// </summary>
        [XmlArray("skus")]
        [XmlArrayItem("ce_item_sku_v_o")]
        public List<CeItemSkuVO> Skus { get; set; }
