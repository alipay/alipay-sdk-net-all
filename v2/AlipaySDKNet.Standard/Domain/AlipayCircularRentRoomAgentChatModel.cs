...
{
    /// <summary>
    /// AlipayCircularRentRoomAgentChatModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCircularRentRoomAgentChatModel : AopObject
    {
        /// <summary>
        /// null
        /// </summary>
        [XmlArray("biz_entity_ids")]
        [XmlArrayItem("biz_entity_id")]
        public List<BizEntityId> BizEntityIds { get; set; }
