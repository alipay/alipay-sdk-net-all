...
{
    /// <summary>
    /// AlipayEbppIndustryCareertrainingExamCreateModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayEbppIndustryCareertrainingExamCreateModel : AopObject
    {
        /// <summary>
        /// null
        /// </summary>
        ...
        /// <summary>
        /// 考试定价(最小值) 单位:分 maxPrice和minPrice都填写时, minPrice<=maxPrice
        /// </summary>
