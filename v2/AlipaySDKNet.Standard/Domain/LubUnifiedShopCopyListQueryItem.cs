...
{
    /// <summary>
    /// LubUnifiedShopCopyListQueryItem Data Structure.
    /// </summary>
    [Serializable]
    public class LubUnifiedShopCopyListQueryItem : AopObject
    {
        /// <summary>
        /// 品牌ID
        /// </summary>
        ...
        public LubBusinessCopyLicenseInfo BusinessLicenseInfo { get; set; }

        /// <summary>
        /// null
        /// </summary>
        [XmlArray("contact_ways")]
        [XmlArrayItem("lub_copy_contact_way_info")]
        public List<LubCopyContactWayInfo> ContactWays { get; set; }
        ...
        public LubLegalCopyPersonInfo LegalPersonInfo { get; set; }
        ...
        public LubStoreCopyAddressInfo StoreAddressInfo { get; set; }
