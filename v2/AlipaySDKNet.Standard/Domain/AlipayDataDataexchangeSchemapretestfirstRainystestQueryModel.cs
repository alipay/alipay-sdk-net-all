...
{
    /// <summary>
    /// AlipayDataDataexchangeSchemapretestfirstRainystestQueryModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayDataDataexchangeSchemapretestfirstRainystestQueryModel : AopObject
    {
        /// <summary>
        /// null
        /// </summary>
        ...
        /// </summary>
        [XmlArray("demo_date")]
        [XmlArrayItem("rainy_a_a_a")]
        public List<RainyAAA> DemoDate { get; set; }
