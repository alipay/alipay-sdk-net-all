...
{
    /// <summary>
    /// AlipayCloudCloudrunStaticsiteFilelistQueryModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCloudCloudrunStaticsiteFilelistQueryModel : AopObject
    {
        /// <summary>
        /// 内部使用，uiam角色扮演token
        /// </summary>
        ...
        /// </summary>
        [XmlElement("parent_directoy")]
        public string ParentDirectoy { get; set; }
