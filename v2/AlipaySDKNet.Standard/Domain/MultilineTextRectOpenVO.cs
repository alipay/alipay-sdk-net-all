...
{
    /// <summary>
    /// MultilineTextRectOpenVO Data Structure.
    /// </summary>
    [Serializable]
    public class MultilineTextRectOpenVO : AopObject
    {
        /// <summary>
        ...
        /// </summary>
        [XmlElement("rect_value")]
        public string RectValue { get; set; }
