...
{
    /// <summary>
    /// AlipayCommerceMedicalMedicineShopCreateModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCommerceMedicalMedicineShopCreateModel : AopObject
    {
        /// <summary>
        /// 门店所在位置的详细地址，需精确到门牌号
        /// </summary>
        ...
        /// <summary>
        /// 营销活动列表， 同一活动类型下，最多6个营销活动, 同一店铺下，同一活动类型下，多个营销活动时间段不重叠，多个时间段按当天的从早到晚顺序，不能重叠、不能跨天
        /// </summary>
