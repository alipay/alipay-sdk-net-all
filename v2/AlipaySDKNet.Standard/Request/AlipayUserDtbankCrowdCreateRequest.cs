...
{
    /// <summary>
    /// AOP API: alipay.user.dtbank.crowd.create
    /// </summary>
    public class AlipayUserDtbankCrowdCreateRequest : IAopUploadRequest<AlipayUserDtbankCrowdCreateResponse>
    {
        /// <summary>
        /// 人群名称
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("crowd_name", this.CrowdName);
