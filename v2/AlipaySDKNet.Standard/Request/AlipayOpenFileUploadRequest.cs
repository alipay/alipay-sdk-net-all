...
{
    /// <summary>
    /// AOP API: alipay.open.file.upload
    /// </summary>
    public class AlipayOpenFileUploadRequest : IAopUploadRequest<AlipayOpenFileUploadResponse>
    {
        /// <summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("extra_parameters", this.ExtraParameters);
            parameters.Add("md5", this.Md5);
            if(udfParams != null) 
            {
