...
{
    /// <summary>
    /// AOP API: anttech.blockchain.finance.fund.image.upload
    /// </summary>
    public class AnttechBlockchainFinanceFundImageUploadRequest : IAopUploadRequest<AnttechBlockchainFinanceFundImageUploadResponse>
    {
        /// <summary>
        /// 请求对应功能
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("function", this.Function);
            parameters.Add("image_type", this.ImageType);
            parameters.Add("request_id", this.RequestId);
            parameters.Add("sub_scene_code", this.SubSceneCode);
            if(udfParams != null) 
            {
