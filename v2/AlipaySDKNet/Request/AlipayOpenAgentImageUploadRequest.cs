...
{
    /// <summary>
    /// AOP API: alipay.open.agent.image.upload
    /// </summary>
    public class AlipayOpenAgentImageUploadRequest : IAopUploadRequest<AlipayOpenAgentImageUploadResponse>
    {
        /// <summary>
        /// 智能体图片，具体如下： ● 图片格式仅支持：jpg、jpeg、png
        /// </summary>
