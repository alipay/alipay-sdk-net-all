...
{
    /// <summary>
    /// AOP API: alipay.open.mini.cloud.file.upload
    /// </summary>
    public class AlipayOpenMiniCloudFileUploadRequest : IAopUploadRequest<AlipayOpenMiniCloudFileUploadResponse>
    {
        /// <summary>
        /// 云环境ID,在云托管平台获取
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("cloud_id", this.CloudId);
