...
{
    /// <summary>
    /// AOP API: alipay.commerce.housing.file.upload
    /// </summary>
    public class AlipayCommerceHousingFileUploadRequest : IAopUploadRequest<AlipayCommerceHousingFileUploadResponse>
    {
        /// <summary>
        /// 文件类别
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("attachment_category", this.AttachmentCategory);
