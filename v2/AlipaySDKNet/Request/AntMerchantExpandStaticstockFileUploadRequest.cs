...
{
    /// <summary>
    /// AOP API: ant.merchant.expand.staticstock.file.upload
    /// </summary>
    public class AntMerchantExpandStaticstockFileUploadRequest : IAopUploadRequest<AntMerchantExpandStaticstockFileUploadResponse>
    {
        /// <summary>
        /// 文件内容，以文件流形式进行传输
        /// </summary>
