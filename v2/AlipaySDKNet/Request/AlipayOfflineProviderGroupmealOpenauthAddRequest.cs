...
{
    /// <summary>
    /// AOP API: alipay.offline.provider.groupmeal.openauth.add
    /// </summary>
    public class AlipayOfflineProviderGroupmealOpenauthAddRequest : IAopRequest<AlipayOfflineProviderGroupmealOpenauthAddResponse>
    {
        /// <summary>
