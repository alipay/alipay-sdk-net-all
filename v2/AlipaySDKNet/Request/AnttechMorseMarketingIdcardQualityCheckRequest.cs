...
{
    /// <summary>
    /// AOP API: anttech.morse.marketing.idcard.quality.check
    /// </summary>
    public class AnttechMorseMarketingIdcardQualityCheckRequest : IAopUploadRequest<AnttechMorseMarketingIdcardQualityCheckResponse>
    {
        /// <summary>
        /// 上传的文件流
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("quality_strategy", this.QualityStrategy);
