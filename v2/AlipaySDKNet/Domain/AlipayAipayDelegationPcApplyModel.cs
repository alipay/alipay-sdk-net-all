...
{
    /// <summary>
    /// AlipayAipayDelegationPcApplyModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayAipayDelegationPcApplyModel : AopObject
    {
        /// <summary>
        ...
        [XmlArrayItem("pc_conversation_history")]
        public List<PcConversationHistory> ConversationHistory { get; set; }

        /// <summary>
        /// AI付代买委托信息
        /// </summary>
        [XmlElement("delegation_params")]
        public PcDelegationParams DelegationParams { get; set; }

        /// <summary>
        /// 委托扩展信息
        /// </summary>
        [XmlElement("ext_info")]
        public DelegationExtInfo ExtInfo { get; set; }
