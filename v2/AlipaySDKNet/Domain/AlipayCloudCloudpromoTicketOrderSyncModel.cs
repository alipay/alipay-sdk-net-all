...
{
    /// <summary>
    /// AlipayCloudCloudpromoTicketOrderSyncModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCloudCloudpromoTicketOrderSyncModel : AopObject
    {
        /// <summary>
        /// 实付金额,单位元
        /// </summary>
        ...
        [XmlArrayItem("ticket_order_detail_info")]
        public List<TicketOrderDetailInfo> OrderDetails { get; set; }
