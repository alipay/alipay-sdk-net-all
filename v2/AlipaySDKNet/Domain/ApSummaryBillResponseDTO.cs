...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class ApSummaryBillResponseDTO : AopObject
    {
        /// <summary>
        /// 调账金额
        /// </summary>
        ...
        /// 出账周期
        /// </summary>
        [XmlElement("charge_off_period")]
        public string ChargeOffPeriod { get; set; }

        /// <summary>
        /// 出账周期类型
        /// </summary>
        [XmlElement("charge_off_period_type")]
        public string ChargeOffPeriodType { get; set; }

        /// <summary>
        /// 出账周期类型name
        /// </summary>
        [XmlElement("charge_off_period_type_name")]
        ...
        /// 关联发票状态
        /// </summary>
        [XmlElement("invoice_status_desc")]
        ...
        /// 收款方账号扩展信息
        /// </summary>
        [XmlElement("payee_account_ext_info")]
        ...
        /// 收款对象pid来源
        /// </summary>
        [XmlElement("payee_ip_role_id_source")]
        public string PayeeIpRoleIdSource { get; set; }

        /// <summary>
        /// 付款方账号扩展信息
        /// </summary>
        [XmlElement("payer_account_ext_info")]
        ...
        /// 付款对象pid来源
        /// </summary>
        [XmlElement("payer_ip_role_id_source")]
        ...
        /// 对账状态
        /// </summary>
        [XmlElement("reconciliation_status")]
        public string ReconciliationStatus { get; set; }

        /// <summary>
        /// 对账状态
        /// </summary>
        [XmlElement("reconciliation_status_name")]
        ...
        /// 结算业务类型name
        /// </summary>
        [XmlElement("settle_biz_type_name")]
        ...
        /// 结算对象pid来源
        /// </summary>
        [XmlElement("settle_ip_role_id_source")]
        public string SettleIpRoleIdSource { get; set; }

        /// <summary>
        /// 结算对象
        /// </summary>
        [XmlElement("settle_ip_role_name")]
        ...
        /// 结算对象mid来源
        /// </summary>
        [XmlElement("settle_merchant_id_source")]
        public string SettleMerchantIdSource { get; set; }

        /// <summary>
        /// 结算对象mid名称
        /// </summary>
        [XmlElement("settle_merchant_name")]
        ...
        /// 结算时点类型name
        /// </summary>
        [XmlElement("settle_time_type_name")]
        ...
        /// 签约对象pid来源
        /// </summary>
        [XmlElement("sign_ip_role_id_source")]
        public string SignIpRoleIdSource { get; set; }

        /// <summary>
        /// 签约对象mid
        /// </summary>
        [XmlElement("sign_merchant_id")]
        public string SignMerchantId { get; set; }

        /// <summary>
        /// 结算对象mid来源
        /// </summary>
        [XmlElement("sign_merchant_id_source")]
