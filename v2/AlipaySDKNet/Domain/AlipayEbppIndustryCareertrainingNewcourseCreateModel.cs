...
{
    /// <summary>
    /// AlipayEbppIndustryCareertrainingNewcourseCreateModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayEbppIndustryCareertrainingNewcourseCreateModel : AopObject
    {
        /// <summary>
        /// null
        /// </summary>
        ...
        [XmlArrayItem("class_info_v_o")]
        public List<ClassInfoVO> PlanRuleList { get; set; }
        ...
        [XmlArrayItem("syllabus_structured_create_v_o")]
        public List<SyllabusStructuredCreateVO> SyllabusStructured { get; set; }
