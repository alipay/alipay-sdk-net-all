...
{
    /// <summary>
    /// AlipayPcreditLoanHonorRepayApplyModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayPcreditLoanHonorRepayApplyModel : AopObject
    {
        /// <summary>
        /// 支付宝用户ID
        /// </summary>
        ...
        /// </summary>
        [XmlElement("budget_interest")]
        public string BudgetInterest { get; set; }

        /// <summary>
        /// 预算时返回的罚息（还款试算不传金额时返回的罚息）
        /// </summary>
        [XmlElement("budget_penalty")]
        public string BudgetPenalty { get; set; }

        /// <summary>
        /// 预算时返回的本金（还款试算不传金额时返回的本金）
        /// </summary>
        [XmlElement("budget_principal")]
        public string BudgetPrincipal { get; set; }
