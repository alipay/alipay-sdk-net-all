...
{
    /// <summary>
    /// EpSpuSpecificInfoResult Data Structure.
    /// </summary>
    [Serializable]
    public class EpSpuSpecificInfoResult : AopObject
    {
        /// <summary>
        /// 经营类型
        /// </summary>
        ...
        /// </summary>
        [XmlArray("spu_list")]
        [XmlArrayItem("ep_spu_specific_info")]
        public List<EpSpuSpecificInfo> SpuList { get; set; }
    }
}
