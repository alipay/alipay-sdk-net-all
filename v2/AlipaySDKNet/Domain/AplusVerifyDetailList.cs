...
{
    /// <summary>
    /// AplusVerifyDetailList Data Structure.
    /// </summary>
    [Serializable]
    public class AplusVerifyDetailList : AopObject
    {
        /// <summary>
        /// 业务发生时间
        /// </summary>
        ...
        public string CertificateOriginalPrice { get; set; }

        /// <summary>
        /// 单凭证售价，单位：元
        /// </summary>
        [XmlElement("certificate_real_price")]
        public string CertificateRealPrice { get; set; }
        ...
        public string MerchantFundAmount { get; set; }
        ...
        public string OtherFundAmount { get; set; }
        ...
        public string PlatformFundAmount { get; set; }
