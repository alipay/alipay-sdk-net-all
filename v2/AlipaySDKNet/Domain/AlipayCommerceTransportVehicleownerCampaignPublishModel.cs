...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class AlipayCommerceTransportVehicleownerCampaignPublishModel : AopObject
    {
        /// <summary>
        /// 0.优惠券（目前仅提供一种后续增加）。必选项，单选。
        /// </summary>
        [XmlElement("activity_icon")]
        public string ActivityIcon { get; set; }

        /// <summary>
        /// 活动文案字符串，必填项，在加油小程序门店展位对用户展示
        /// </summary>
        [XmlElement("activity_record")]
        ...
        /// 上架平台：0 代表支付宝APP端
        /// </summary>
        [XmlElement("last_platform")]
        public string LastPlatform { get; set; }

        /// <summary>
        /// 上架门店id，逗号分隔开(备注：除上架外其它操作场景类型选填)
        /// </summary>
        [XmlElement("last_store_id")]
