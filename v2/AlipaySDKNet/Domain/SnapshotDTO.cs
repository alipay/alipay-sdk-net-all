...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class SnapshotDTO : AopObject
    {
        /// <summary>
        /// 盘后竞价成交量
        /// </summary>
