...
namespace Aop.Api.Domain
{
    ...
    public class ResourcePackageInfo : AopObject
    {
        ...
        /// <summary>
        /// 资源包规格编码  - public_cloudd_cd_cn_free_bag(免费版)  - public_cloudd_cd_cn_basic_bag(基础版)  - public_cloudd_cd_cn_standard_bag(标准版)  - public_cloudd_cd_cn_pro_bag(专业版)  - public_cloudd_cd_cn_enterprise_bag(企业版)  - public_cloudd_cd_cn_flagship_bag(旗舰版)
        /// </summary>
