...
{
    /// <summary>
    /// AlipayCommerceSportsVenueSimpleCreateModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCommerceSportsVenueSimpleCreateModel : AopObject
    {
        /// <summary>
        /// 具体地址
        /// </summary>
        ...
        /// <summary>
        /// 接入方式： 空值/不传值/center = 中心化 (场馆走文体中心统一展示样式）；  half_center = 半中心化 （场馆走服务商的跳转链接）；
        /// </summary>
