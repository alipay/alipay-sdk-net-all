...
{
    /// <summary>
    /// InteOpBusinessLicenseInfo Data Structure.
    /// </summary>
    [Serializable]
    public class InteOpBusinessLicenseInfo : AopObject
    {
        /// <summary>
        ...
        /// <summary>
        /// 营业执照图片。 被代创建商户运营主体为个人账户必填，企业账户无需填写，最小5KB，最大5M（暂不限制图片宽高），图片格式必须为：png、bmp、gif、jpg、jpeg 传入alipay.open.file.upload接口上传图片获取的file_id。
        /// </summary>
