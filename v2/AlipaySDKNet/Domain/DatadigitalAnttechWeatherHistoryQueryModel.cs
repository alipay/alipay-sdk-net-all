...
{
    /// <summary>
    /// DatadigitalAnttechWeatherHistoryQueryModel Data Structure.
    /// </summary>
    [Serializable]
    public class DatadigitalAnttechWeatherHistoryQueryModel : AopObject
    {
        /// <summary>
        ...
        /// <summary>
        /// 查询气象的开始日期，忽略时分秒。 结束日期 大于等于 开始日期。 开始日期和结束日期间隔不能超过7天
        /// </summary>
