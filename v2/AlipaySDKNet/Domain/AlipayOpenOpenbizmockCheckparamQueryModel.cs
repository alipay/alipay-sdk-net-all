...
{
    /// <summary>
    /// AlipayOpenOpenbizmockCheckparamQueryModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayOpenOpenbizmockCheckparamQueryModel : AopObject
    {
        /// <summary>
        /// 1
        /// </summary>
        ...
        [XmlArrayItem("complex_test_all")]
        public List<ComplexTestAll> ComplexListMust { get; set; }

        /// <summary>
        /// 1
        /// </summary>
        [XmlElement("complex_must")]
        public ComplexTestAll ComplexMust { get; set; }
