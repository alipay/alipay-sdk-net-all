...
namespace Aop.Api.Domain
{
    ...
    public class AlipayCloudCloudbaseMonitorMetricQueryModel : AopObject
    {
        ...
        /// <summary>
        /// 指标  - total  - success  - fail  - success_percent  - cost  - get_qps_count_60  - put_qps_count_60  - get_latency_avg_60  - put_latency_avg_60  - keys  - used_memory  - instance_input_bytes  - instance_output_bytes  - cmd_qps_count_60  - cmd_latency_avg_60  - request_package_size_sum_60  - response_package_size_sum_60
        /// </summary>
        [XmlElement("metric")]
