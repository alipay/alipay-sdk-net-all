...
{
    /// <summary>
    /// RepaymentBankcardExtInfo Data Structure.
    /// </summary>
    [Serializable]
    public class RepaymentBankcardExtInfo : AopObject
    {
        /// <summary>
        /// 银行卡收款账户类型 1：对公（在金融机构开设的公司账户）,如果银行卡为对公，必须传递省市支行信息或者联行号 2：对私（在金融机构开设的个人账户）
        /// </summary>
