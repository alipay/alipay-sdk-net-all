...
{
    /// <summary>
    /// AnttechOceanbaseObglobalPartnerCreateResponse.
    /// </summary>
    public class AnttechOceanbaseObglobalPartnerCreateResponse : AopResponse
    {
        /// <summary>
        /// 业务错误码
        /// </summary>
        ...
        /// </summary>
        [XmlElement("result")]
        public FxiaokeCreatePartnerResponse Result { get; set; }
    }
}
