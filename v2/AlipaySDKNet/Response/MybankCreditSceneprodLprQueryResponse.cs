...
namespace Aop.Api.Response
{
    ...
    /// </summary>
    public class MybankCreditSceneprodLprQueryResponse : AopResponse
    {
        /// <summary>
        /// 贷款利率基于LPR基准利率数据。 贷款利率为年利率为16.2%，LPR基准利率为3.85%，则为浮动利率上浮12.35%
        /// </summary>
        [XmlElement("float_rate")]
