...
{
    /// <summary>
    /// AlipayCommerceIotnspplaycenterActivityQueryResponse.
    /// </summary>
    public class AlipayCommerceIotnspplaycenterActivityQueryResponse : AopResponse
    {
        /// <summary>
        /// 活动状态
        /// </summary>
        ...
        [XmlArrayItem("iotnspplaycenter_activity_voucher_info")]
        public List<IotnspplaycenterActivityVoucherInfo> VoucherList { get; set; }
    }
}
