...
namespace Aop.Api.Response
{
    ...
    public class AlipayTradeQueryResponse : AopResponse
    {
        ...
        [XmlElement("test1")]
        public VoucherDetail Test1 { get; set; }
        ...
        [XmlArray("test_list1")]
        [XmlArrayItem("int")]
        public List<int> TestList1 { get; set; }

        [XmlArray("test_list2")]
        [XmlArrayItem("long")]
        public List<long> TestList2 { get; set; }

        [XmlArray("test_list3")]
        [XmlArrayItem("double")]
        public List<double> TestList3 { get; set; }

        [XmlArray("test_list4")]
        [XmlArrayItem("bool")]
        public List<bool> TestList4 { get; set; }

        [XmlArray("test_list5")]
        [XmlArrayItem("string")]
        public List<string> TestList5 { get; set; }
    }
}
