...
namespace Test
{
    ...
    public class CertificateRSACheckTest
    {
        ...
        public void should_pass_rsa_check_when_sign_type_is_rsa()
        {
            ...
            bool result = AlipaySignature.RSACertCheckV2(parameters, TestAccount.ProdCert.CertParams.AppCertPath, "utf-8", "RSA");
        ...
        public void should_pass_rsa_check_when_sign_type_is_rsa2()
        {
            ...
            bool result = AlipaySignature.RSACertCheckV2(parameters, TestAccount.ProdCert.CertParams.AppCertPath, "utf-8", "RSA2");
