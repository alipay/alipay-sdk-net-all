...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class AlipayDataAiserviceBikepriceGetModel : AopObject
    {
        /// <summary>
        /// 渠道来源，跳转到渠道(流量位)的上一级页面(由调用方定义渠道枚举，给出对应英文代码或中文解释)
        /// </summary>
        [XmlElement("ad_source")]
        public string AdSource { get; set; }

        /// <summary>
        /// 卡型代码版本,0为旧版卡型代码(默认),1为新版卡型代码
        /// </summary>
        [XmlElement("card_type_version")]
        ...
        [XmlArrayItem("card_price_request_item")]
