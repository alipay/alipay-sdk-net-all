...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class AlipayDataIotdataBaiCargocountQueryModel : AopObject
    {
        /// <summary>
        /// 货物盘点使用的摄像头id
        /// </summary>
