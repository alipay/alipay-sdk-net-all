...
namespace Aop.Api.Domain
{
    ...
    public class EnviromentalInfoDTO : AopObject
    {
        ...
        /// <summary>
        /// environmental_info不为空时,必填; 环保行为内容字典值: 减塑/不使用购物袋:huanbaojiansu;  无纸质小票(电子小票):dianzixiaopiao; 直饮水:zhiyinshui;   酒店绿色入住:lvseruzhu; 减碳-酒店不洗涤:待定;   景区订单-扫码购票:saomagoupiao;   高校订单:待定; 充电宝订单:chongdianbao; 物流订单:wangshangjijian; 酒店信用住:xinyongzhu; 临期食品:linqishipin;
        /// </summary>
