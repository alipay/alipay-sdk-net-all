...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class ZhimaMerchantZmgoCumulateSyncModel : AopObject
    {
        /// <summary>
        ...
        /// </summary>
        [XmlElement("amount_type_sync_data")]
        ...
        /// 优惠数据，仅回传优惠数据时传入
        /// </summary>
        [XmlElement("discount_type_sync_data")]
        ...
        /// </summary>
        [XmlElement("sub_biz_action")]
        public string SubBizAction { get; set; }

        /// <summary>
        /// 任务次数型数据，当选择次数任务时传入
        /// </summary>
        [XmlElement("times_type_sync_data")]
