...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class AlipayOverseasFundInstitutionschoolinfCreateModel : AopObject
    {
        /// <summary>
        ...
        /// 学校联系人姓名
        /// </summary>
        [XmlElement("link_man_name")]
        public string LinkManName { get; set; }

        /// <summary>
        /// 学校联系电话
        /// </summary>
        [XmlElement("link_phone")]
        public string LinkPhone { get; set; }

        /// <summary>
        /// 组织机构英文名称和单位地址（英文）两个字段的长度加总不能超过130个字符
        /// </summary>
        [XmlElement("office_adr_en")]
        ...
        /// 开户描述信息
        /// </summary>
        [XmlElement("remark_info")]
        public string RemarkInfo { get; set; }

        /// <summary>
        /// 学校详细地址
        /// </summary>
        [XmlElement("school_address")]
        public string SchoolAddress { get; set; }

        /// <summary>
        /// 学校所在的国家编码ISO2位标准
        /// </summary>
        [XmlElement("school_country")]
        public string SchoolCountry { get; set; }

        /// <summary>
        /// 学校英文名称
        /// </summary>
        [XmlElement("school_en_name")]
        ...
        /// </summary>
        [XmlElement("special_economic_zone_company_type")]
        public string SpecialEconomicZoneCompanyType { get; set; }

        /// <summary>
        /// 交易用eMail
        /// </summary>
        [XmlElement("trans_email")]
