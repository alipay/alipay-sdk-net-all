...
namespace Aop.Api.Response
{
    ...
    public class AlipayMerchantIndirectAuthorderQuerystatusResponse : AopResponse
    {
        ...
        /// <summary>
        /// 商家认证小程序二维码图片链接，申请单状态处于审核成功、审核中、已冻结时返回，商户使用支付宝APP扫码后完成后续确认动作。 此字段是平台生成并返回的二维码码值，通过浏览器访问即可获得一个二维码的图片。服务商在推广过程中，可引导商家使用支付宝APP扫描此二维码，进入认证申请单页面，完成认证申请的后续确认操作。
        /// </summary>
        [XmlElement("qr_code")]
