...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class AlipaySocialBaseBcMsgSendModel : AopObject
    {
        /// <summary>
