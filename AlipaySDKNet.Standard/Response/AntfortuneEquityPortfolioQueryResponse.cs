...
namespace Aop.Api.Response
{
    ...
    /// </summary>
    public class AntfortuneEquityPortfolioQueryResponse : AopResponse
    {
        /// <summary>
        /// 是否可买入
        /// </summary>
        [XmlElement("can_purchase")]
        ...
        /// 日涨跌幅，四舍五入后保留小数点后4位
        /// </summary>
        [XmlElement("last_day_profit_rate")]
        public string LastDayProfitRate { get; set; }

        /// <summary>
        /// 近一年涨跌幅，四舍五入后保留小数点后4位
        /// </summary>
        [XmlElement("latest_one_year_profit_rate")]
        ...
        /// 组合明细
        /// </summary>
        [XmlArray("portfolio_detail_products")]
        [XmlArrayItem("portfolio_detail_product_info")]
        ...
        /// 策略目标
        /// </summary>
        [XmlElement("strategy_goal")]
        public string StrategyGoal { get; set; }

        /// <summary>
        /// 组合简介
        /// </summary>
        [XmlElement("strategy_intro")]
        public string StrategyIntro { get; set; }

        /// <summary>
        /// 策略描述地址
        /// </summary>
        [XmlElement("strategy_url")]
        ...
        /// </summary>
        [XmlElement("suggested_keep_period")]
